...
(defn get-log-group-fields
  ...
  (^com.amazonaws.services.logs.model.GetLogGroupFieldsResult [^AWSLogs this ^com.amazonaws.services.logs.model.GetLogGroupFieldsRequest get-log-group-fields-request]
    (-> this (.getLogGroupFields get-log-group-fields-request))))
...
(defn create-export-task
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.CreateExportTaskResult [^AWSLogs this ^com.amazonaws.services.logs.model.CreateExportTaskRequest create-export-task-request]
    (-> this (.createExportTask create-export-task-request))))
...
(defn delete-log-stream
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteLogStreamResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteLogStreamRequest delete-log-stream-request]
    (-> this (.deleteLogStream delete-log-stream-request))))
...
(defn disassociate-kms-key
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DisassociateKmsKeyResult [^AWSLogs this ^com.amazonaws.services.logs.model.DisassociateKmsKeyRequest disassociate-kms-key-request]
    (-> this (.disassociateKmsKey disassociate-kms-key-request))))

(defn set-region
  "Deprecated. use AwsClientBuilder#setRegion(String)

  region - The region this client will communicate with. See Region.getRegion(com.amazonaws.regions.Regions) for accessing a given region. Must not be null and must be a region where the service is available. - `com.amazonaws.regions.Region`"
  ([^AWSLogs this ^com.amazonaws.regions.Region region]
...
(defn delete-metric-filter
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteMetricFilterResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteMetricFilterRequest delete-metric-filter-request]
    (-> this (.deleteMetricFilter delete-metric-filter-request))))
...
(defn describe-subscription-filters
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeSubscriptionFiltersResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeSubscriptionFiltersRequest describe-subscription-filters-request]
    (-> this (.describeSubscriptionFilters describe-subscription-filters-request))))
...
(defn put-subscription-filter
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutSubscriptionFilterResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutSubscriptionFilterRequest put-subscription-filter-request]
    (-> this (.putSubscriptionFilter put-subscription-filter-request))))
...
(defn delete-resource-policy
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteResourcePolicyResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteResourcePolicyRequest delete-resource-policy-request]
...
(defn describe-log-groups
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeLogGroupsResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeLogGroupsRequest describe-log-groups-request]
    (-> this (.describeLogGroups describe-log-groups-request)))
  (^com.amazonaws.services.logs.model.DescribeLogGroupsResult [^AWSLogs this]
...
(defn associate-kms-key
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.AssociateKmsKeyResult [^AWSLogs this ^com.amazonaws.services.logs.model.AssociateKmsKeyRequest associate-kms-key-request]
    (-> this (.associateKmsKey associate-kms-key-request))))
...
(defn list-tags-log-group
  ...
  (^com.amazonaws.services.logs.model.ListTagsLogGroupResult [^AWSLogs this ^com.amazonaws.services.logs.model.ListTagsLogGroupRequest list-tags-log-group-request]
    (-> this (.listTagsLogGroup list-tags-log-group-request))))
...
(defn tag-log-group
  ...
  throws: com.amazonaws.services.logs.model.ResourceNotFoundException - The specified resource does not exist."
  (^com.amazonaws.services.logs.model.TagLogGroupResult [^AWSLogs this ^com.amazonaws.services.logs.model.TagLogGroupRequest tag-log-group-request]
    (-> this (.tagLogGroup tag-log-group-request))))
...
(defn delete-subscription-filter
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteSubscriptionFilterResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteSubscriptionFilterRequest delete-subscription-filter-request]
    (-> this (.deleteSubscriptionFilter delete-subscription-filter-request))))
...
(defn delete-retention-policy
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteRetentionPolicyResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteRetentionPolicyRequest delete-retention-policy-request]
    (-> this (.deleteRetentionPolicy delete-retention-policy-request))))
...
(defn start-query
  ...
  (^com.amazonaws.services.logs.model.StartQueryResult [^AWSLogs this ^com.amazonaws.services.logs.model.StartQueryRequest start-query-request]
    (-> this (.startQuery start-query-request))))
...
(defn put-resource-policy
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutResourcePolicyResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutResourcePolicyRequest put-resource-policy-request]
...
(defn get-log-record
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.GetLogRecordResult [^AWSLogs this ^com.amazonaws.services.logs.model.GetLogRecordRequest get-log-record-request]
    (-> this (.getLogRecord get-log-record-request))))
...
(defn put-log-events
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutLogEventsResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutLogEventsRequest put-log-events-request]
    (-> this (.putLogEvents put-log-events-request))))
...
(defn stop-query
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.StopQueryResult [^AWSLogs this ^com.amazonaws.services.logs.model.StopQueryRequest stop-query-request]
    (-> this (.stopQuery stop-query-request))))
...
(defn describe-metric-filters
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeMetricFiltersResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeMetricFiltersRequest describe-metric-filters-request]
    (-> this (.describeMetricFilters describe-metric-filters-request))))
...
(defn untag-log-group
  ...
  throws: com.amazonaws.services.logs.model.ResourceNotFoundException - The specified resource does not exist."
  (^com.amazonaws.services.logs.model.UntagLogGroupResult [^AWSLogs this ^com.amazonaws.services.logs.model.UntagLogGroupRequest untag-log-group-request]
    (-> this (.untagLogGroup untag-log-group-request))))
...
(defn set-endpoint
  ...
  ([^AWSLogs this ^java.lang.String endpoint]
...
(defn cancel-export-task
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.CancelExportTaskResult [^AWSLogs this ^com.amazonaws.services.logs.model.CancelExportTaskRequest cancel-export-task-request]
...
(defn get-log-events
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.GetLogEventsResult [^AWSLogs this ^com.amazonaws.services.logs.model.GetLogEventsRequest get-log-events-request]
    (-> this (.getLogEvents get-log-events-request))))
...
(defn create-log-stream
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.CreateLogStreamResult [^AWSLogs this ^com.amazonaws.services.logs.model.CreateLogStreamRequest create-log-stream-request]
    (-> this (.createLogStream create-log-stream-request))))
...
(defn put-destination
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutDestinationResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutDestinationRequest put-destination-request]
    (-> this (.putDestination put-destination-request))))
...
(defn put-retention-policy
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutRetentionPolicyResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutRetentionPolicyRequest put-retention-policy-request]
    (-> this (.putRetentionPolicy put-retention-policy-request))))
...
(defn test-metric-filter
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.TestMetricFilterResult [^AWSLogs this ^com.amazonaws.services.logs.model.TestMetricFilterRequest test-metric-filter-request]
    (-> this (.testMetricFilter test-metric-filter-request))))
...
(defn get-query-results
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.GetQueryResultsResult [^AWSLogs this ^com.amazonaws.services.logs.model.GetQueryResultsRequest get-query-results-request]
...
(defn put-destination-policy
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutDestinationPolicyResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutDestinationPolicyRequest put-destination-policy-request]
    (-> this (.putDestinationPolicy put-destination-policy-request))))
...
(defn describe-export-tasks
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeExportTasksResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeExportTasksRequest describe-export-tasks-request]
...
(defn delete-log-group
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteLogGroupResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteLogGroupRequest delete-log-group-request]
    (-> this (.deleteLogGroup delete-log-group-request))))
...
(defn describe-log-streams
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeLogStreamsResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeLogStreamsRequest describe-log-streams-request]
    (-> this (.describeLogStreams describe-log-streams-request))))
...
(defn delete-destination
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DeleteDestinationResult [^AWSLogs this ^com.amazonaws.services.logs.model.DeleteDestinationRequest delete-destination-request]
    (-> this (.deleteDestination delete-destination-request))))
...
(defn put-metric-filter
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.PutMetricFilterResult [^AWSLogs this ^com.amazonaws.services.logs.model.PutMetricFilterRequest put-metric-filter-request]
    (-> this (.putMetricFilter put-metric-filter-request))))
...
(defn create-log-group
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.CreateLogGroupResult [^AWSLogs this ^com.amazonaws.services.logs.model.CreateLogGroupRequest create-log-group-request]
    (-> this (.createLogGroup create-log-group-request))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AWSLogs this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn describe-resource-policies
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeResourcePoliciesResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeResourcePoliciesRequest describe-resource-policies-request]
    (-> this (.describeResourcePolicies describe-resource-policies-request))))
...
(defn describe-queries
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeQueriesResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeQueriesRequest describe-queries-request]
    (-> this (.describeQueries describe-queries-request))))
...
(defn describe-destinations
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.DescribeDestinationsResult [^AWSLogs this ^com.amazonaws.services.logs.model.DescribeDestinationsRequest describe-destinations-request]
    (-> this (.describeDestinations describe-destinations-request)))
  (^com.amazonaws.services.logs.model.DescribeDestinationsResult [^AWSLogs this]
...
(defn filter-log-events
  ...
  throws: com.amazonaws.services.logs.model.InvalidParameterException - A parameter is specified incorrectly."
  (^com.amazonaws.services.logs.model.FilterLogEventsResult [^AWSLogs this ^com.amazonaws.services.logs.model.FilterLogEventsRequest filter-log-events-request]
    (-> this (.filterLogEvents filter-log-events-request))))
