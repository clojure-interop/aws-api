(ns com.amazonaws.services.kinesisvideo.AmazonKinesisVideoArchivedMediaClient
...
(defn *builder
  "returns: `com.amazonaws.services.kinesisvideo.AmazonKinesisVideoArchivedMediaClientBuilder`"
  (^com.amazonaws.services.kinesisvideo.AmazonKinesisVideoArchivedMediaClientBuilder []
    (AmazonKinesisVideoArchivedMediaClient/builder )))
...
(defn get-dash-streaming-session-url
  ...
  (^com.amazonaws.services.kinesisvideo.model.GetDASHStreamingSessionURLResult [^AmazonKinesisVideoArchivedMediaClient this ^com.amazonaws.services.kinesisvideo.model.GetDASHStreamingSessionURLRequest request]
...
(defn get-hls-streaming-session-url
  ...
  throws: com.amazonaws.services.kinesisvideo.model.ResourceNotFoundException - GetMedia throws this error when Kinesis Video Streams can't find the stream that you specified. GetHLSStreamingSessionURL and GetDASHStreamingSessionURL throw this error if a session with a PlaybackMode of ON_DEMAND or LIVE_REPLAYis requested for a stream that has no fragments within the requested time range, or if a session with a PlaybackMode of LIVE is requested for a stream that has no fragments within the last 30 seconds."
  (^com.amazonaws.services.kinesisvideo.model.GetHLSStreamingSessionURLResult [^AmazonKinesisVideoArchivedMediaClient this ^com.amazonaws.services.kinesisvideo.model.GetHLSStreamingSessionURLRequest request]
...
(defn get-media-for-fragment-list
  ...
  throws: com.amazonaws.services.kinesisvideo.model.ResourceNotFoundException - GetMedia throws this error when Kinesis Video Streams can't find the stream that you specified. GetHLSStreamingSessionURL and GetDASHStreamingSessionURL throw this error if a session with a PlaybackMode of ON_DEMAND or LIVE_REPLAYis requested for a stream that has no fragments within the requested time range, or if a session with a PlaybackMode of LIVE is requested for a stream that has no fragments within the last 30 seconds."
  (^com.amazonaws.services.kinesisvideo.model.GetMediaForFragmentListResult [^AmazonKinesisVideoArchivedMediaClient this ^com.amazonaws.services.kinesisvideo.model.GetMediaForFragmentListRequest request]
...
(defn list-fragments
  ...
  throws: com.amazonaws.services.kinesisvideo.model.ResourceNotFoundException - GetMedia throws this error when Kinesis Video Streams can't find the stream that you specified. GetHLSStreamingSessionURL and GetDASHStreamingSessionURL throw this error if a session with a PlaybackMode of ON_DEMAND or LIVE_REPLAYis requested for a stream that has no fragments within the requested time range, or if a session with a PlaybackMode of LIVE is requested for a stream that has no fragments within the last 30 seconds."
  (^com.amazonaws.services.kinesisvideo.model.ListFragmentsResult [^AmazonKinesisVideoArchivedMediaClient this ^com.amazonaws.services.kinesisvideo.model.ListFragmentsRequest request]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonKinesisVideoArchivedMediaClient this ^com.amazonaws.AmazonWebServiceRequest request]
