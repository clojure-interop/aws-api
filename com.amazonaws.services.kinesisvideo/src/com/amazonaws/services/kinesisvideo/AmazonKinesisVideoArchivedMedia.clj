(ns com.amazonaws.services.kinesisvideo.AmazonKinesisVideoArchivedMedia
  "Interface for accessing Kinesis Video Archived Media.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAmazonKinesisVideoArchivedMedia instead."
...
(defn get-hls-streaming-session-url
  ...
  throws: com.amazonaws.services.kinesisvideo.model.ResourceNotFoundException - GetMedia throws this error when Kinesis Video Streams can't find the stream that you specified. GetHLSStreamingSessionURL and GetDASHStreamingSessionURL throw this error if a session with a PlaybackMode of ON_DEMAND or LIVE_REPLAYis requested for a stream that has no fragments within the requested time range, or if a session with a PlaybackMode of LIVE is requested for a stream that has no fragments within the last 30 seconds."
  (^com.amazonaws.services.kinesisvideo.model.GetHLSStreamingSessionURLResult [^AmazonKinesisVideoArchivedMedia this ^com.amazonaws.services.kinesisvideo.model.GetHLSStreamingSessionURLRequest get-hls-streaming-session-url-request]
    (-> this (.getHLSStreamingSessionURL get-hls-streaming-session-url-request))))
...
(defn get-media-for-fragment-list
  ...
  throws: com.amazonaws.services.kinesisvideo.model.ResourceNotFoundException - GetMedia throws this error when Kinesis Video Streams can't find the stream that you specified. GetHLSStreamingSessionURL and GetDASHStreamingSessionURL throw this error if a session with a PlaybackMode of ON_DEMAND or LIVE_REPLAYis requested for a stream that has no fragments within the requested time range, or if a session with a PlaybackMode of LIVE is requested for a stream that has no fragments within the last 30 seconds."
  (^com.amazonaws.services.kinesisvideo.model.GetMediaForFragmentListResult [^AmazonKinesisVideoArchivedMedia this ^com.amazonaws.services.kinesisvideo.model.GetMediaForFragmentListRequest get-media-for-fragment-list-request]
    (-> this (.getMediaForFragmentList get-media-for-fragment-list-request))))
...
(defn list-fragments
  ...
  throws: com.amazonaws.services.kinesisvideo.model.ResourceNotFoundException - GetMedia throws this error when Kinesis Video Streams can't find the stream that you specified. GetHLSStreamingSessionURL and GetDASHStreamingSessionURL throw this error if a session with a PlaybackMode of ON_DEMAND or LIVE_REPLAYis requested for a stream that has no fragments within the requested time range, or if a session with a PlaybackMode of LIVE is requested for a stream that has no fragments within the last 30 seconds."
  (^com.amazonaws.services.kinesisvideo.model.ListFragmentsResult [^AmazonKinesisVideoArchivedMedia this ^com.amazonaws.services.kinesisvideo.model.ListFragmentsRequest list-fragments-request]
    (-> this (.listFragments list-fragments-request))))

(defn shutdown
  "Shuts down this client object, releasing any resources that might be held open. This is an optional method, and
   callers are not expected to call it, but can if they want to explicitly release any open resources. Once a client
   has been shutdown, it should not be used to make any more requests."
  ([^AmazonKinesisVideoArchivedMedia this]
    (-> this (.shutdown))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonKinesisVideoArchivedMedia this ^com.amazonaws.AmazonWebServiceRequest request]
