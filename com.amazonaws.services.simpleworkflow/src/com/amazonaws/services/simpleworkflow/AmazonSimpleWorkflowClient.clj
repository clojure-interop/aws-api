(ns com.amazonaws.services.simpleworkflow.AmazonSimpleWorkflowClient
...
(defn ->amazon-simple-workflow-client
  "Constructor.
  ...
  client-configuration - The client configuration options controlling how this client connects to Amazon SWF (ex: proxy settings, retry counts, etc.). - `com.amazonaws.ClientConfiguration`
  request-metric-collector - optional request metric collector - `com.amazonaws.metrics.RequestMetricCollector`"
  (^AmazonSimpleWorkflowClient [^com.amazonaws.auth.AWSCredentialsProvider aws-credentials-provider ^com.amazonaws.ClientConfiguration client-configuration ^com.amazonaws.metrics.RequestMetricCollector request-metric-collector]
    (new AmazonSimpleWorkflowClient aws-credentials-provider client-configuration request-metric-collector))
  (^AmazonSimpleWorkflowClient [^com.amazonaws.auth.AWSCredentials aws-credentials ^com.amazonaws.ClientConfiguration client-configuration]
    (new AmazonSimpleWorkflowClient aws-credentials client-configuration))
  (^AmazonSimpleWorkflowClient [^com.amazonaws.ClientConfiguration client-configuration]
    (new AmazonSimpleWorkflowClient client-configuration))
  (^AmazonSimpleWorkflowClient []
    (new AmazonSimpleWorkflowClient )))

(defn *builder
  "returns: `com.amazonaws.services.simpleworkflow.AmazonSimpleWorkflowClientBuilder`"
  (^com.amazonaws.services.simpleworkflow.AmazonSimpleWorkflowClientBuilder []
    (AmazonSimpleWorkflowClient/builder )))
...
(defn register-workflow-type
  ...
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RegisterWorkflowTypeRequest request]
...
(defn list-tags-for-resource
  ...
  (^com.amazonaws.services.simpleworkflow.model.ListTagsForResourceOutput [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.ListTagsForResourceRequest request]
...
(defn describe-activity-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.ActivityTypeDetail [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DescribeActivityTypeRequest request]
...
(defn respond-activity-task-completed
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RespondActivityTaskCompletedRequest request]
...
(defn start-workflow-execution
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.Run [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.StartWorkflowExecutionRequest request]
...
(defn count-pending-activity-tasks
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.PendingTaskCount [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.CountPendingActivityTasksRequest request]
...
(defn signal-workflow-execution
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.SignalWorkflowExecutionRequest request]
...
(defn describe-workflow-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowTypeDetail [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DescribeWorkflowTypeRequest request]
...
(defn deprecate-workflow-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DeprecateWorkflowTypeRequest request]
...
(defn untag-resource
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.UntagResourceRequest request]
...
(defn undeprecate-workflow-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.UndeprecateWorkflowTypeRequest request]
...
(defn respond-activity-task-failed
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RespondActivityTaskFailedRequest request]
...
(defn request-cancel-workflow-execution
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RequestCancelWorkflowExecutionRequest request]
...
(defn respond-decision-task-completed
  ...
  request - `com.amazonaws.services.simpleworkflow.model.RespondDecisionTaskCompletedRequest`

  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RespondDecisionTaskCompletedRequest request]
...
(defn list-closed-workflow-executions
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowExecutionInfos [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.ListClosedWorkflowExecutionsRequest request]
...
(defn list-activity-types
  ...
  (^com.amazonaws.services.simpleworkflow.model.ActivityTypeInfos [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.ListActivityTypesRequest request]
...
(defn undeprecate-domain
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.UndeprecateDomainRequest request]
...
(defn deprecate-domain
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DeprecateDomainRequest request]
...
(defn poll-for-decision-task
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.DecisionTask [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.PollForDecisionTaskRequest request]
...
(defn terminate-workflow-execution
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.TerminateWorkflowExecutionRequest request]
...
(defn register-activity-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.TypeAlreadyExistsException - Returned if the type already exists in the specified domain. You may get this fault if you are registering a type that is either already registered or deprecated, or if you undeprecate a type that is currently registered."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RegisterActivityTypeRequest request]
...
(defn list-domains
  ...
  throws: com.amazonaws.services.simpleworkflow.model.OperationNotPermittedException - Returned when the caller doesn't have sufficient permissions to invoke the action."
  (^com.amazonaws.services.simpleworkflow.model.DomainInfos [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.ListDomainsRequest request]
...
(defn count-pending-decision-tasks
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.PendingTaskCount [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.CountPendingDecisionTasksRequest request]
...
(defn respond-activity-task-canceled
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RespondActivityTaskCanceledRequest request]
...
(defn describe-domain
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.DomainDetail [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DescribeDomainRequest request]
...
(defn deprecate-activity-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DeprecateActivityTypeRequest request]
...
(defn get-workflow-execution-history
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.History [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.GetWorkflowExecutionHistoryRequest request]
...
(defn count-closed-workflow-executions
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowExecutionCount [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.CountClosedWorkflowExecutionsRequest request]
...
(defn poll-for-activity-task
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.ActivityTask [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.PollForActivityTaskRequest request]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonSimpleWorkflowClient this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn count-open-workflow-executions
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowExecutionCount [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.CountOpenWorkflowExecutionsRequest request]
...
(defn list-workflow-types
  ...
  throws: com.amazonaws.services.simpleworkflow.model.OperationNotPermittedException - Returned when the caller doesn't have sufficient permissions to invoke the action."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowTypeInfos [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.ListWorkflowTypesRequest request]
...
(defn undeprecate-activity-type
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.UndeprecateActivityTypeRequest request]
...
(defn record-activity-task-heartbeat
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.ActivityTaskStatus [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RecordActivityTaskHeartbeatRequest request]
...
(defn describe-workflow-execution
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowExecutionDetail [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.DescribeWorkflowExecutionRequest request]
...
(defn list-open-workflow-executions
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  (^com.amazonaws.services.simpleworkflow.model.WorkflowExecutionInfos [^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.ListOpenWorkflowExecutionsRequest request]
...
(defn tag-resource
  ...
  throws: com.amazonaws.services.simpleworkflow.model.UnknownResourceException - Returned when the named resource cannot be found with in the scope of this operation (region or domain). This could happen if the named resource was never created or is no longer available for this operation."
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.TagResourceRequest request]
...
(defn register-domain
  ...
  ([^AmazonSimpleWorkflowClient this ^com.amazonaws.services.simpleworkflow.model.RegisterDomainRequest request]
