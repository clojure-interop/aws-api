(ns com.amazonaws.services.resourcegroupstaggingapi.AWSResourceGroupsTaggingAPI
...
(defn get-resources
  ...
  (^com.amazonaws.services.resourcegroupstaggingapi.model.GetResourcesResult [^AWSResourceGroupsTaggingAPI this ^com.amazonaws.services.resourcegroupstaggingapi.model.GetResourcesRequest get-resources-request]
...
(defn get-tag-keys
  ...
  throws: com.amazonaws.services.resourcegroupstaggingapi.model.InvalidParameterException - A parameter is missing or a malformed string or invalid or out-of-range value was supplied for the request parameter."
  (^com.amazonaws.services.resourcegroupstaggingapi.model.GetTagKeysResult [^AWSResourceGroupsTaggingAPI this ^com.amazonaws.services.resourcegroupstaggingapi.model.GetTagKeysRequest get-tag-keys-request]
    (-> this (.getTagKeys get-tag-keys-request))))
...
(defn get-tag-values
  ...
  throws: com.amazonaws.services.resourcegroupstaggingapi.model.InvalidParameterException - A parameter is missing or a malformed string or invalid or out-of-range value was supplied for the request parameter."
  (^com.amazonaws.services.resourcegroupstaggingapi.model.GetTagValuesResult [^AWSResourceGroupsTaggingAPI this ^com.amazonaws.services.resourcegroupstaggingapi.model.GetTagValuesRequest get-tag-values-request]
    (-> this (.getTagValues get-tag-values-request))))
...
(defn tag-resources
  ...
  throws: com.amazonaws.services.resourcegroupstaggingapi.model.InvalidParameterException - A parameter is missing or a malformed string or invalid or out-of-range value was supplied for the request parameter."
  (^com.amazonaws.services.resourcegroupstaggingapi.model.TagResourcesResult [^AWSResourceGroupsTaggingAPI this ^com.amazonaws.services.resourcegroupstaggingapi.model.TagResourcesRequest tag-resources-request]
    (-> this (.tagResources tag-resources-request))))
...
(defn untag-resources
  ...
  throws: com.amazonaws.services.resourcegroupstaggingapi.model.InvalidParameterException - A parameter is missing or a malformed string or invalid or out-of-range value was supplied for the request parameter."
  (^com.amazonaws.services.resourcegroupstaggingapi.model.UntagResourcesResult [^AWSResourceGroupsTaggingAPI this ^com.amazonaws.services.resourcegroupstaggingapi.model.UntagResourcesRequest untag-resources-request]
    (-> this (.untagResources untag-resources-request))))

(defn shutdown
  "Shuts down this client object, releasing any resources that might be held open. This is an optional method, and
   callers are not expected to call it, but can if they want to explicitly release any open resources. Once a client
   has been shutdown, it should not be used to make any more requests."
  ([^AWSResourceGroupsTaggingAPI this]
    (-> this (.shutdown))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AWSResourceGroupsTaggingAPI this ^com.amazonaws.AmazonWebServiceRequest request]
