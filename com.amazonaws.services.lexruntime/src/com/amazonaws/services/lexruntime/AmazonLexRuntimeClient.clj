(ns com.amazonaws.services.lexruntime.AmazonLexRuntimeClient
...
(defn *builder
  "returns: `com.amazonaws.services.lexruntime.AmazonLexRuntimeClientBuilder`"
  (^com.amazonaws.services.lexruntime.AmazonLexRuntimeClientBuilder []
    (AmazonLexRuntimeClient/builder )))
...
(defn post-content
  ...
  (^com.amazonaws.services.lexruntime.model.PostContentResult [^AmazonLexRuntimeClient this ^com.amazonaws.services.lexruntime.model.PostContentRequest request]
...
(defn post-text
  ...
  (^com.amazonaws.services.lexruntime.model.PostTextResult [^AmazonLexRuntimeClient this ^com.amazonaws.services.lexruntime.model.PostTextRequest request]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonLexRuntimeClient this ^com.amazonaws.AmazonWebServiceRequest request]
