(ns com.amazonaws.services.ec2.AmazonEC2
  "Interface for accessing Amazon EC2.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAmazonEC2 instead.
...
(defn describe-traffic-mirror-targets
  ...
  (^com.amazonaws.services.ec2.model.DescribeTrafficMirrorTargetsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTrafficMirrorTargetsRequest describe-traffic-mirror-targets-request]
    (-> this (.describeTrafficMirrorTargets describe-traffic-mirror-targets-request))))
...
(defn modify-fleet
  ...
  (^com.amazonaws.services.ec2.model.ModifyFleetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyFleetRequest modify-fleet-request]
    (-> this (.modifyFleet modify-fleet-request))))
...
(defn create-vpc
  ...
  (^com.amazonaws.services.ec2.model.CreateVpcResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpcRequest create-vpc-request]
    (-> this (.createVpc create-vpc-request))))
...
(defn describe-id-format
  ...
  (^com.amazonaws.services.ec2.model.DescribeIdFormatResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeIdFormatRequest describe-id-format-request]
    (-> this (.describeIdFormat describe-id-format-request)))
  (^com.amazonaws.services.ec2.model.DescribeIdFormatResult [^AmazonEC2 this]
...
(defn delete-tags
  ...
  (^com.amazonaws.services.ec2.model.DeleteTagsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTagsRequest delete-tags-request]
...
(defn create-route-table
  ...
  (^com.amazonaws.services.ec2.model.CreateRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateRouteTableRequest create-route-table-request]
    (-> this (.createRouteTable create-route-table-request))))
...
(defn apply-security-groups-to-client-vpn-target-network
  ...
  (^com.amazonaws.services.ec2.model.ApplySecurityGroupsToClientVpnTargetNetworkResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ApplySecurityGroupsToClientVpnTargetNetworkRequest apply-security-groups-to-client-vpn-target-network-request]
    (-> this (.applySecurityGroupsToClientVpnTargetNetwork apply-security-groups-to-client-vpn-target-network-request))))
...
(defn delete-route-table
  ...
  (^com.amazonaws.services.ec2.model.DeleteRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteRouteTableRequest delete-route-table-request]
    (-> this (.deleteRouteTable delete-route-table-request))))
...
(defn disable-vgw-route-propagation
  ...
  (^com.amazonaws.services.ec2.model.DisableVgwRoutePropagationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisableVgwRoutePropagationRequest disable-vgw-route-propagation-request]
    (-> this (.disableVgwRoutePropagation disable-vgw-route-propagation-request))))
...
(defn describe-instance-status
  ...
  (^com.amazonaws.services.ec2.model.DescribeInstanceStatusResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeInstanceStatusRequest describe-instance-status-request]
    (-> this (.describeInstanceStatus describe-instance-status-request)))
  (^com.amazonaws.services.ec2.model.DescribeInstanceStatusResult [^AmazonEC2 this]
...
(defn delete-network-acl-entry
  ...
  (^com.amazonaws.services.ec2.model.DeleteNetworkAclEntryResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteNetworkAclEntryRequest delete-network-acl-entry-request]
    (-> this (.deleteNetworkAclEntry delete-network-acl-entry-request))))
...
(defn modify-instance-capacity-reservation-attributes
  ...
  (^com.amazonaws.services.ec2.model.ModifyInstanceCapacityReservationAttributesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyInstanceCapacityReservationAttributesRequest modify-instance-capacity-reservation-attributes-request]
    (-> this (.modifyInstanceCapacityReservationAttributes modify-instance-capacity-reservation-attributes-request))))
...
(defn create-subnet
  ...
  (^com.amazonaws.services.ec2.model.CreateSubnetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateSubnetRequest create-subnet-request]
    (-> this (.createSubnet create-subnet-request))))
...
(defn describe-snapshot-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeSnapshotAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSnapshotAttributeRequest describe-snapshot-attribute-request]
    (-> this (.describeSnapshotAttribute describe-snapshot-attribute-request))))
...
(defn report-instance-status
  ...
  (^com.amazonaws.services.ec2.model.ReportInstanceStatusResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReportInstanceStatusRequest report-instance-status-request]
    (-> this (.reportInstanceStatus report-instance-status-request))))
...
(defn describe-launch-templates
  ...
  (^com.amazonaws.services.ec2.model.DescribeLaunchTemplatesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeLaunchTemplatesRequest describe-launch-templates-request]
    (-> this (.describeLaunchTemplates describe-launch-templates-request))))
...
(defn describe-classic-link-instances
  ...
  (^com.amazonaws.services.ec2.model.DescribeClassicLinkInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeClassicLinkInstancesRequest describe-classic-link-instances-request]
    (-> this (.describeClassicLinkInstances describe-classic-link-instances-request)))
  (^com.amazonaws.services.ec2.model.DescribeClassicLinkInstancesResult [^AmazonEC2 this]
...
(defn describe-launch-template-versions
  ...
  (^com.amazonaws.services.ec2.model.DescribeLaunchTemplateVersionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeLaunchTemplateVersionsRequest describe-launch-template-versions-request]
    (-> this (.describeLaunchTemplateVersions describe-launch-template-versions-request))))
...
(defn deregister-image
  ...
  (^com.amazonaws.services.ec2.model.DeregisterImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeregisterImageRequest deregister-image-request]
    (-> this (.deregisterImage deregister-image-request))))
...
(defn delete-security-group
  ...
  (^com.amazonaws.services.ec2.model.DeleteSecurityGroupResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteSecurityGroupRequest delete-security-group-request]
    (-> this (.deleteSecurityGroup delete-security-group-request))))
...
(defn describe-volumes-modifications
  ...
  (^com.amazonaws.services.ec2.model.DescribeVolumesModificationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVolumesModificationsRequest describe-volumes-modifications-request]
    (-> this (.describeVolumesModifications describe-volumes-modifications-request))))
...
(defn reset-ebs-default-kms-key-id
  ...
  (^com.amazonaws.services.ec2.model.ResetEbsDefaultKmsKeyIdResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ResetEbsDefaultKmsKeyIdRequest reset-ebs-default-kms-key-id-request]
    (-> this (.resetEbsDefaultKmsKeyId reset-ebs-default-kms-key-id-request))))
...
(defn import-volume
  ...
  (^com.amazonaws.services.ec2.model.ImportVolumeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ImportVolumeRequest import-volume-request]
    (-> this (.importVolume import-volume-request))))
...
(defn modify-client-vpn-endpoint
  ...
  (^com.amazonaws.services.ec2.model.ModifyClientVpnEndpointResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyClientVpnEndpointRequest modify-client-vpn-endpoint-request]
    (-> this (.modifyClientVpnEndpoint modify-client-vpn-endpoint-request))))
...
(defn describe-internet-gateways
  ...
  (^com.amazonaws.services.ec2.model.DescribeInternetGatewaysResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeInternetGatewaysRequest describe-internet-gateways-request]
    (-> this (.describeInternetGateways describe-internet-gateways-request)))
  (^com.amazonaws.services.ec2.model.DescribeInternetGatewaysResult [^AmazonEC2 this]
...
(defn withdraw-byoip-cidr
  ...
  (^com.amazonaws.services.ec2.model.WithdrawByoipCidrResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.WithdrawByoipCidrRequest withdraw-byoip-cidr-request]
    (-> this (.withdrawByoipCidr withdraw-byoip-cidr-request))))
...
(defn describe-scheduled-instances
  ...
  (^com.amazonaws.services.ec2.model.DescribeScheduledInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeScheduledInstancesRequest describe-scheduled-instances-request]
    (-> this (.describeScheduledInstances describe-scheduled-instances-request))))
...
(defn describe-tags
  ...
  (^com.amazonaws.services.ec2.model.DescribeTagsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTagsRequest describe-tags-request]
    (-> this (.describeTags describe-tags-request)))
  (^com.amazonaws.services.ec2.model.DescribeTagsResult [^AmazonEC2 this]
    (-> this (.describeTags))))
...
(defn replace-transit-gateway-route
  ...
  (^com.amazonaws.services.ec2.model.ReplaceTransitGatewayRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReplaceTransitGatewayRouteRequest replace-transit-gateway-route-request]
    (-> this (.replaceTransitGatewayRoute replace-transit-gateway-route-request))))
...
(defn describe-spot-fleet-instances
  ...
  (^com.amazonaws.services.ec2.model.DescribeSpotFleetInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSpotFleetInstancesRequest describe-spot-fleet-instances-request]
    (-> this (.describeSpotFleetInstances describe-spot-fleet-instances-request))))
...
(defn import-snapshot
  ...
  (^com.amazonaws.services.ec2.model.ImportSnapshotResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ImportSnapshotRequest import-snapshot-request]
    (-> this (.importSnapshot import-snapshot-request)))
  (^com.amazonaws.services.ec2.model.ImportSnapshotResult [^AmazonEC2 this]
    (-> this (.importSnapshot))))
...
(defn run-instances
  ...
  (^com.amazonaws.services.ec2.model.RunInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RunInstancesRequest run-instances-request]
    (-> this (.runInstances run-instances-request))))

(defn set-region
  "Deprecated. use AwsClientBuilder#setRegion(String)

  region - The region this client will communicate with. See Region.getRegion(com.amazonaws.regions.Regions) for accessing a given region. Must not be null and must be a region where the service is available. - `com.amazonaws.regions.Region`"
  ([^AmazonEC2 this ^com.amazonaws.regions.Region region]
...
(defn describe-network-acls
  ...
  (^com.amazonaws.services.ec2.model.DescribeNetworkAclsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeNetworkAclsRequest describe-network-acls-request]
    (-> this (.describeNetworkAcls describe-network-acls-request)))
  (^com.amazonaws.services.ec2.model.DescribeNetworkAclsResult [^AmazonEC2 this]
...
(defn modify-image-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifyImageAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyImageAttributeRequest modify-image-attribute-request]
    (-> this (.modifyImageAttribute modify-image-attribute-request))))
...
(defn describe-spot-datafeed-subscription
  ...
  (^com.amazonaws.services.ec2.model.DescribeSpotDatafeedSubscriptionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSpotDatafeedSubscriptionRequest describe-spot-datafeed-subscription-request]
    (-> this (.describeSpotDatafeedSubscription describe-spot-datafeed-subscription-request)))
  (^com.amazonaws.services.ec2.model.DescribeSpotDatafeedSubscriptionResult [^AmazonEC2 this]
...
(defn describe-nat-gateways
  ...
  (^com.amazonaws.services.ec2.model.DescribeNatGatewaysResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeNatGatewaysRequest describe-nat-gateways-request]
    (-> this (.describeNatGateways describe-nat-gateways-request))))
...
(defn create-flow-logs
  ...
  (^com.amazonaws.services.ec2.model.CreateFlowLogsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateFlowLogsRequest create-flow-logs-request]
    (-> this (.createFlowLogs create-flow-logs-request))))
...
(defn describe-volumes
  ...
  (^com.amazonaws.services.ec2.model.DescribeVolumesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVolumesRequest describe-volumes-request]
    (-> this (.describeVolumes describe-volumes-request)))
  (^com.amazonaws.services.ec2.model.DescribeVolumesResult [^AmazonEC2 this]
...
(defn get-transit-gateway-attachment-propagations
  ...
  (^com.amazonaws.services.ec2.model.GetTransitGatewayAttachmentPropagationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetTransitGatewayAttachmentPropagationsRequest get-transit-gateway-attachment-propagations-request]
    (-> this (.getTransitGatewayAttachmentPropagations get-transit-gateway-attachment-propagations-request))))
...
(defn request-spot-fleet
  ...
  (^com.amazonaws.services.ec2.model.RequestSpotFleetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RequestSpotFleetRequest request-spot-fleet-request]
    (-> this (.requestSpotFleet request-spot-fleet-request))))
...
(defn describe-network-interfaces
  ...
  (^com.amazonaws.services.ec2.model.DescribeNetworkInterfacesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeNetworkInterfacesRequest describe-network-interfaces-request]
    (-> this (.describeNetworkInterfaces describe-network-interfaces-request)))
  (^com.amazonaws.services.ec2.model.DescribeNetworkInterfacesResult [^AmazonEC2 this]
...
(defn modify-volume
  ...
  (^com.amazonaws.services.ec2.model.ModifyVolumeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVolumeRequest modify-volume-request]
    (-> this (.modifyVolume modify-volume-request))))
...
(defn create-client-vpn-route
  ...
  (^com.amazonaws.services.ec2.model.CreateClientVpnRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateClientVpnRouteRequest create-client-vpn-route-request]
    (-> this (.createClientVpnRoute create-client-vpn-route-request))))
...
(defn describe-spot-fleet-requests
  ...
  (^com.amazonaws.services.ec2.model.DescribeSpotFleetRequestsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSpotFleetRequestsRequest describe-spot-fleet-requests-request]
    (-> this (.describeSpotFleetRequests describe-spot-fleet-requests-request)))
  (^com.amazonaws.services.ec2.model.DescribeSpotFleetRequestsResult [^AmazonEC2 this]
...
(defn describe-instance-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeInstanceAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeInstanceAttributeRequest describe-instance-attribute-request]
    (-> this (.describeInstanceAttribute describe-instance-attribute-request))))

(defn waiters
  "returns: `com.amazonaws.services.ec2.waiters.AmazonEC2Waiters`"
  (^com.amazonaws.services.ec2.waiters.AmazonEC2Waiters [^AmazonEC2 this]
    (-> this (.waiters))))
...
(defn modify-traffic-mirror-filter-network-services
  ...
  (^com.amazonaws.services.ec2.model.ModifyTrafficMirrorFilterNetworkServicesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyTrafficMirrorFilterNetworkServicesRequest modify-traffic-mirror-filter-network-services-request]
    (-> this (.modifyTrafficMirrorFilterNetworkServices modify-traffic-mirror-filter-network-services-request))))
...
(defn replace-route-table-association
  ...
  (^com.amazonaws.services.ec2.model.ReplaceRouteTableAssociationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReplaceRouteTableAssociationRequest replace-route-table-association-request]
    (-> this (.replaceRouteTableAssociation replace-route-table-association-request))))
...
(defn accept-reserved-instances-exchange-quote
  ...
  (^com.amazonaws.services.ec2.model.AcceptReservedInstancesExchangeQuoteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AcceptReservedInstancesExchangeQuoteRequest accept-reserved-instances-exchange-quote-request]
    (-> this (.acceptReservedInstancesExchangeQuote accept-reserved-instances-exchange-quote-request))))
...
(defn delete-vpc-endpoints
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpcEndpointsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpcEndpointsRequest delete-vpc-endpoints-request]
    (-> this (.deleteVpcEndpoints delete-vpc-endpoints-request))))
...
(defn search-transit-gateway-routes
  ...
  (^com.amazonaws.services.ec2.model.SearchTransitGatewayRoutesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.SearchTransitGatewayRoutesRequest search-transit-gateway-routes-request]
    (-> this (.searchTransitGatewayRoutes search-transit-gateway-routes-request))))
...
(defn create-reserved-instances-listing
  ...
  (^com.amazonaws.services.ec2.model.CreateReservedInstancesListingResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateReservedInstancesListingRequest create-reserved-instances-listing-request]
    (-> this (.createReservedInstancesListing create-reserved-instances-listing-request))))
...
(defn cancel-conversion-task
  ...
  (^com.amazonaws.services.ec2.model.CancelConversionTaskResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelConversionTaskRequest cancel-conversion-task-request]
    (-> this (.cancelConversionTask cancel-conversion-task-request))))
...
(defn accept-vpc-endpoint-connections
  ...
  (^com.amazonaws.services.ec2.model.AcceptVpcEndpointConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AcceptVpcEndpointConnectionsRequest accept-vpc-endpoint-connections-request]
    (-> this (.acceptVpcEndpointConnections accept-vpc-endpoint-connections-request))))
...
(defn describe-vpc-peering-connections
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcPeeringConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcPeeringConnectionsRequest describe-vpc-peering-connections-request]
    (-> this (.describeVpcPeeringConnections describe-vpc-peering-connections-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpcPeeringConnectionsResult [^AmazonEC2 this]
...
(defn create-transit-gateway
  ...
  (^com.amazonaws.services.ec2.model.CreateTransitGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTransitGatewayRequest create-transit-gateway-request]
    (-> this (.createTransitGateway create-transit-gateway-request))))
...
(defn describe-key-pairs
  ...
  (^com.amazonaws.services.ec2.model.DescribeKeyPairsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeKeyPairsRequest describe-key-pairs-request]
    (-> this (.describeKeyPairs describe-key-pairs-request)))
  (^com.amazonaws.services.ec2.model.DescribeKeyPairsResult [^AmazonEC2 this]
...
(defn enable-ebs-encryption-by-default
  ...
  (^com.amazonaws.services.ec2.model.EnableEbsEncryptionByDefaultResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.EnableEbsEncryptionByDefaultRequest enable-ebs-encryption-by-default-request]
    (-> this (.enableEbsEncryptionByDefault enable-ebs-encryption-by-default-request))))
...
(defn assign-private-ip-addresses
  ...
  (^com.amazonaws.services.ec2.model.AssignPrivateIpAddressesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssignPrivateIpAddressesRequest assign-private-ip-addresses-request]
    (-> this (.assignPrivateIpAddresses assign-private-ip-addresses-request))))
...
(defn describe-identity-id-format
  ...
  (^com.amazonaws.services.ec2.model.DescribeIdentityIdFormatResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeIdentityIdFormatRequest describe-identity-id-format-request]
    (-> this (.describeIdentityIdFormat describe-identity-id-format-request))))
...
(defn delete-spot-datafeed-subscription
  ...
  (^com.amazonaws.services.ec2.model.DeleteSpotDatafeedSubscriptionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteSpotDatafeedSubscriptionRequest delete-spot-datafeed-subscription-request]
    (-> this (.deleteSpotDatafeedSubscription delete-spot-datafeed-subscription-request)))
  (^com.amazonaws.services.ec2.model.DeleteSpotDatafeedSubscriptionResult [^AmazonEC2 this]
...
(defn describe-reserved-instances-offerings
  ...
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesOfferingsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeReservedInstancesOfferingsRequest describe-reserved-instances-offerings-request]
    (-> this (.describeReservedInstancesOfferings describe-reserved-instances-offerings-request)))
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesOfferingsResult [^AmazonEC2 this]
...
(defn modify-snapshot-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifySnapshotAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifySnapshotAttributeRequest modify-snapshot-attribute-request]
    (-> this (.modifySnapshotAttribute modify-snapshot-attribute-request))))
...
(defn delete-client-vpn-route
  ...
  (^com.amazonaws.services.ec2.model.DeleteClientVpnRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteClientVpnRouteRequest delete-client-vpn-route-request]
    (-> this (.deleteClientVpnRoute delete-client-vpn-route-request))))
...
(defn modify-transit-gateway-vpc-attachment
  ...
  (^com.amazonaws.services.ec2.model.ModifyTransitGatewayVpcAttachmentResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyTransitGatewayVpcAttachmentRequest modify-transit-gateway-vpc-attachment-request]
    (-> this (.modifyTransitGatewayVpcAttachment modify-transit-gateway-vpc-attachment-request))))
...
(defn modify-vpc-endpoint
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcEndpointResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcEndpointRequest modify-vpc-endpoint-request]
    (-> this (.modifyVpcEndpoint modify-vpc-endpoint-request))))
...
(defn detach-internet-gateway
  ...
  (^com.amazonaws.services.ec2.model.DetachInternetGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DetachInternetGatewayRequest detach-internet-gateway-request]
    (-> this (.detachInternetGateway detach-internet-gateway-request))))
...
(defn describe-addresses
  ...
  (^com.amazonaws.services.ec2.model.DescribeAddressesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeAddressesRequest describe-addresses-request]
    (-> this (.describeAddresses describe-addresses-request)))
  (^com.amazonaws.services.ec2.model.DescribeAddressesResult [^AmazonEC2 this]
...
(defn copy-snapshot
  ...
  (^com.amazonaws.services.ec2.model.CopySnapshotResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CopySnapshotRequest copy-snapshot-request]
...
(defn release-address
  ...
  (^com.amazonaws.services.ec2.model.ReleaseAddressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReleaseAddressRequest release-address-request]
    (-> this (.releaseAddress release-address-request))))
...
(defn delete-volume
  ...
  (^com.amazonaws.services.ec2.model.DeleteVolumeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVolumeRequest delete-volume-request]
...
(defn create-vpn-connection
  ...
  (^com.amazonaws.services.ec2.model.CreateVpnConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpnConnectionRequest create-vpn-connection-request]
    (-> this (.createVpnConnection create-vpn-connection-request))))
...
(defn describe-prefix-lists
  ...
  (^com.amazonaws.services.ec2.model.DescribePrefixListsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribePrefixListsRequest describe-prefix-lists-request]
    (-> this (.describePrefixLists describe-prefix-lists-request)))
  (^com.amazonaws.services.ec2.model.DescribePrefixListsResult [^AmazonEC2 this]
...
(defn modify-fpga-image-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifyFpgaImageAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyFpgaImageAttributeRequest modify-fpga-image-attribute-request]
    (-> this (.modifyFpgaImageAttribute modify-fpga-image-attribute-request))))
...
(defn disable-vpc-classic-link-dns-support
  ...
  (^com.amazonaws.services.ec2.model.DisableVpcClassicLinkDnsSupportResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisableVpcClassicLinkDnsSupportRequest disable-vpc-classic-link-dns-support-request]
    (-> this (.disableVpcClassicLinkDnsSupport disable-vpc-classic-link-dns-support-request))))
...
(defn describe-reserved-instances-listings
  ...
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesListingsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeReservedInstancesListingsRequest describe-reserved-instances-listings-request]
    (-> this (.describeReservedInstancesListings describe-reserved-instances-listings-request)))
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesListingsResult [^AmazonEC2 this]
...
(defn describe-byoip-cidrs
  ...
  (^com.amazonaws.services.ec2.model.DescribeByoipCidrsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeByoipCidrsRequest describe-byoip-cidrs-request]
    (-> this (.describeByoipCidrs describe-byoip-cidrs-request))))
...
(defn modify-network-interface-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifyNetworkInterfaceAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyNetworkInterfaceAttributeRequest modify-network-interface-attribute-request]
    (-> this (.modifyNetworkInterfaceAttribute modify-network-interface-attribute-request))))
...
(defn describe-vpc-endpoint-connection-notifications
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointConnectionNotificationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcEndpointConnectionNotificationsRequest describe-vpc-endpoint-connection-notifications-request]
    (-> this (.describeVpcEndpointConnectionNotifications describe-vpc-endpoint-connection-notifications-request))))
...
(defn delete-fpga-image
  ...
  (^com.amazonaws.services.ec2.model.DeleteFpgaImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteFpgaImageRequest delete-fpga-image-request]
    (-> this (.deleteFpgaImage delete-fpga-image-request))))
...
(defn create-vpc-endpoint-connection-notification
  ...
  (^com.amazonaws.services.ec2.model.CreateVpcEndpointConnectionNotificationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpcEndpointConnectionNotificationRequest create-vpc-endpoint-connection-notification-request]
    (-> this (.createVpcEndpointConnectionNotification create-vpc-endpoint-connection-notification-request))))
...
(defn describe-iam-instance-profile-associations
  ...
  (^com.amazonaws.services.ec2.model.DescribeIamInstanceProfileAssociationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeIamInstanceProfileAssociationsRequest describe-iam-instance-profile-associations-request]
    (-> this (.describeIamInstanceProfileAssociations describe-iam-instance-profile-associations-request))))
...
(defn modify-vpn-connection
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpnConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpnConnectionRequest modify-vpn-connection-request]
    (-> this (.modifyVpnConnection modify-vpn-connection-request))))
...
(defn create-launch-template
  ...
  (^com.amazonaws.services.ec2.model.CreateLaunchTemplateResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateLaunchTemplateRequest create-launch-template-request]
    (-> this (.createLaunchTemplate create-launch-template-request))))
...
(defn assign-ipv-6-addresses
  ...
  (^com.amazonaws.services.ec2.model.AssignIpv6AddressesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssignIpv6AddressesRequest assign-ipv-6-addresses-request]
    (-> this (.assignIpv6Addresses assign-ipv-6-addresses-request))))
...
(defn enable-vpc-classic-link-dns-support
  ...
  (^com.amazonaws.services.ec2.model.EnableVpcClassicLinkDnsSupportResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.EnableVpcClassicLinkDnsSupportRequest enable-vpc-classic-link-dns-support-request]
    (-> this (.enableVpcClassicLinkDnsSupport enable-vpc-classic-link-dns-support-request))))
...
(defn import-client-vpn-client-certificate-revocation-list
  ...
  (^com.amazonaws.services.ec2.model.ImportClientVpnClientCertificateRevocationListResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ImportClientVpnClientCertificateRevocationListRequest import-client-vpn-client-certificate-revocation-list-request]
    (-> this (.importClientVpnClientCertificateRevocationList import-client-vpn-client-certificate-revocation-list-request))))
...
(defn describe-elastic-gpus
  ...
  (^com.amazonaws.services.ec2.model.DescribeElasticGpusResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeElasticGpusRequest describe-elastic-gpus-request]
    (-> this (.describeElasticGpus describe-elastic-gpus-request))))
...
(defn create-vpn-gateway
  ...
  (^com.amazonaws.services.ec2.model.CreateVpnGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpnGatewayRequest create-vpn-gateway-request]
    (-> this (.createVpnGateway create-vpn-gateway-request))))
...
(defn modify-reserved-instances
  ...
  (^com.amazonaws.services.ec2.model.ModifyReservedInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyReservedInstancesRequest modify-reserved-instances-request]
    (-> this (.modifyReservedInstances modify-reserved-instances-request))))
...
(defn describe-vpc-endpoints
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcEndpointsRequest describe-vpc-endpoints-request]
    (-> this (.describeVpcEndpoints describe-vpc-endpoints-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointsResult [^AmazonEC2 this]
...
(defn get-console-screenshot
  ...
  (^com.amazonaws.services.ec2.model.GetConsoleScreenshotResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetConsoleScreenshotRequest get-console-screenshot-request]
    (-> this (.getConsoleScreenshot get-console-screenshot-request))))
...
(defn reset-snapshot-attribute
  ...
  (^com.amazonaws.services.ec2.model.ResetSnapshotAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ResetSnapshotAttributeRequest reset-snapshot-attribute-request]
    (-> this (.resetSnapshotAttribute reset-snapshot-attribute-request))))
...
(defn create-fleet
  ...
  (^com.amazonaws.services.ec2.model.CreateFleetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateFleetRequest create-fleet-request]
...
(defn get-transit-gateway-route-table-associations
  ...
  (^com.amazonaws.services.ec2.model.GetTransitGatewayRouteTableAssociationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetTransitGatewayRouteTableAssociationsRequest get-transit-gateway-route-table-associations-request]
    (-> this (.getTransitGatewayRouteTableAssociations get-transit-gateway-route-table-associations-request))))
...
(defn associate-iam-instance-profile
  ...
  (^com.amazonaws.services.ec2.model.AssociateIamInstanceProfileResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateIamInstanceProfileRequest associate-iam-instance-profile-request]
    (-> this (.associateIamInstanceProfile associate-iam-instance-profile-request))))
...
(defn delete-vpc
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpcResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpcRequest delete-vpc-request]
    (-> this (.deleteVpc delete-vpc-request))))
...
(defn modify-ebs-default-kms-key-id
  ...
  (^com.amazonaws.services.ec2.model.ModifyEbsDefaultKmsKeyIdResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyEbsDefaultKmsKeyIdRequest modify-ebs-default-kms-key-id-request]
    (-> this (.modifyEbsDefaultKmsKeyId modify-ebs-default-kms-key-id-request))))
...
(defn associate-subnet-cidr-block
  ...
  (^com.amazonaws.services.ec2.model.AssociateSubnetCidrBlockResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateSubnetCidrBlockRequest associate-subnet-cidr-block-request]
    (-> this (.associateSubnetCidrBlock associate-subnet-cidr-block-request))))
...
(defn revoke-security-group-egress
  ...
  (^com.amazonaws.services.ec2.model.RevokeSecurityGroupEgressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RevokeSecurityGroupEgressRequest revoke-security-group-egress-request]
    (-> this (.revokeSecurityGroupEgress revoke-security-group-egress-request))))
...
(defn unassign-ipv-6-addresses
  ...
  (^com.amazonaws.services.ec2.model.UnassignIpv6AddressesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.UnassignIpv6AddressesRequest unassign-ipv-6-addresses-request]
    (-> this (.unassignIpv6Addresses unassign-ipv-6-addresses-request))))
...
(defn export-client-vpn-client-configuration
  ...
  (^com.amazonaws.services.ec2.model.ExportClientVpnClientConfigurationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ExportClientVpnClientConfigurationRequest export-client-vpn-client-configuration-request]
    (-> this (.exportClientVpnClientConfiguration export-client-vpn-client-configuration-request))))
...
(defn reject-vpc-peering-connection
  ...
  (^com.amazonaws.services.ec2.model.RejectVpcPeeringConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RejectVpcPeeringConnectionRequest reject-vpc-peering-connection-request]
    (-> this (.rejectVpcPeeringConnection reject-vpc-peering-connection-request))))
...
(defn create-traffic-mirror-filter-rule
  ...
  (^com.amazonaws.services.ec2.model.CreateTrafficMirrorFilterRuleResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTrafficMirrorFilterRuleRequest create-traffic-mirror-filter-rule-request]
    (-> this (.createTrafficMirrorFilterRule create-traffic-mirror-filter-rule-request))))
...
(defn update-security-group-rule-descriptions-egress
  ...
  (^com.amazonaws.services.ec2.model.UpdateSecurityGroupRuleDescriptionsEgressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.UpdateSecurityGroupRuleDescriptionsEgressRequest update-security-group-rule-descriptions-egress-request]
    (-> this (.updateSecurityGroupRuleDescriptionsEgress update-security-group-rule-descriptions-egress-request))))
...
(defn delete-vpc-endpoint-service-configurations
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpcEndpointServiceConfigurationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpcEndpointServiceConfigurationsRequest delete-vpc-endpoint-service-configurations-request]
    (-> this (.deleteVpcEndpointServiceConfigurations delete-vpc-endpoint-service-configurations-request))))
...
(defn describe-network-interface-permissions
  ...
  (^com.amazonaws.services.ec2.model.DescribeNetworkInterfacePermissionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeNetworkInterfacePermissionsRequest describe-network-interface-permissions-request]
    (-> this (.describeNetworkInterfacePermissions describe-network-interface-permissions-request))))
...
(defn create-security-group
  ...
  (^com.amazonaws.services.ec2.model.CreateSecurityGroupResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateSecurityGroupRequest create-security-group-request]
    (-> this (.createSecurityGroup create-security-group-request))))
...
(defn describe-fpga-images
  ...
  (^com.amazonaws.services.ec2.model.DescribeFpgaImagesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeFpgaImagesRequest describe-fpga-images-request]
    (-> this (.describeFpgaImages describe-fpga-images-request))))
...
(defn cancel-reserved-instances-listing
  ...
  (^com.amazonaws.services.ec2.model.CancelReservedInstancesListingResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelReservedInstancesListingRequest cancel-reserved-instances-listing-request]
    (-> this (.cancelReservedInstancesListing cancel-reserved-instances-listing-request))))
...
(defn describe-capacity-reservations
  ...
  (^com.amazonaws.services.ec2.model.DescribeCapacityReservationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeCapacityReservationsRequest describe-capacity-reservations-request]
    (-> this (.describeCapacityReservations describe-capacity-reservations-request))))
...
(defn describe-aggregate-id-format
  ...
  (^com.amazonaws.services.ec2.model.DescribeAggregateIdFormatResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeAggregateIdFormatRequest describe-aggregate-id-format-request]
    (-> this (.describeAggregateIdFormat describe-aggregate-id-format-request))))
...
(defn export-client-vpn-client-certificate-revocation-list
  ...
  (^com.amazonaws.services.ec2.model.ExportClientVpnClientCertificateRevocationListResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ExportClientVpnClientCertificateRevocationListRequest export-client-vpn-client-certificate-revocation-list-request]
    (-> this (.exportClientVpnClientCertificateRevocationList export-client-vpn-client-certificate-revocation-list-request))))
...
(defn allocate-hosts
  ...
  (^com.amazonaws.services.ec2.model.AllocateHostsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AllocateHostsRequest allocate-hosts-request]
    (-> this (.allocateHosts allocate-hosts-request))))
...
(defn describe-transit-gateways
  ...
  (^com.amazonaws.services.ec2.model.DescribeTransitGatewaysResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTransitGatewaysRequest describe-transit-gateways-request]
    (-> this (.describeTransitGateways describe-transit-gateways-request))))
...
(defn modify-instance-placement
  ...
  (^com.amazonaws.services.ec2.model.ModifyInstancePlacementResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyInstancePlacementRequest modify-instance-placement-request]
    (-> this (.modifyInstancePlacement modify-instance-placement-request))))
...
(defn describe-traffic-mirror-filters
  ...
  (^com.amazonaws.services.ec2.model.DescribeTrafficMirrorFiltersResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTrafficMirrorFiltersRequest describe-traffic-mirror-filters-request]
    (-> this (.describeTrafficMirrorFilters describe-traffic-mirror-filters-request))))
...
(defn attach-volume
  ...
  (^com.amazonaws.services.ec2.model.AttachVolumeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AttachVolumeRequest attach-volume-request]
...
(defn create-vpc-peering-connection
  ...
  (^com.amazonaws.services.ec2.model.CreateVpcPeeringConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpcPeeringConnectionRequest create-vpc-peering-connection-request]
    (-> this (.createVpcPeeringConnection create-vpc-peering-connection-request)))
  (^com.amazonaws.services.ec2.model.CreateVpcPeeringConnectionResult [^AmazonEC2 this]
...
(defn describe-volume-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeVolumeAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVolumeAttributeRequest describe-volume-attribute-request]
    (-> this (.describeVolumeAttribute describe-volume-attribute-request))))
...
(defn modify-spot-fleet-request
  ...
  (^com.amazonaws.services.ec2.model.ModifySpotFleetRequestResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifySpotFleetRequestRequest modify-spot-fleet-request-request]
    (-> this (.modifySpotFleetRequest modify-spot-fleet-request-request))))
...
(defn get-ebs-encryption-by-default
  ...
  (^com.amazonaws.services.ec2.model.GetEbsEncryptionByDefaultResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetEbsEncryptionByDefaultRequest get-ebs-encryption-by-default-request]
    (-> this (.getEbsEncryptionByDefault get-ebs-encryption-by-default-request))))
...
(defn describe-traffic-mirror-sessions
  ...
  (^com.amazonaws.services.ec2.model.DescribeTrafficMirrorSessionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTrafficMirrorSessionsRequest describe-traffic-mirror-sessions-request]
    (-> this (.describeTrafficMirrorSessions describe-traffic-mirror-sessions-request))))
...
(defn create-capacity-reservation
  ...
  (^com.amazonaws.services.ec2.model.CreateCapacityReservationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateCapacityReservationRequest create-capacity-reservation-request]
    (-> this (.createCapacityReservation create-capacity-reservation-request))))
...
(defn describe-route-tables
  ...
  (^com.amazonaws.services.ec2.model.DescribeRouteTablesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeRouteTablesRequest describe-route-tables-request]
    (-> this (.describeRouteTables describe-route-tables-request)))
  (^com.amazonaws.services.ec2.model.DescribeRouteTablesResult [^AmazonEC2 this]
...
(defn describe-vpc-endpoint-connections
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcEndpointConnectionsRequest describe-vpc-endpoint-connections-request]
    (-> this (.describeVpcEndpointConnections describe-vpc-endpoint-connections-request))))
...
(defn describe-fleet-instances
  ...
  (^com.amazonaws.services.ec2.model.DescribeFleetInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeFleetInstancesRequest describe-fleet-instances-request]
    (-> this (.describeFleetInstances describe-fleet-instances-request))))
...
(defn describe-vpc-endpoint-service-configurations
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointServiceConfigurationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcEndpointServiceConfigurationsRequest describe-vpc-endpoint-service-configurations-request]
    (-> this (.describeVpcEndpointServiceConfigurations describe-vpc-endpoint-service-configurations-request))))
...
(defn reject-vpc-endpoint-connections
  ...
  (^com.amazonaws.services.ec2.model.RejectVpcEndpointConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RejectVpcEndpointConnectionsRequest reject-vpc-endpoint-connections-request]
    (-> this (.rejectVpcEndpointConnections reject-vpc-endpoint-connections-request))))
...
(defn enable-vpc-classic-link
  ...
  (^com.amazonaws.services.ec2.model.EnableVpcClassicLinkResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.EnableVpcClassicLinkRequest enable-vpc-classic-link-request]
    (-> this (.enableVpcClassicLink enable-vpc-classic-link-request))))
...
(defn describe-vpc-endpoint-service-permissions
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointServicePermissionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcEndpointServicePermissionsRequest describe-vpc-endpoint-service-permissions-request]
    (-> this (.describeVpcEndpointServicePermissions describe-vpc-endpoint-service-permissions-request))))
...
(defn update-security-group-rule-descriptions-ingress
  ...
  (^com.amazonaws.services.ec2.model.UpdateSecurityGroupRuleDescriptionsIngressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.UpdateSecurityGroupRuleDescriptionsIngressRequest update-security-group-rule-descriptions-ingress-request]
    (-> this (.updateSecurityGroupRuleDescriptionsIngress update-security-group-rule-descriptions-ingress-request))))
...
(defn enable-vgw-route-propagation
  ...
  (^com.amazonaws.services.ec2.model.EnableVgwRoutePropagationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.EnableVgwRoutePropagationRequest enable-vgw-route-propagation-request]
    (-> this (.enableVgwRoutePropagation enable-vgw-route-propagation-request))))
...
(defn describe-customer-gateways
  ...
  (^com.amazonaws.services.ec2.model.DescribeCustomerGatewaysResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeCustomerGatewaysRequest describe-customer-gateways-request]
    (-> this (.describeCustomerGateways describe-customer-gateways-request)))
  (^com.amazonaws.services.ec2.model.DescribeCustomerGatewaysResult [^AmazonEC2 this]
...
(defn create-network-acl
  ...
  (^com.amazonaws.services.ec2.model.CreateNetworkAclResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateNetworkAclRequest create-network-acl-request]
    (-> this (.createNetworkAcl create-network-acl-request))))
...
(defn register-image
  ...
  (^com.amazonaws.services.ec2.model.RegisterImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RegisterImageRequest register-image-request]
    (-> this (.registerImage register-image-request))))
...
(defn describe-spot-fleet-request-history
  ...
  (^com.amazonaws.services.ec2.model.DescribeSpotFleetRequestHistoryResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSpotFleetRequestHistoryRequest describe-spot-fleet-request-history-request]
    (-> this (.describeSpotFleetRequestHistory describe-spot-fleet-request-history-request))))
...
(defn run-scheduled-instances
  ...
  (^com.amazonaws.services.ec2.model.RunScheduledInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RunScheduledInstancesRequest run-scheduled-instances-request]
    (-> this (.runScheduledInstances run-scheduled-instances-request))))
...
(defn create-internet-gateway
  ...
  (^com.amazonaws.services.ec2.model.CreateInternetGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateInternetGatewayRequest create-internet-gateway-request]
    (-> this (.createInternetGateway create-internet-gateway-request)))
  (^com.amazonaws.services.ec2.model.CreateInternetGatewayResult [^AmazonEC2 this]
...
(defn detach-vpn-gateway
  ...
  (^com.amazonaws.services.ec2.model.DetachVpnGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DetachVpnGatewayRequest detach-vpn-gateway-request]
    (-> this (.detachVpnGateway detach-vpn-gateway-request))))
...
(defn create-route
  ...
  (^com.amazonaws.services.ec2.model.CreateRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateRouteRequest create-route-request]
...
(defn delete-subnet
  ...
  (^com.amazonaws.services.ec2.model.DeleteSubnetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteSubnetRequest delete-subnet-request]
    (-> this (.deleteSubnet delete-subnet-request))))
...
(defn describe-client-vpn-authorization-rules
  ...
  (^com.amazonaws.services.ec2.model.DescribeClientVpnAuthorizationRulesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeClientVpnAuthorizationRulesRequest describe-client-vpn-authorization-rules-request]
    (-> this (.describeClientVpnAuthorizationRules describe-client-vpn-authorization-rules-request))))
...
(defn create-transit-gateway-route-table
  ...
  (^com.amazonaws.services.ec2.model.CreateTransitGatewayRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTransitGatewayRouteTableRequest create-transit-gateway-route-table-request]
    (-> this (.createTransitGatewayRouteTable create-transit-gateway-route-table-request))))
...
(defn delete-vpn-connection-route
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpnConnectionRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpnConnectionRouteRequest delete-vpn-connection-route-request]
    (-> this (.deleteVpnConnectionRoute delete-vpn-connection-route-request))))
...
(defn create-vpn-connection-route
  ...
  (^com.amazonaws.services.ec2.model.CreateVpnConnectionRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpnConnectionRouteRequest create-vpn-connection-route-request]
    (-> this (.createVpnConnectionRoute create-vpn-connection-route-request))))
...
(defn disassociate-transit-gateway-route-table
  ...
  (^com.amazonaws.services.ec2.model.DisassociateTransitGatewayRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateTransitGatewayRouteTableRequest disassociate-transit-gateway-route-table-request]
    (-> this (.disassociateTransitGatewayRouteTable disassociate-transit-gateway-route-table-request))))
...
(defn monitor-instances
  ...
  (^com.amazonaws.services.ec2.model.MonitorInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.MonitorInstancesRequest monitor-instances-request]
    (-> this (.monitorInstances monitor-instances-request))))
...
(defn get-console-output
  ...
  (^com.amazonaws.services.ec2.model.GetConsoleOutputResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetConsoleOutputRequest get-console-output-request]
    (-> this (.getConsoleOutput get-console-output-request))))
...
(defn bundle-instance
  ...
  (^com.amazonaws.services.ec2.model.BundleInstanceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.BundleInstanceRequest bundle-instance-request]
    (-> this (.bundleInstance bundle-instance-request))))
...
(defn create-transit-gateway-route
  ...
  (^com.amazonaws.services.ec2.model.CreateTransitGatewayRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTransitGatewayRouteRequest create-transit-gateway-route-request]
    (-> this (.createTransitGatewayRoute create-transit-gateway-route-request))))
...
(defn disable-transit-gateway-route-table-propagation
  ...
  (^com.amazonaws.services.ec2.model.DisableTransitGatewayRouteTablePropagationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisableTransitGatewayRouteTablePropagationRequest disable-transit-gateway-route-table-propagation-request]
    (-> this (.disableTransitGatewayRouteTablePropagation disable-transit-gateway-route-table-propagation-request))))
...
(defn provision-byoip-cidr
  ...
  (^com.amazonaws.services.ec2.model.ProvisionByoipCidrResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ProvisionByoipCidrRequest provision-byoip-cidr-request]
    (-> this (.provisionByoipCidr provision-byoip-cidr-request))))
...
(defn associate-transit-gateway-route-table
  ...
  (^com.amazonaws.services.ec2.model.AssociateTransitGatewayRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateTransitGatewayRouteTableRequest associate-transit-gateway-route-table-request]
    (-> this (.associateTransitGatewayRouteTable associate-transit-gateway-route-table-request))))
...
(defn accept-vpc-peering-connection
  ...
  (^com.amazonaws.services.ec2.model.AcceptVpcPeeringConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AcceptVpcPeeringConnectionRequest accept-vpc-peering-connection-request]
    (-> this (.acceptVpcPeeringConnection accept-vpc-peering-connection-request)))
  (^com.amazonaws.services.ec2.model.AcceptVpcPeeringConnectionResult [^AmazonEC2 this]
...
(defn create-key-pair
  ...
  (^com.amazonaws.services.ec2.model.CreateKeyPairResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateKeyPairRequest create-key-pair-request]
...
(defn create-default-subnet
  ...
  (^com.amazonaws.services.ec2.model.CreateDefaultSubnetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateDefaultSubnetRequest create-default-subnet-request]
    (-> this (.createDefaultSubnet create-default-subnet-request))))
...
(defn modify-identity-id-format
  ...
  (^com.amazonaws.services.ec2.model.ModifyIdentityIdFormatResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyIdentityIdFormatRequest modify-identity-id-format-request]
    (-> this (.modifyIdentityIdFormat modify-identity-id-format-request))))
...
(defn create-traffic-mirror-session
  ...
  (^com.amazonaws.services.ec2.model.CreateTrafficMirrorSessionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTrafficMirrorSessionRequest create-traffic-mirror-session-request]
    (-> this (.createTrafficMirrorSession create-traffic-mirror-session-request))))
...
(defn create-tags
  ...
  (^com.amazonaws.services.ec2.model.CreateTagsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTagsRequest create-tags-request]
...
(defn reset-image-attribute
  ...
  (^com.amazonaws.services.ec2.model.ResetImageAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ResetImageAttributeRequest reset-image-attribute-request]
    (-> this (.resetImageAttribute reset-image-attribute-request))))
...
(defn describe-vpcs
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcsRequest describe-vpcs-request]
    (-> this (.describeVpcs describe-vpcs-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpcsResult [^AmazonEC2 this]
    (-> this (.describeVpcs))))
...
(defn cancel-spot-instance-requests
  ...
  (^com.amazonaws.services.ec2.model.CancelSpotInstanceRequestsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelSpotInstanceRequestsRequest cancel-spot-instance-requests-request]
    (-> this (.cancelSpotInstanceRequests cancel-spot-instance-requests-request))))
...
(defn associate-dhcp-options
  ...
  (^com.amazonaws.services.ec2.model.AssociateDhcpOptionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateDhcpOptionsRequest associate-dhcp-options-request]
    (-> this (.associateDhcpOptions associate-dhcp-options-request))))
...
(defn describe-principal-id-format
  ...
  (^com.amazonaws.services.ec2.model.DescribePrincipalIdFormatResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribePrincipalIdFormatRequest describe-principal-id-format-request]
    (-> this (.describePrincipalIdFormat describe-principal-id-format-request))))
...
(defn dry-run
  ...
  ([^AmazonEC2 this ^com.amazonaws.services.ec2.model.DryRunSupportedRequest request]
    (-> this (.dryRun request))))
...
(defn replace-iam-instance-profile-association
  ...
  (^com.amazonaws.services.ec2.model.ReplaceIamInstanceProfileAssociationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReplaceIamInstanceProfileAssociationRequest replace-iam-instance-profile-association-request]
    (-> this (.replaceIamInstanceProfileAssociation replace-iam-instance-profile-association-request))))
...
(defn describe-placement-groups
  ...
  (^com.amazonaws.services.ec2.model.DescribePlacementGroupsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribePlacementGroupsRequest describe-placement-groups-request]
    (-> this (.describePlacementGroups describe-placement-groups-request)))
  (^com.amazonaws.services.ec2.model.DescribePlacementGroupsResult [^AmazonEC2 this]
...
(defn associate-route-table
  ...
  (^com.amazonaws.services.ec2.model.AssociateRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateRouteTableRequest associate-route-table-request]
    (-> this (.associateRouteTable associate-route-table-request))))
...
(defn reject-transit-gateway-vpc-attachment
  ...
  (^com.amazonaws.services.ec2.model.RejectTransitGatewayVpcAttachmentResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RejectTransitGatewayVpcAttachmentRequest reject-transit-gateway-vpc-attachment-request]
    (-> this (.rejectTransitGatewayVpcAttachment reject-transit-gateway-vpc-attachment-request))))
...
(defn describe-account-attributes
  ...
  (^com.amazonaws.services.ec2.model.DescribeAccountAttributesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeAccountAttributesRequest describe-account-attributes-request]
    (-> this (.describeAccountAttributes describe-account-attributes-request)))
  (^com.amazonaws.services.ec2.model.DescribeAccountAttributesResult [^AmazonEC2 this]
...
(defn reset-instance-attribute
  ...
  (^com.amazonaws.services.ec2.model.ResetInstanceAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ResetInstanceAttributeRequest reset-instance-attribute-request]
    (-> this (.resetInstanceAttribute reset-instance-attribute-request))))
...
(defn disassociate-address
  ...
  (^com.amazonaws.services.ec2.model.DisassociateAddressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateAddressRequest disassociate-address-request]
    (-> this (.disassociateAddress disassociate-address-request))))
...
(defn disassociate-subnet-cidr-block
  ...
  (^com.amazonaws.services.ec2.model.DisassociateSubnetCidrBlockResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateSubnetCidrBlockRequest disassociate-subnet-cidr-block-request]
    (-> this (.disassociateSubnetCidrBlock disassociate-subnet-cidr-block-request))))
...
(defn delete-snapshot
  ...
  (^com.amazonaws.services.ec2.model.DeleteSnapshotResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteSnapshotRequest delete-snapshot-request]
...
(defn get-reserved-instances-exchange-quote
  ...
  (^com.amazonaws.services.ec2.model.GetReservedInstancesExchangeQuoteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetReservedInstancesExchangeQuoteRequest get-reserved-instances-exchange-quote-request]
    (-> this (.getReservedInstancesExchangeQuote get-reserved-instances-exchange-quote-request))))
...
(defn create-placement-group
  ...
  (^com.amazonaws.services.ec2.model.CreatePlacementGroupResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreatePlacementGroupRequest create-placement-group-request]
    (-> this (.createPlacementGroup create-placement-group-request))))
...
(defn terminate-client-vpn-connections
  ...
  (^com.amazonaws.services.ec2.model.TerminateClientVpnConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.TerminateClientVpnConnectionsRequest terminate-client-vpn-connections-request]
    (-> this (.terminateClientVpnConnections terminate-client-vpn-connections-request))))
...
(defn modify-vpc-endpoint-connection-notification
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcEndpointConnectionNotificationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcEndpointConnectionNotificationRequest modify-vpc-endpoint-connection-notification-request]
    (-> this (.modifyVpcEndpointConnectionNotification modify-vpc-endpoint-connection-notification-request))))
...
(defn import-image
  ...
  (^com.amazonaws.services.ec2.model.ImportImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ImportImageRequest import-image-request]
    (-> this (.importImage import-image-request)))
  (^com.amazonaws.services.ec2.model.ImportImageResult [^AmazonEC2 this]
    (-> this (.importImage))))
...
(defn describe-scheduled-instance-availability
  ...
  (^com.amazonaws.services.ec2.model.DescribeScheduledInstanceAvailabilityResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeScheduledInstanceAvailabilityRequest describe-scheduled-instance-availability-request]
    (-> this (.describeScheduledInstanceAvailability describe-scheduled-instance-availability-request))))
...
(defn get-launch-template-data
  ...
  (^com.amazonaws.services.ec2.model.GetLaunchTemplateDataResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetLaunchTemplateDataRequest get-launch-template-data-request]
    (-> this (.getLaunchTemplateData get-launch-template-data-request))))
...
(defn describe-transit-gateway-vpc-attachments
  ...
  (^com.amazonaws.services.ec2.model.DescribeTransitGatewayVpcAttachmentsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTransitGatewayVpcAttachmentsRequest describe-transit-gateway-vpc-attachments-request]
    (-> this (.describeTransitGatewayVpcAttachments describe-transit-gateway-vpc-attachments-request))))
...
(defn create-launch-template-version
  ...
  (^com.amazonaws.services.ec2.model.CreateLaunchTemplateVersionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateLaunchTemplateVersionRequest create-launch-template-version-request]
    (-> this (.createLaunchTemplateVersion create-launch-template-version-request))))
...
(defn describe-fpga-image-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeFpgaImageAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeFpgaImageAttributeRequest describe-fpga-image-attribute-request]
    (-> this (.describeFpgaImageAttribute describe-fpga-image-attribute-request))))
...
(defn modify-traffic-mirror-session
  ...
  (^com.amazonaws.services.ec2.model.ModifyTrafficMirrorSessionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyTrafficMirrorSessionRequest modify-traffic-mirror-session-request]
    (-> this (.modifyTrafficMirrorSession modify-traffic-mirror-session-request))))
...
(defn create-default-vpc
  ...
  (^com.amazonaws.services.ec2.model.CreateDefaultVpcResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateDefaultVpcRequest create-default-vpc-request]
    (-> this (.createDefaultVpc create-default-vpc-request))))
...
(defn delete-transit-gateway
  ...
  (^com.amazonaws.services.ec2.model.DeleteTransitGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTransitGatewayRequest delete-transit-gateway-request]
    (-> this (.deleteTransitGateway delete-transit-gateway-request))))
...
(defn allocate-address
  ...
  (^com.amazonaws.services.ec2.model.AllocateAddressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AllocateAddressRequest allocate-address-request]
    (-> this (.allocateAddress allocate-address-request)))
  (^com.amazonaws.services.ec2.model.AllocateAddressResult [^AmazonEC2 this]
...
(defn detach-volume
  ...
  (^com.amazonaws.services.ec2.model.DetachVolumeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DetachVolumeRequest detach-volume-request]
...
(defn delete-transit-gateway-vpc-attachment
  ...
  (^com.amazonaws.services.ec2.model.DeleteTransitGatewayVpcAttachmentResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTransitGatewayVpcAttachmentRequest delete-transit-gateway-vpc-attachment-request]
    (-> this (.deleteTransitGatewayVpcAttachment delete-transit-gateway-vpc-attachment-request))))
...
(defn describe-fleets
  ...
  (^com.amazonaws.services.ec2.model.DescribeFleetsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeFleetsRequest describe-fleets-request]
...
(defn start-instances
  ...
  (^com.amazonaws.services.ec2.model.StartInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.StartInstancesRequest start-instances-request]
    (-> this (.startInstances start-instances-request))))
...
(defn terminate-instances
  ...
  (^com.amazonaws.services.ec2.model.TerminateInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.TerminateInstancesRequest terminate-instances-request]
    (-> this (.terminateInstances terminate-instances-request))))
...
(defn unassign-private-ip-addresses
  ...
  (^com.amazonaws.services.ec2.model.UnassignPrivateIpAddressesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.UnassignPrivateIpAddressesRequest unassign-private-ip-addresses-request]
    (-> this (.unassignPrivateIpAddresses unassign-private-ip-addresses-request))))
...
(defn describe-reserved-instances-modifications
  ...
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesModificationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeReservedInstancesModificationsRequest describe-reserved-instances-modifications-request]
    (-> this (.describeReservedInstancesModifications describe-reserved-instances-modifications-request)))
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesModificationsResult [^AmazonEC2 this]
...
(defn modify-instance-credit-specification
  ...
  (^com.amazonaws.services.ec2.model.ModifyInstanceCreditSpecificationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyInstanceCreditSpecificationRequest modify-instance-credit-specification-request]
    (-> this (.modifyInstanceCreditSpecification modify-instance-credit-specification-request))))
...
(defn describe-snapshots
  ...
  (^com.amazonaws.services.ec2.model.DescribeSnapshotsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSnapshotsRequest describe-snapshots-request]
    (-> this (.describeSnapshots describe-snapshots-request)))
  (^com.amazonaws.services.ec2.model.DescribeSnapshotsResult [^AmazonEC2 this]
...
(defn move-address-to-vpc
  ...
  (^com.amazonaws.services.ec2.model.MoveAddressToVpcResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.MoveAddressToVpcRequest move-address-to-vpc-request]
    (-> this (.moveAddressToVpc move-address-to-vpc-request))))
...
(defn describe-instance-credit-specifications
  ...
  (^com.amazonaws.services.ec2.model.DescribeInstanceCreditSpecificationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeInstanceCreditSpecificationsRequest describe-instance-credit-specifications-request]
    (-> this (.describeInstanceCreditSpecifications describe-instance-credit-specifications-request))))
...
(defn describe-vpc-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcAttributeRequest describe-vpc-attribute-request]
    (-> this (.describeVpcAttribute describe-vpc-attribute-request))))
...
(defn describe-bundle-tasks
  ...
  (^com.amazonaws.services.ec2.model.DescribeBundleTasksResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeBundleTasksRequest describe-bundle-tasks-request]
    (-> this (.describeBundleTasks describe-bundle-tasks-request)))
  (^com.amazonaws.services.ec2.model.DescribeBundleTasksResult [^AmazonEC2 this]
...
(defn describe-vpc-classic-link-dns-support
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcClassicLinkDnsSupportResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcClassicLinkDnsSupportRequest describe-vpc-classic-link-dns-support-request]
    (-> this (.describeVpcClassicLinkDnsSupport describe-vpc-classic-link-dns-support-request))))
...
(defn describe-spot-price-history
  ...
  (^com.amazonaws.services.ec2.model.DescribeSpotPriceHistoryResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSpotPriceHistoryRequest describe-spot-price-history-request]
    (-> this (.describeSpotPriceHistory describe-spot-price-history-request)))
  (^com.amazonaws.services.ec2.model.DescribeSpotPriceHistoryResult [^AmazonEC2 this]
...
(defn set-endpoint
  ...
  ([^AmazonEC2 this ^java.lang.String endpoint]
...
(defn revoke-client-vpn-ingress
  ...
  (^com.amazonaws.services.ec2.model.RevokeClientVpnIngressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RevokeClientVpnIngressRequest revoke-client-vpn-ingress-request]
    (-> this (.revokeClientVpnIngress revoke-client-vpn-ingress-request))))
...
(defn modify-instance-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifyInstanceAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyInstanceAttributeRequest modify-instance-attribute-request]
    (-> this (.modifyInstanceAttribute modify-instance-attribute-request))))
...
(defn create-spot-datafeed-subscription
  ...
  (^com.amazonaws.services.ec2.model.CreateSpotDatafeedSubscriptionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateSpotDatafeedSubscriptionRequest create-spot-datafeed-subscription-request]
    (-> this (.createSpotDatafeedSubscription create-spot-datafeed-subscription-request))))
...
(defn get-transit-gateway-route-table-propagations
  ...
  (^com.amazonaws.services.ec2.model.GetTransitGatewayRouteTablePropagationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetTransitGatewayRouteTablePropagationsRequest get-transit-gateway-route-table-propagations-request]
    (-> this (.getTransitGatewayRouteTablePropagations get-transit-gateway-route-table-propagations-request))))
...
(defn detach-classic-link-vpc
  ...
  (^com.amazonaws.services.ec2.model.DetachClassicLinkVpcResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DetachClassicLinkVpcRequest detach-classic-link-vpc-request]
    (-> this (.detachClassicLinkVpc detach-classic-link-vpc-request))))
...
(defn unmonitor-instances
  ...
  (^com.amazonaws.services.ec2.model.UnmonitorInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.UnmonitorInstancesRequest unmonitor-instances-request]
    (-> this (.unmonitorInstances unmonitor-instances-request))))
...
(defn create-nat-gateway
  ...
  (^com.amazonaws.services.ec2.model.CreateNatGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateNatGatewayRequest create-nat-gateway-request]
    (-> this (.createNatGateway create-nat-gateway-request))))
...
(defn describe-vpn-connections
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpnConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpnConnectionsRequest describe-vpn-connections-request]
    (-> this (.describeVpnConnections describe-vpn-connections-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpnConnectionsResult [^AmazonEC2 this]
...
(defn describe-client-vpn-routes
  ...
  (^com.amazonaws.services.ec2.model.DescribeClientVpnRoutesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeClientVpnRoutesRequest describe-client-vpn-routes-request]
    (-> this (.describeClientVpnRoutes describe-client-vpn-routes-request))))
...
(defn import-key-pair
  ...
  (^com.amazonaws.services.ec2.model.ImportKeyPairResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ImportKeyPairRequest import-key-pair-request]
...
(defn accept-transit-gateway-vpc-attachment
  ...
  (^com.amazonaws.services.ec2.model.AcceptTransitGatewayVpcAttachmentResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AcceptTransitGatewayVpcAttachmentRequest accept-transit-gateway-vpc-attachment-request]
    (-> this (.acceptTransitGatewayVpcAttachment accept-transit-gateway-vpc-attachment-request))))
...
(defn cancel-export-task
  ...
  (^com.amazonaws.services.ec2.model.CancelExportTaskResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelExportTaskRequest cancel-export-task-request]
    (-> this (.cancelExportTask cancel-export-task-request))))
...
(defn release-hosts
  ...
  (^com.amazonaws.services.ec2.model.ReleaseHostsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReleaseHostsRequest release-hosts-request]
    (-> this (.releaseHosts release-hosts-request))))
...
(defn modify-launch-template
  ...
  (^com.amazonaws.services.ec2.model.ModifyLaunchTemplateResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyLaunchTemplateRequest modify-launch-template-request]
    (-> this (.modifyLaunchTemplate modify-launch-template-request))))
...
(defn describe-security-group-references
  ...
  (^com.amazonaws.services.ec2.model.DescribeSecurityGroupReferencesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSecurityGroupReferencesRequest describe-security-group-references-request]
    (-> this (.describeSecurityGroupReferences describe-security-group-references-request))))
...
(defn delete-internet-gateway
  ...
  (^com.amazonaws.services.ec2.model.DeleteInternetGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteInternetGatewayRequest delete-internet-gateway-request]
    (-> this (.deleteInternetGateway delete-internet-gateway-request))))
...
(defn delete-launch-template
  ...
  (^com.amazonaws.services.ec2.model.DeleteLaunchTemplateResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteLaunchTemplateRequest delete-launch-template-request]
    (-> this (.deleteLaunchTemplate delete-launch-template-request))))
...
(defn delete-nat-gateway
  ...
  (^com.amazonaws.services.ec2.model.DeleteNatGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteNatGatewayRequest delete-nat-gateway-request]
    (-> this (.deleteNatGateway delete-nat-gateway-request))))
...
(defn reset-network-interface-attribute
  ...
  (^com.amazonaws.services.ec2.model.ResetNetworkInterfaceAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ResetNetworkInterfaceAttributeRequest reset-network-interface-attribute-request]
    (-> this (.resetNetworkInterfaceAttribute reset-network-interface-attribute-request))))
...
(defn deprovision-byoip-cidr
  ...
  (^com.amazonaws.services.ec2.model.DeprovisionByoipCidrResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeprovisionByoipCidrRequest deprovision-byoip-cidr-request]
    (-> this (.deprovisionByoipCidr deprovision-byoip-cidr-request))))
...
(defn delete-vpn-gateway
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpnGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpnGatewayRequest delete-vpn-gateway-request]
    (-> this (.deleteVpnGateway delete-vpn-gateway-request))))
...
(defn describe-transit-gateway-route-tables
  ...
  (^com.amazonaws.services.ec2.model.DescribeTransitGatewayRouteTablesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTransitGatewayRouteTablesRequest describe-transit-gateway-route-tables-request]
    (-> this (.describeTransitGatewayRouteTables describe-transit-gateway-route-tables-request))))
...
(defn describe-hosts
  ...
  (^com.amazonaws.services.ec2.model.DescribeHostsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeHostsRequest describe-hosts-request]
    (-> this (.describeHosts describe-hosts-request)))
  (^com.amazonaws.services.ec2.model.DescribeHostsResult [^AmazonEC2 this]
    (-> this (.describeHosts))))
...
(defn describe-conversion-tasks
  ...
  (^com.amazonaws.services.ec2.model.DescribeConversionTasksResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeConversionTasksRequest describe-conversion-tasks-request]
    (-> this (.describeConversionTasks describe-conversion-tasks-request)))
  (^com.amazonaws.services.ec2.model.DescribeConversionTasksResult [^AmazonEC2 this]
...
(defn describe-image-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeImageAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeImageAttributeRequest describe-image-attribute-request]
    (-> this (.describeImageAttribute describe-image-attribute-request))))
...
(defn create-dhcp-options
  ...
  (^com.amazonaws.services.ec2.model.CreateDhcpOptionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateDhcpOptionsRequest create-dhcp-options-request]
    (-> this (.createDhcpOptions create-dhcp-options-request))))
...
(defn delete-transit-gateway-route-table
  ...
  (^com.amazonaws.services.ec2.model.DeleteTransitGatewayRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTransitGatewayRouteTableRequest delete-transit-gateway-route-table-request]
    (-> this (.deleteTransitGatewayRouteTable delete-transit-gateway-route-table-request))))
...
(defn purchase-scheduled-instances
  ...
  (^com.amazonaws.services.ec2.model.PurchaseScheduledInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.PurchaseScheduledInstancesRequest purchase-scheduled-instances-request]
    (-> this (.purchaseScheduledInstances purchase-scheduled-instances-request))))
...
(defn replace-network-acl-entry
  ...
  (^com.amazonaws.services.ec2.model.ReplaceNetworkAclEntryResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReplaceNetworkAclEntryRequest replace-network-acl-entry-request]
    (-> this (.replaceNetworkAclEntry replace-network-acl-entry-request))))
...
(defn modify-id-format
  ...
  (^com.amazonaws.services.ec2.model.ModifyIdFormatResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyIdFormatRequest modify-id-format-request]
    (-> this (.modifyIdFormat modify-id-format-request))))
...
(defn get-capacity-reservation-usage
  ...
  (^com.amazonaws.services.ec2.model.GetCapacityReservationUsageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetCapacityReservationUsageRequest get-capacity-reservation-usage-request]
    (-> this (.getCapacityReservationUsage get-capacity-reservation-usage-request))))
...
(defn cancel-import-task
  ...
  (^com.amazonaws.services.ec2.model.CancelImportTaskResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelImportTaskRequest cancel-import-task-request]
    (-> this (.cancelImportTask cancel-import-task-request)))
  (^com.amazonaws.services.ec2.model.CancelImportTaskResult [^AmazonEC2 this]
...
(defn describe-client-vpn-target-networks
  ...
  (^com.amazonaws.services.ec2.model.DescribeClientVpnTargetNetworksResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeClientVpnTargetNetworksRequest describe-client-vpn-target-networks-request]
    (-> this (.describeClientVpnTargetNetworks describe-client-vpn-target-networks-request))))
...
(defn attach-vpn-gateway
  ...
  (^com.amazonaws.services.ec2.model.AttachVpnGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AttachVpnGatewayRequest attach-vpn-gateway-request]
    (-> this (.attachVpnGateway attach-vpn-gateway-request))))
...
(defn create-traffic-mirror-target
  ...
  (^com.amazonaws.services.ec2.model.CreateTrafficMirrorTargetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTrafficMirrorTargetRequest create-traffic-mirror-target-request]
    (-> this (.createTrafficMirrorTarget create-traffic-mirror-target-request))))
...
(defn describe-instances
  ...
  (^com.amazonaws.services.ec2.model.DescribeInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeInstancesRequest describe-instances-request]
    (-> this (.describeInstances describe-instances-request)))
  (^com.amazonaws.services.ec2.model.DescribeInstancesResult [^AmazonEC2 this]
...
(defn export-transit-gateway-routes
  ...
  (^com.amazonaws.services.ec2.model.ExportTransitGatewayRoutesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ExportTransitGatewayRoutesRequest export-transit-gateway-routes-request]
    (-> this (.exportTransitGatewayRoutes export-transit-gateway-routes-request))))
...
(defn enable-volume-io
  ...
  (^com.amazonaws.services.ec2.model.EnableVolumeIOResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.EnableVolumeIORequest enable-volume-io-request]
    (-> this (.enableVolumeIO enable-volume-io-request))))
...
(defn get-host-reservation-purchase-preview
  ...
  (^com.amazonaws.services.ec2.model.GetHostReservationPurchasePreviewResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetHostReservationPurchasePreviewRequest get-host-reservation-purchase-preview-request]
    (-> this (.getHostReservationPurchasePreview get-host-reservation-purchase-preview-request))))
...
(defn create-customer-gateway
  ...
  (^com.amazonaws.services.ec2.model.CreateCustomerGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateCustomerGatewayRequest create-customer-gateway-request]
    (-> this (.createCustomerGateway create-customer-gateway-request))))
...
(defn modify-instance-event-start-time
  ...
  (^com.amazonaws.services.ec2.model.ModifyInstanceEventStartTimeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyInstanceEventStartTimeRequest modify-instance-event-start-time-request]
    (-> this (.modifyInstanceEventStartTime modify-instance-event-start-time-request))))
...
(defn modify-vpc-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcAttributeRequest modify-vpc-attribute-request]
    (-> this (.modifyVpcAttribute modify-vpc-attribute-request))))
...
(defn delete-client-vpn-endpoint
  ...
  (^com.amazonaws.services.ec2.model.DeleteClientVpnEndpointResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteClientVpnEndpointRequest delete-client-vpn-endpoint-request]
    (-> this (.deleteClientVpnEndpoint delete-client-vpn-endpoint-request))))
...
(defn revoke-security-group-ingress
  ...
  (^com.amazonaws.services.ec2.model.RevokeSecurityGroupIngressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RevokeSecurityGroupIngressRequest revoke-security-group-ingress-request]
    (-> this (.revokeSecurityGroupIngress revoke-security-group-ingress-request)))
  (^com.amazonaws.services.ec2.model.RevokeSecurityGroupIngressResult [^AmazonEC2 this]
...
(defn describe-flow-logs
  ...
  (^com.amazonaws.services.ec2.model.DescribeFlowLogsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeFlowLogsRequest describe-flow-logs-request]
    (-> this (.describeFlowLogs describe-flow-logs-request)))
  (^com.amazonaws.services.ec2.model.DescribeFlowLogsResult [^AmazonEC2 this]
...
(defn describe-export-tasks
  ...
  (^com.amazonaws.services.ec2.model.DescribeExportTasksResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeExportTasksRequest describe-export-tasks-request]
    (-> this (.describeExportTasks describe-export-tasks-request)))
  (^com.amazonaws.services.ec2.model.DescribeExportTasksResult [^AmazonEC2 this]
...
(defn attach-internet-gateway
  ...
  (^com.amazonaws.services.ec2.model.AttachInternetGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AttachInternetGatewayRequest attach-internet-gateway-request]
    (-> this (.attachInternetGateway attach-internet-gateway-request))))
...
(defn confirm-product-instance
  ...
  (^com.amazonaws.services.ec2.model.ConfirmProductInstanceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ConfirmProductInstanceRequest confirm-product-instance-request]
    (-> this (.confirmProductInstance confirm-product-instance-request))))
...
(defn create-egress-only-internet-gateway
  ...
  (^com.amazonaws.services.ec2.model.CreateEgressOnlyInternetGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateEgressOnlyInternetGatewayRequest create-egress-only-internet-gateway-request]
    (-> this (.createEgressOnlyInternetGateway create-egress-only-internet-gateway-request))))
...
(defn describe-public-ipv-4-pools
  ...
  (^com.amazonaws.services.ec2.model.DescribePublicIpv4PoolsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribePublicIpv4PoolsRequest describe-public-ipv-4-pools-request]
    (-> this (.describePublicIpv4Pools describe-public-ipv-4-pools-request))))
...
(defn authorize-client-vpn-ingress
  ...
  (^com.amazonaws.services.ec2.model.AuthorizeClientVpnIngressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AuthorizeClientVpnIngressRequest authorize-client-vpn-ingress-request]
    (-> this (.authorizeClientVpnIngress authorize-client-vpn-ingress-request))))
...
(defn cancel-capacity-reservation
  ...
  (^com.amazonaws.services.ec2.model.CancelCapacityReservationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelCapacityReservationRequest cancel-capacity-reservation-request]
    (-> this (.cancelCapacityReservation cancel-capacity-reservation-request))))
...
(defn replace-network-acl-association
  ...
  (^com.amazonaws.services.ec2.model.ReplaceNetworkAclAssociationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReplaceNetworkAclAssociationRequest replace-network-acl-association-request]
    (-> this (.replaceNetworkAclAssociation replace-network-acl-association-request))))
...
(defn describe-regions
  ...
  (^com.amazonaws.services.ec2.model.DescribeRegionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeRegionsRequest describe-regions-request]
    (-> this (.describeRegions describe-regions-request)))
  (^com.amazonaws.services.ec2.model.DescribeRegionsResult [^AmazonEC2 this]
...
(defn delete-flow-logs
  ...
  (^com.amazonaws.services.ec2.model.DeleteFlowLogsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteFlowLogsRequest delete-flow-logs-request]
    (-> this (.deleteFlowLogs delete-flow-logs-request))))
...
(defn advertise-byoip-cidr
  ...
  (^com.amazonaws.services.ec2.model.AdvertiseByoipCidrResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AdvertiseByoipCidrRequest advertise-byoip-cidr-request]
    (-> this (.advertiseByoipCidr advertise-byoip-cidr-request))))
...
(defn create-image
  ...
  (^com.amazonaws.services.ec2.model.CreateImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateImageRequest create-image-request]
    (-> this (.createImage create-image-request))))
...
(defn delete-traffic-mirror-target
  ...
  (^com.amazonaws.services.ec2.model.DeleteTrafficMirrorTargetResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTrafficMirrorTargetRequest delete-traffic-mirror-target-request]
    (-> this (.deleteTrafficMirrorTarget delete-traffic-mirror-target-request))))
...
(defn authorize-security-group-egress
  ...
  (^com.amazonaws.services.ec2.model.AuthorizeSecurityGroupEgressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AuthorizeSecurityGroupEgressRequest authorize-security-group-egress-request]
    (-> this (.authorizeSecurityGroupEgress authorize-security-group-egress-request))))
...
(defn describe-dhcp-options
  ...
  (^com.amazonaws.services.ec2.model.DescribeDhcpOptionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeDhcpOptionsRequest describe-dhcp-options-request]
    (-> this (.describeDhcpOptions describe-dhcp-options-request)))
  (^com.amazonaws.services.ec2.model.DescribeDhcpOptionsResult [^AmazonEC2 this]
...
(defn describe-network-interface-attribute
  ...
  (^com.amazonaws.services.ec2.model.DescribeNetworkInterfaceAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeNetworkInterfaceAttributeRequest describe-network-interface-attribute-request]
    (-> this (.describeNetworkInterfaceAttribute describe-network-interface-attribute-request))))
...
(defn modify-vpc-peering-connection-options
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcPeeringConnectionOptionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcPeeringConnectionOptionsRequest modify-vpc-peering-connection-options-request]
    (-> this (.modifyVpcPeeringConnectionOptions modify-vpc-peering-connection-options-request))))
...
(defn modify-volume-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifyVolumeAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVolumeAttributeRequest modify-volume-attribute-request]
    (-> this (.modifyVolumeAttribute modify-volume-attribute-request))))
...
(defn attach-network-interface
  ...
  (^com.amazonaws.services.ec2.model.AttachNetworkInterfaceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AttachNetworkInterfaceRequest attach-network-interface-request]
    (-> this (.attachNetworkInterface attach-network-interface-request))))
...
(defn request-spot-instances
  ...
  (^com.amazonaws.services.ec2.model.RequestSpotInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RequestSpotInstancesRequest request-spot-instances-request]
    (-> this (.requestSpotInstances request-spot-instances-request))))
...
(defn disable-ebs-encryption-by-default
  ...
  (^com.amazonaws.services.ec2.model.DisableEbsEncryptionByDefaultResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisableEbsEncryptionByDefaultRequest disable-ebs-encryption-by-default-request]
    (-> this (.disableEbsEncryptionByDefault disable-ebs-encryption-by-default-request))))
...
(defn restore-address-to-classic
  ...
  (^com.amazonaws.services.ec2.model.RestoreAddressToClassicResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RestoreAddressToClassicRequest restore-address-to-classic-request]
    (-> this (.restoreAddressToClassic restore-address-to-classic-request))))
...
(defn describe-reserved-instances
  ...
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeReservedInstancesRequest describe-reserved-instances-request]
    (-> this (.describeReservedInstances describe-reserved-instances-request)))
  (^com.amazonaws.services.ec2.model.DescribeReservedInstancesResult [^AmazonEC2 this]
...
(defn describe-stale-security-groups
  ...
  (^com.amazonaws.services.ec2.model.DescribeStaleSecurityGroupsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeStaleSecurityGroupsRequest describe-stale-security-groups-request]
    (-> this (.describeStaleSecurityGroups describe-stale-security-groups-request))))
...
(defn describe-host-reservations
  ...
  (^com.amazonaws.services.ec2.model.DescribeHostReservationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeHostReservationsRequest describe-host-reservations-request]
    (-> this (.describeHostReservations describe-host-reservations-request))))
...
(defn detach-network-interface
  ...
  (^com.amazonaws.services.ec2.model.DetachNetworkInterfaceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DetachNetworkInterfaceRequest detach-network-interface-request]
    (-> this (.detachNetworkInterface detach-network-interface-request))))
...
(defn create-client-vpn-endpoint
  ...
  (^com.amazonaws.services.ec2.model.CreateClientVpnEndpointResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateClientVpnEndpointRequest create-client-vpn-endpoint-request]
    (-> this (.createClientVpnEndpoint create-client-vpn-endpoint-request))))
...
(defn delete-egress-only-internet-gateway
  ...
  (^com.amazonaws.services.ec2.model.DeleteEgressOnlyInternetGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteEgressOnlyInternetGatewayRequest delete-egress-only-internet-gateway-request]
    (-> this (.deleteEgressOnlyInternetGateway delete-egress-only-internet-gateway-request))))
...
(defn describe-moving-addresses
  ...
  (^com.amazonaws.services.ec2.model.DescribeMovingAddressesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeMovingAddressesRequest describe-moving-addresses-request]
    (-> this (.describeMovingAddresses describe-moving-addresses-request)))
  (^com.amazonaws.services.ec2.model.DescribeMovingAddressesResult [^AmazonEC2 this]
...
(defn delete-network-interface-permission
  ...
  (^com.amazonaws.services.ec2.model.DeleteNetworkInterfacePermissionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteNetworkInterfacePermissionRequest delete-network-interface-permission-request]
    (-> this (.deleteNetworkInterfacePermission delete-network-interface-permission-request))))
...
(defn describe-vpc-endpoint-services
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointServicesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcEndpointServicesRequest describe-vpc-endpoint-services-request]
    (-> this (.describeVpcEndpointServices describe-vpc-endpoint-services-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpcEndpointServicesResult [^AmazonEC2 this]
...
(defn delete-transit-gateway-route
  ...
  (^com.amazonaws.services.ec2.model.DeleteTransitGatewayRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTransitGatewayRouteRequest delete-transit-gateway-route-request]
    (-> this (.deleteTransitGatewayRoute delete-transit-gateway-route-request))))
...
(defn copy-fpga-image
  ...
  (^com.amazonaws.services.ec2.model.CopyFpgaImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CopyFpgaImageRequest copy-fpga-image-request]
    (-> this (.copyFpgaImage copy-fpga-image-request))))
...
(defn modify-vpc-endpoint-service-configuration
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcEndpointServiceConfigurationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcEndpointServiceConfigurationRequest modify-vpc-endpoint-service-configuration-request]
    (-> this (.modifyVpcEndpointServiceConfiguration modify-vpc-endpoint-service-configuration-request))))
...
(defn delete-vpc-peering-connection
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpcPeeringConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpcPeeringConnectionRequest delete-vpc-peering-connection-request]
...
(defn describe-import-image-tasks
  ...
  (^com.amazonaws.services.ec2.model.DescribeImportImageTasksResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeImportImageTasksRequest describe-import-image-tasks-request]
    (-> this (.describeImportImageTasks describe-import-image-tasks-request)))
  (^com.amazonaws.services.ec2.model.DescribeImportImageTasksResult [^AmazonEC2 this]
...
(defn describe-host-reservation-offerings
  ...
  (^com.amazonaws.services.ec2.model.DescribeHostReservationOfferingsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeHostReservationOfferingsRequest describe-host-reservation-offerings-request]
    (-> this (.describeHostReservationOfferings describe-host-reservation-offerings-request))))
...
(defn reset-fpga-image-attribute
  ...
  (^com.amazonaws.services.ec2.model.ResetFpgaImageAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ResetFpgaImageAttributeRequest reset-fpga-image-attribute-request]
    (-> this (.resetFpgaImageAttribute reset-fpga-image-attribute-request))))
...
(defn associate-client-vpn-target-network
  ...
  (^com.amazonaws.services.ec2.model.AssociateClientVpnTargetNetworkResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateClientVpnTargetNetworkRequest associate-client-vpn-target-network-request]
    (-> this (.associateClientVpnTargetNetwork associate-client-vpn-target-network-request))))
...
(defn disassociate-vpc-cidr-block
  ...
  (^com.amazonaws.services.ec2.model.DisassociateVpcCidrBlockResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateVpcCidrBlockRequest disassociate-vpc-cidr-block-request]
    (-> this (.disassociateVpcCidrBlock disassociate-vpc-cidr-block-request))))
...
(defn modify-subnet-attribute
  ...
  (^com.amazonaws.services.ec2.model.ModifySubnetAttributeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifySubnetAttributeRequest modify-subnet-attribute-request]
    (-> this (.modifySubnetAttribute modify-subnet-attribute-request))))
...
(defn delete-key-pair
  ...
  (^com.amazonaws.services.ec2.model.DeleteKeyPairResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteKeyPairRequest delete-key-pair-request]
...
(defn describe-vpn-gateways
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpnGatewaysResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpnGatewaysRequest describe-vpn-gateways-request]
    (-> this (.describeVpnGateways describe-vpn-gateways-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpnGatewaysResult [^AmazonEC2 this]
...
(defn delete-vpc-endpoint-connection-notifications
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpcEndpointConnectionNotificationsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpcEndpointConnectionNotificationsRequest delete-vpc-endpoint-connection-notifications-request]
    (-> this (.deleteVpcEndpointConnectionNotifications delete-vpc-endpoint-connection-notifications-request))))
...
(defn copy-image
  ...
  (^com.amazonaws.services.ec2.model.CopyImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CopyImageRequest copy-image-request]
...
(defn purchase-host-reservation
  ...
  (^com.amazonaws.services.ec2.model.PurchaseHostReservationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.PurchaseHostReservationRequest purchase-host-reservation-request]
    (-> this (.purchaseHostReservation purchase-host-reservation-request))))
...
(defn disassociate-client-vpn-target-network
  ...
  (^com.amazonaws.services.ec2.model.DisassociateClientVpnTargetNetworkResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateClientVpnTargetNetworkRequest disassociate-client-vpn-target-network-request]
    (-> this (.disassociateClientVpnTargetNetwork disassociate-client-vpn-target-network-request))))
...
(defn disassociate-route-table
  ...
  (^com.amazonaws.services.ec2.model.DisassociateRouteTableResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateRouteTableRequest disassociate-route-table-request]
    (-> this (.disassociateRouteTable disassociate-route-table-request))))
...
(defn reboot-instances
  ...
  (^com.amazonaws.services.ec2.model.RebootInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.RebootInstancesRequest reboot-instances-request]
    (-> this (.rebootInstances reboot-instances-request))))
...
(defn cancel-spot-fleet-requests
  ...
  (^com.amazonaws.services.ec2.model.CancelSpotFleetRequestsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelSpotFleetRequestsRequest cancel-spot-fleet-requests-request]
    (-> this (.cancelSpotFleetRequests cancel-spot-fleet-requests-request))))
...
(defn disable-vpc-classic-link
  ...
  (^com.amazonaws.services.ec2.model.DisableVpcClassicLinkResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisableVpcClassicLinkRequest disable-vpc-classic-link-request]
    (-> this (.disableVpcClassicLink disable-vpc-classic-link-request))))
...
(defn replace-route
  ...
  (^com.amazonaws.services.ec2.model.ReplaceRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ReplaceRouteRequest replace-route-request]
    (-> this (.replaceRoute replace-route-request))))
...
(defn create-network-acl-entry
  ...
  (^com.amazonaws.services.ec2.model.CreateNetworkAclEntryResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateNetworkAclEntryRequest create-network-acl-entry-request]
    (-> this (.createNetworkAclEntry create-network-acl-entry-request))))
...
(defn associate-vpc-cidr-block
  ...
  (^com.amazonaws.services.ec2.model.AssociateVpcCidrBlockResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateVpcCidrBlockRequest associate-vpc-cidr-block-request]
    (-> this (.associateVpcCidrBlock associate-vpc-cidr-block-request))))
...
(defn delete-vpn-connection
  ...
  (^com.amazonaws.services.ec2.model.DeleteVpnConnectionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteVpnConnectionRequest delete-vpn-connection-request]
    (-> this (.deleteVpnConnection delete-vpn-connection-request))))
...
(defn describe-availability-zones
  ...
  (^com.amazonaws.services.ec2.model.DescribeAvailabilityZonesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeAvailabilityZonesRequest describe-availability-zones-request]
    (-> this (.describeAvailabilityZones describe-availability-zones-request)))
  (^com.amazonaws.services.ec2.model.DescribeAvailabilityZonesResult [^AmazonEC2 this]
...
(defn modify-vpc-tenancy
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcTenancyResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcTenancyRequest modify-vpc-tenancy-request]
    (-> this (.modifyVpcTenancy modify-vpc-tenancy-request))))
...
(defn delete-customer-gateway
  ...
  (^com.amazonaws.services.ec2.model.DeleteCustomerGatewayResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteCustomerGatewayRequest delete-customer-gateway-request]
    (-> this (.deleteCustomerGateway delete-customer-gateway-request))))
...
(defn delete-fleets
  ...
  (^com.amazonaws.services.ec2.model.DeleteFleetsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteFleetsRequest delete-fleets-request]
    (-> this (.deleteFleets delete-fleets-request))))
...
(defn delete-route
  ...
  (^com.amazonaws.services.ec2.model.DeleteRouteResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteRouteRequest delete-route-request]
...
(defn describe-client-vpn-connections
  ...
  (^com.amazonaws.services.ec2.model.DescribeClientVpnConnectionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeClientVpnConnectionsRequest describe-client-vpn-connections-request]
    (-> this (.describeClientVpnConnections describe-client-vpn-connections-request))))
...
(defn create-volume
  ...
  (^com.amazonaws.services.ec2.model.CreateVolumeResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVolumeRequest create-volume-request]
    (-> this (.createVolume create-volume-request))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonEC2 this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn modify-capacity-reservation
  ...
  (^com.amazonaws.services.ec2.model.ModifyCapacityReservationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyCapacityReservationRequest modify-capacity-reservation-request]
    (-> this (.modifyCapacityReservation modify-capacity-reservation-request))))
...
(defn create-traffic-mirror-filter
  ...
  (^com.amazonaws.services.ec2.model.CreateTrafficMirrorFilterResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTrafficMirrorFilterRequest create-traffic-mirror-filter-request]
    (-> this (.createTrafficMirrorFilter create-traffic-mirror-filter-request))))
...
(defn import-instance
  ...
  (^com.amazonaws.services.ec2.model.ImportInstanceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ImportInstanceRequest import-instance-request]
    (-> this (.importInstance import-instance-request))))
...
(defn delete-placement-group
  ...
  (^com.amazonaws.services.ec2.model.DeletePlacementGroupResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeletePlacementGroupRequest delete-placement-group-request]
    (-> this (.deletePlacementGroup delete-placement-group-request))))
...
(defn associate-address
  ...
  (^com.amazonaws.services.ec2.model.AssociateAddressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AssociateAddressRequest associate-address-request]
    (-> this (.associateAddress associate-address-request))))
...
(defn create-fpga-image
  ...
  (^com.amazonaws.services.ec2.model.CreateFpgaImageResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateFpgaImageRequest create-fpga-image-request]
    (-> this (.createFpgaImage create-fpga-image-request))))
...
(defn delete-network-interface
  ...
  (^com.amazonaws.services.ec2.model.DeleteNetworkInterfaceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteNetworkInterfaceRequest delete-network-interface-request]
    (-> this (.deleteNetworkInterface delete-network-interface-request))))
...
(defn get-ebs-default-kms-key-id
  ...
  (^com.amazonaws.services.ec2.model.GetEbsDefaultKmsKeyIdResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetEbsDefaultKmsKeyIdRequest get-ebs-default-kms-key-id-request]
    (-> this (.getEbsDefaultKmsKeyId get-ebs-default-kms-key-id-request))))
...
(defn cancel-bundle-task
  ...
  (^com.amazonaws.services.ec2.model.CancelBundleTaskResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CancelBundleTaskRequest cancel-bundle-task-request]
    (-> this (.cancelBundleTask cancel-bundle-task-request))))
...
(defn create-network-interface
  ...
  (^com.amazonaws.services.ec2.model.CreateNetworkInterfaceResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateNetworkInterfaceRequest create-network-interface-request]
    (-> this (.createNetworkInterface create-network-interface-request))))
...
(defn describe-egress-only-internet-gateways
  ...
  (^com.amazonaws.services.ec2.model.DescribeEgressOnlyInternetGatewaysResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeEgressOnlyInternetGatewaysRequest describe-egress-only-internet-gateways-request]
    (-> this (.describeEgressOnlyInternetGateways describe-egress-only-internet-gateways-request))))
...
(defn create-instance-export-task
  ...
  (^com.amazonaws.services.ec2.model.CreateInstanceExportTaskResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateInstanceExportTaskRequest create-instance-export-task-request]
    (-> this (.createInstanceExportTask create-instance-export-task-request))))
...
(defn describe-security-groups
  ...
  (^com.amazonaws.services.ec2.model.DescribeSecurityGroupsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSecurityGroupsRequest describe-security-groups-request]
    (-> this (.describeSecurityGroups describe-security-groups-request)))
  (^com.amazonaws.services.ec2.model.DescribeSecurityGroupsResult [^AmazonEC2 this]
...
(defn get-password-data
  ...
  (^com.amazonaws.services.ec2.model.GetPasswordDataResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.GetPasswordDataRequest get-password-data-request]
    (-> this (.getPasswordData get-password-data-request))))
...
(defn delete-traffic-mirror-filter
  ...
  (^com.amazonaws.services.ec2.model.DeleteTrafficMirrorFilterResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTrafficMirrorFilterRequest delete-traffic-mirror-filter-request]
    (-> this (.deleteTrafficMirrorFilter delete-traffic-mirror-filter-request))))
...
(defn attach-classic-link-vpc
  ...
  (^com.amazonaws.services.ec2.model.AttachClassicLinkVpcResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AttachClassicLinkVpcRequest attach-classic-link-vpc-request]
    (-> this (.attachClassicLinkVpc attach-classic-link-vpc-request))))
...
(defn create-network-interface-permission
  ...
  (^com.amazonaws.services.ec2.model.CreateNetworkInterfacePermissionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateNetworkInterfacePermissionRequest create-network-interface-permission-request]
    (-> this (.createNetworkInterfacePermission create-network-interface-permission-request))))
...
(defn describe-images
  ...
  (^com.amazonaws.services.ec2.model.DescribeImagesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeImagesRequest describe-images-request]
    (-> this (.describeImages describe-images-request)))
  (^com.amazonaws.services.ec2.model.DescribeImagesResult [^AmazonEC2 this]
    (-> this (.describeImages))))
...
(defn create-vpc-endpoint-service-configuration
  ...
  (^com.amazonaws.services.ec2.model.CreateVpcEndpointServiceConfigurationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpcEndpointServiceConfigurationRequest create-vpc-endpoint-service-configuration-request]
    (-> this (.createVpcEndpointServiceConfiguration create-vpc-endpoint-service-configuration-request))))
...
(defn purchase-reserved-instances-offering
  ...
  (^com.amazonaws.services.ec2.model.PurchaseReservedInstancesOfferingResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.PurchaseReservedInstancesOfferingRequest purchase-reserved-instances-offering-request]
    (-> this (.purchaseReservedInstancesOffering purchase-reserved-instances-offering-request))))
...
(defn enable-transit-gateway-route-table-propagation
  ...
  (^com.amazonaws.services.ec2.model.EnableTransitGatewayRouteTablePropagationResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.EnableTransitGatewayRouteTablePropagationRequest enable-transit-gateway-route-table-propagation-request]
    (-> this (.enableTransitGatewayRouteTablePropagation enable-transit-gateway-route-table-propagation-request))))
...
(defn describe-fleet-history
  ...
  (^com.amazonaws.services.ec2.model.DescribeFleetHistoryResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeFleetHistoryRequest describe-fleet-history-request]
    (-> this (.describeFleetHistory describe-fleet-history-request))))
...
(defn delete-launch-template-versions
  ...
  (^com.amazonaws.services.ec2.model.DeleteLaunchTemplateVersionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteLaunchTemplateVersionsRequest delete-launch-template-versions-request]
    (-> this (.deleteLaunchTemplateVersions delete-launch-template-versions-request))))
...
(defn stop-instances
  ...
  (^com.amazonaws.services.ec2.model.StopInstancesResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.StopInstancesRequest stop-instances-request]
    (-> this (.stopInstances stop-instances-request))))
...
(defn create-vpc-endpoint
  ...
  (^com.amazonaws.services.ec2.model.CreateVpcEndpointResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateVpcEndpointRequest create-vpc-endpoint-request]
    (-> this (.createVpcEndpoint create-vpc-endpoint-request))))
...
(defn describe-vpc-classic-link
  ...
  (^com.amazonaws.services.ec2.model.DescribeVpcClassicLinkResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVpcClassicLinkRequest describe-vpc-classic-link-request]
    (-> this (.describeVpcClassicLink describe-vpc-classic-link-request)))
  (^com.amazonaws.services.ec2.model.DescribeVpcClassicLinkResult [^AmazonEC2 this]
...
(defn describe-client-vpn-endpoints
  ...
  (^com.amazonaws.services.ec2.model.DescribeClientVpnEndpointsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeClientVpnEndpointsRequest describe-client-vpn-endpoints-request]
    (-> this (.describeClientVpnEndpoints describe-client-vpn-endpoints-request))))
...
(defn delete-traffic-mirror-filter-rule
  ...
  (^com.amazonaws.services.ec2.model.DeleteTrafficMirrorFilterRuleResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTrafficMirrorFilterRuleRequest delete-traffic-mirror-filter-rule-request]
    (-> this (.deleteTrafficMirrorFilterRule delete-traffic-mirror-filter-rule-request))))
...
(defn delete-dhcp-options
  ...
  (^com.amazonaws.services.ec2.model.DeleteDhcpOptionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteDhcpOptionsRequest delete-dhcp-options-request]
    (-> this (.deleteDhcpOptions delete-dhcp-options-request))))
...
(defn modify-traffic-mirror-filter-rule
  ...
  (^com.amazonaws.services.ec2.model.ModifyTrafficMirrorFilterRuleResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyTrafficMirrorFilterRuleRequest modify-traffic-mirror-filter-rule-request]
    (-> this (.modifyTrafficMirrorFilterRule modify-traffic-mirror-filter-rule-request))))
...
(defn describe-spot-instance-requests
  ...
  (^com.amazonaws.services.ec2.model.DescribeSpotInstanceRequestsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSpotInstanceRequestsRequest describe-spot-instance-requests-request]
    (-> this (.describeSpotInstanceRequests describe-spot-instance-requests-request)))
  (^com.amazonaws.services.ec2.model.DescribeSpotInstanceRequestsResult [^AmazonEC2 this]
...
(defn modify-hosts
  ...
  (^com.amazonaws.services.ec2.model.ModifyHostsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyHostsRequest modify-hosts-request]
    (-> this (.modifyHosts modify-hosts-request))))
...
(defn create-snapshot
  ...
  (^com.amazonaws.services.ec2.model.CreateSnapshotResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateSnapshotRequest create-snapshot-request]
...
(defn delete-traffic-mirror-session
  ...
  (^com.amazonaws.services.ec2.model.DeleteTrafficMirrorSessionResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteTrafficMirrorSessionRequest delete-traffic-mirror-session-request]
    (-> this (.deleteTrafficMirrorSession delete-traffic-mirror-session-request))))
...
(defn describe-transit-gateway-attachments
  ...
  (^com.amazonaws.services.ec2.model.DescribeTransitGatewayAttachmentsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeTransitGatewayAttachmentsRequest describe-transit-gateway-attachments-request]
    (-> this (.describeTransitGatewayAttachments describe-transit-gateway-attachments-request))))
...
(defn create-snapshots
  ...
  (^com.amazonaws.services.ec2.model.CreateSnapshotsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateSnapshotsRequest create-snapshots-request]
    (-> this (.createSnapshots create-snapshots-request))))
...
(defn describe-subnets
  ...
  (^com.amazonaws.services.ec2.model.DescribeSubnetsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeSubnetsRequest describe-subnets-request]
    (-> this (.describeSubnets describe-subnets-request)))
  (^com.amazonaws.services.ec2.model.DescribeSubnetsResult [^AmazonEC2 this]
...
(defn describe-import-snapshot-tasks
  ...
  (^com.amazonaws.services.ec2.model.DescribeImportSnapshotTasksResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeImportSnapshotTasksRequest describe-import-snapshot-tasks-request]
    (-> this (.describeImportSnapshotTasks describe-import-snapshot-tasks-request)))
  (^com.amazonaws.services.ec2.model.DescribeImportSnapshotTasksResult [^AmazonEC2 this]
...
(defn delete-network-acl
  ...
  (^com.amazonaws.services.ec2.model.DeleteNetworkAclResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DeleteNetworkAclRequest delete-network-acl-request]
    (-> this (.deleteNetworkAcl delete-network-acl-request))))
...
(defn describe-volume-status
  ...
  (^com.amazonaws.services.ec2.model.DescribeVolumeStatusResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DescribeVolumeStatusRequest describe-volume-status-request]
    (-> this (.describeVolumeStatus describe-volume-status-request)))
  (^com.amazonaws.services.ec2.model.DescribeVolumeStatusResult [^AmazonEC2 this]
...
(defn modify-vpc-endpoint-service-permissions
  ...
  (^com.amazonaws.services.ec2.model.ModifyVpcEndpointServicePermissionsResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.ModifyVpcEndpointServicePermissionsRequest modify-vpc-endpoint-service-permissions-request]
    (-> this (.modifyVpcEndpointServicePermissions modify-vpc-endpoint-service-permissions-request))))
...
(defn disassociate-iam-instance-profile
  ...
  (^com.amazonaws.services.ec2.model.DisassociateIamInstanceProfileResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.DisassociateIamInstanceProfileRequest disassociate-iam-instance-profile-request]
    (-> this (.disassociateIamInstanceProfile disassociate-iam-instance-profile-request))))
...
(defn create-transit-gateway-vpc-attachment
  ...
  (^com.amazonaws.services.ec2.model.CreateTransitGatewayVpcAttachmentResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.CreateTransitGatewayVpcAttachmentRequest create-transit-gateway-vpc-attachment-request]
    (-> this (.createTransitGatewayVpcAttachment create-transit-gateway-vpc-attachment-request))))
...
(defn authorize-security-group-ingress
  ...
  (^com.amazonaws.services.ec2.model.AuthorizeSecurityGroupIngressResult [^AmazonEC2 this ^com.amazonaws.services.ec2.model.AuthorizeSecurityGroupIngressRequest authorize-security-group-ingress-request]
    (-> this (.authorizeSecurityGroupIngress authorize-security-group-ingress-request))))
