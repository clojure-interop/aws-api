(ns com.amazonaws.services.elasticfilesystem.AmazonElasticFileSystemAsync
  ...
  AbstractAmazonElasticFileSystemAsync instead.
...
(defn update-file-system-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.UpdateFileSystemRequest update-file-system-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateFileSystemAsync update-file-system-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.UpdateFileSystemRequest update-file-system-request]
...
(defn delete-tags-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DeleteTagsRequest delete-tags-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteTagsAsync delete-tags-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DeleteTagsRequest delete-tags-request]
...
(defn describe-lifecycle-configuration-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeLifecycleConfigurationRequest describe-lifecycle-configuration-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeLifecycleConfigurationAsync describe-lifecycle-configuration-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeLifecycleConfigurationRequest describe-lifecycle-configuration-request]
    (-> this (.describeLifecycleConfigurationAsync describe-lifecycle-configuration-request))))
...
(defn delete-mount-target-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetRequest delete-mount-target-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteMountTargetAsync delete-mount-target-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DeleteMountTargetRequest delete-mount-target-request]
    (-> this (.deleteMountTargetAsync delete-mount-target-request))))
...
(defn put-lifecycle-configuration-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.PutLifecycleConfigurationRequest put-lifecycle-configuration-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.putLifecycleConfigurationAsync put-lifecycle-configuration-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.PutLifecycleConfigurationRequest put-lifecycle-configuration-request]
    (-> this (.putLifecycleConfigurationAsync put-lifecycle-configuration-request))))
...
(defn modify-mount-target-security-groups-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsRequest modify-mount-target-security-groups-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.modifyMountTargetSecurityGroupsAsync modify-mount-target-security-groups-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.ModifyMountTargetSecurityGroupsRequest modify-mount-target-security-groups-request]
    (-> this (.modifyMountTargetSecurityGroupsAsync modify-mount-target-security-groups-request))))
...
(defn create-file-system-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.CreateFileSystemRequest create-file-system-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createFileSystemAsync create-file-system-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.CreateFileSystemRequest create-file-system-request]
...
(defn describe-mount-targets-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsRequest describe-mount-targets-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeMountTargetsAsync describe-mount-targets-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetsRequest describe-mount-targets-request]
    (-> this (.describeMountTargetsAsync describe-mount-targets-request))))
...
(defn create-tags-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.CreateTagsRequest create-tags-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createTagsAsync create-tags-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.CreateTagsRequest create-tags-request]
...
(defn delete-file-system-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemRequest delete-file-system-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteFileSystemAsync delete-file-system-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DeleteFileSystemRequest delete-file-system-request]
...
(defn describe-file-systems-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsRequest describe-file-systems-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeFileSystemsAsync describe-file-systems-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeFileSystemsRequest describe-file-systems-request]
    (-> this (.describeFileSystemsAsync describe-file-systems-request)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this]
...
(defn describe-tags-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeTagsRequest describe-tags-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeTagsAsync describe-tags-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeTagsRequest describe-tags-request]
...
(defn create-mount-target-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.CreateMountTargetRequest create-mount-target-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createMountTargetAsync create-mount-target-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.CreateMountTargetRequest create-mount-target-request]
    (-> this (.createMountTargetAsync create-mount-target-request))))
...
(defn describe-mount-target-security-groups-async
  ...
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsRequest describe-mount-target-security-groups-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeMountTargetSecurityGroupsAsync describe-mount-target-security-groups-request async-handler)))
  (^java.util.concurrent.Future [^AmazonElasticFileSystemAsync this ^com.amazonaws.services.elasticfilesystem.model.DescribeMountTargetSecurityGroupsRequest describe-mount-target-security-groups-request]
    (-> this (.describeMountTargetSecurityGroupsAsync describe-mount-target-security-groups-request))))
