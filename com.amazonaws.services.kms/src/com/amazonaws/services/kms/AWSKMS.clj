(ns com.amazonaws.services.kms.AWSKMS
  "Interface for accessing KMS.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAWSKMS instead.
...
(defn encrypt
  ...
  (^com.amazonaws.services.kms.model.EncryptResult [^AWSKMS this ^com.amazonaws.services.kms.model.EncryptRequest encrypt-request]
    (-> this (.encrypt encrypt-request))))
...
(defn cancel-key-deletion
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.CancelKeyDeletionResult [^AWSKMS this ^com.amazonaws.services.kms.model.CancelKeyDeletionRequest cancel-key-deletion-request]
    (-> this (.cancelKeyDeletion cancel-key-deletion-request))))
...
(defn enable-key-rotation
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.EnableKeyRotationResult [^AWSKMS this ^com.amazonaws.services.kms.model.EnableKeyRotationRequest enable-key-rotation-request]
    (-> this (.enableKeyRotation enable-key-rotation-request))))

(defn set-region
  "Deprecated. use AwsClientBuilder#setRegion(String)

  region - The region this client will communicate with. See Region.getRegion(com.amazonaws.regions.Regions) for accessing a given region. Must not be null and must be a region where the service is available. - `com.amazonaws.regions.Region`"
  ([^AWSKMS this ^com.amazonaws.regions.Region region]
...
(defn import-key-material
  ...
  (^com.amazonaws.services.kms.model.ImportKeyMaterialResult [^AWSKMS this ^com.amazonaws.services.kms.model.ImportKeyMaterialRequest import-key-material-request]
    (-> this (.importKeyMaterial import-key-material-request))))
...
(defn disconnect-custom-key-store
  ...
  (^com.amazonaws.services.kms.model.DisconnectCustomKeyStoreResult [^AWSKMS this ^com.amazonaws.services.kms.model.DisconnectCustomKeyStoreRequest disconnect-custom-key-store-request]
    (-> this (.disconnectCustomKeyStore disconnect-custom-key-store-request))))
...
(defn generate-data-key-without-plaintext
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextResult [^AWSKMS this ^com.amazonaws.services.kms.model.GenerateDataKeyWithoutPlaintextRequest generate-data-key-without-plaintext-request]
    (-> this (.generateDataKeyWithoutPlaintext generate-data-key-without-plaintext-request))))
...
(defn update-key-description
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.UpdateKeyDescriptionResult [^AWSKMS this ^com.amazonaws.services.kms.model.UpdateKeyDescriptionRequest update-key-description-request]
    (-> this (.updateKeyDescription update-key-description-request))))
...
(defn untag-resource
  ...
  (^com.amazonaws.services.kms.model.UntagResourceResult [^AWSKMS this ^com.amazonaws.services.kms.model.UntagResourceRequest untag-resource-request]
...
(defn delete-custom-key-store
  ...
  (^com.amazonaws.services.kms.model.DeleteCustomKeyStoreResult [^AWSKMS this ^com.amazonaws.services.kms.model.DeleteCustomKeyStoreRequest delete-custom-key-store-request]
    (-> this (.deleteCustomKeyStore delete-custom-key-store-request))))
...
(defn delete-imported-key-material
  ...
  (^com.amazonaws.services.kms.model.DeleteImportedKeyMaterialResult [^AWSKMS this ^com.amazonaws.services.kms.model.DeleteImportedKeyMaterialRequest delete-imported-key-material-request]
    (-> this (.deleteImportedKeyMaterial delete-imported-key-material-request))))
...
(defn create-key
  ...
  throws: com.amazonaws.services.kms.model.CustomKeyStoreInvalidStateException - The request was rejected because of the ConnectionState of the custom key store. To get the ConnectionState of a custom key store, use the DescribeCustomKeyStores operation. This exception is thrown under the following conditions: You requested the CreateKey or GenerateRandom operation in a custom key store that is not connected. These operations are valid only when the custom key store ConnectionState is CONNECTED. You requested the UpdateCustomKeyStore or DeleteCustomKeyStore operation on a custom key store that is not disconnected. This operation is valid only when the custom key store ConnectionState is DISCONNECTED. You requested the ConnectCustomKeyStore operation on a custom key store with a ConnectionState of DISCONNECTING or FAILED. This operation is valid for all other ConnectionState values."
  (^com.amazonaws.services.kms.model.CreateKeyResult [^AWSKMS this ^com.amazonaws.services.kms.model.CreateKeyRequest create-key-request]
    (-> this (.createKey create-key-request)))
  (^com.amazonaws.services.kms.model.CreateKeyResult [^AWSKMS this]
    (-> this (.createKey))))
...
(defn create-alias
  ...
  (^com.amazonaws.services.kms.model.CreateAliasResult [^AWSKMS this ^com.amazonaws.services.kms.model.CreateAliasRequest create-alias-request]
...
(defn delete-alias
  ...
  throws: com.amazonaws.services.kms.model.DependencyTimeoutException - The system timed out while trying to fulfill the request. The request can be retried."
  (^com.amazonaws.services.kms.model.DeleteAliasResult [^AWSKMS this ^com.amazonaws.services.kms.model.DeleteAliasRequest delete-alias-request]
...
(defn revoke-grant
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.RevokeGrantResult [^AWSKMS this ^com.amazonaws.services.kms.model.RevokeGrantRequest revoke-grant-request]
    (-> this (.revokeGrant revoke-grant-request))))
...
(defn list-keys
  ...
  throws: com.amazonaws.services.kms.model.DependencyTimeoutException - The system timed out while trying to fulfill the request. The request can be retried."
  (^com.amazonaws.services.kms.model.ListKeysResult [^AWSKMS this ^com.amazonaws.services.kms.model.ListKeysRequest list-keys-request]
    (-> this (.listKeys list-keys-request)))
  (^com.amazonaws.services.kms.model.ListKeysResult [^AWSKMS this]
    (-> this (.listKeys))))
...
(defn schedule-key-deletion
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.ScheduleKeyDeletionResult [^AWSKMS this ^com.amazonaws.services.kms.model.ScheduleKeyDeletionRequest schedule-key-deletion-request]
    (-> this (.scheduleKeyDeletion schedule-key-deletion-request))))
...
(defn get-key-rotation-status
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.GetKeyRotationStatusResult [^AWSKMS this ^com.amazonaws.services.kms.model.GetKeyRotationStatusRequest get-key-rotation-status-request]
    (-> this (.getKeyRotationStatus get-key-rotation-status-request))))
...
(defn create-custom-key-store
  ...
  (^com.amazonaws.services.kms.model.CreateCustomKeyStoreResult [^AWSKMS this ^com.amazonaws.services.kms.model.CreateCustomKeyStoreRequest create-custom-key-store-request]
    (-> this (.createCustomKeyStore create-custom-key-store-request))))
...
(defn update-alias
  ...
  throws: com.amazonaws.services.kms.model.DependencyTimeoutException - The system timed out while trying to fulfill the request. The request can be retried."
  (^com.amazonaws.services.kms.model.UpdateAliasResult [^AWSKMS this ^com.amazonaws.services.kms.model.UpdateAliasRequest update-alias-request]
...
(defn set-endpoint
  ...
  ([^AWSKMS this ^java.lang.String endpoint]
...
(defn generate-random
  ...
  throws: com.amazonaws.services.kms.model.DependencyTimeoutException - The system timed out while trying to fulfill the request. The request can be retried."
  (^com.amazonaws.services.kms.model.GenerateRandomResult [^AWSKMS this ^com.amazonaws.services.kms.model.GenerateRandomRequest generate-random-request]
    (-> this (.generateRandom generate-random-request)))
  (^com.amazonaws.services.kms.model.GenerateRandomResult [^AWSKMS this]
    (-> this (.generateRandom))))
...
(defn get-key-policy
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.GetKeyPolicyResult [^AWSKMS this ^com.amazonaws.services.kms.model.GetKeyPolicyRequest get-key-policy-request]
    (-> this (.getKeyPolicy get-key-policy-request))))
...
(defn retire-grant
  ...
  throws: com.amazonaws.services.kms.model.InvalidArnException - The request was rejected because a specified ARN, or an ARN in a key policy, is not valid."
  (^com.amazonaws.services.kms.model.RetireGrantResult [^AWSKMS this ^com.amazonaws.services.kms.model.RetireGrantRequest retire-grant-request]
    (-> this (.retireGrant retire-grant-request)))
  (^com.amazonaws.services.kms.model.RetireGrantResult [^AWSKMS this]
    (-> this (.retireGrant))))
...
(defn list-key-policies
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.ListKeyPoliciesResult [^AWSKMS this ^com.amazonaws.services.kms.model.ListKeyPoliciesRequest list-key-policies-request]
    (-> this (.listKeyPolicies list-key-policies-request))))
...
(defn put-key-policy
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.PutKeyPolicyResult [^AWSKMS this ^com.amazonaws.services.kms.model.PutKeyPolicyRequest put-key-policy-request]
    (-> this (.putKeyPolicy put-key-policy-request))))
...
(defn generate-data-key
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.GenerateDataKeyResult [^AWSKMS this ^com.amazonaws.services.kms.model.GenerateDataKeyRequest generate-data-key-request]
    (-> this (.generateDataKey generate-data-key-request))))
...
(defn describe-custom-key-stores
  ...
  (^com.amazonaws.services.kms.model.DescribeCustomKeyStoresResult [^AWSKMS this ^com.amazonaws.services.kms.model.DescribeCustomKeyStoresRequest describe-custom-key-stores-request]
    (-> this (.describeCustomKeyStores describe-custom-key-stores-request))))
...
(defn list-resource-tags
  ...
  throws: com.amazonaws.services.kms.model.KMSInternalException - The request was rejected because an internal exception occurred. The request can be retried."
  (^com.amazonaws.services.kms.model.ListResourceTagsResult [^AWSKMS this ^com.amazonaws.services.kms.model.ListResourceTagsRequest list-resource-tags-request]
    (-> this (.listResourceTags list-resource-tags-request))))
...
(defn decrypt
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.DecryptResult [^AWSKMS this ^com.amazonaws.services.kms.model.DecryptRequest decrypt-request]
    (-> this (.decrypt decrypt-request))))
...
(defn describe-key
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.DescribeKeyResult [^AWSKMS this ^com.amazonaws.services.kms.model.DescribeKeyRequest describe-key-request]
    (-> this (.describeKey describe-key-request))))
...
(defn disable-key-rotation
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.DisableKeyRotationResult [^AWSKMS this ^com.amazonaws.services.kms.model.DisableKeyRotationRequest disable-key-rotation-request]
    (-> this (.disableKeyRotation disable-key-rotation-request))))
...
(defn list-aliases
  ...
  throws: com.amazonaws.services.kms.model.DependencyTimeoutException - The system timed out while trying to fulfill the request. The request can be retried."
  (^com.amazonaws.services.kms.model.ListAliasesResult [^AWSKMS this ^com.amazonaws.services.kms.model.ListAliasesRequest list-aliases-request]
    (-> this (.listAliases list-aliases-request)))
  (^com.amazonaws.services.kms.model.ListAliasesResult [^AWSKMS this]
    (-> this (.listAliases))))
...
(defn list-grants
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.ListGrantsResult [^AWSKMS this ^com.amazonaws.services.kms.model.ListGrantsRequest list-grants-request]
    (-> this (.listGrants list-grants-request))))
...
(defn re-encrypt
  ...
  (^com.amazonaws.services.kms.model.ReEncryptResult [^AWSKMS this ^com.amazonaws.services.kms.model.ReEncryptRequest re-encrypt-request]
    (-> this (.reEncrypt re-encrypt-request))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AWSKMS this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn create-grant
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.CreateGrantResult [^AWSKMS this ^com.amazonaws.services.kms.model.CreateGrantRequest create-grant-request]
    (-> this (.createGrant create-grant-request))))
...
(defn list-retirable-grants
  ...
  throws: com.amazonaws.services.kms.model.DependencyTimeoutException - The system timed out while trying to fulfill the request. The request can be retried."
  (^com.amazonaws.services.kms.model.ListRetirableGrantsResult [^AWSKMS this ^com.amazonaws.services.kms.model.ListRetirableGrantsRequest list-retirable-grants-request]
    (-> this (.listRetirableGrants list-retirable-grants-request))))
...
(defn tag-resource
  ...
  throws: com.amazonaws.services.kms.model.KMSInternalException - The request was rejected because an internal exception occurred. The request can be retried."
  (^com.amazonaws.services.kms.model.TagResourceResult [^AWSKMS this ^com.amazonaws.services.kms.model.TagResourceRequest tag-resource-request]
...
(defn disable-key
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.DisableKeyResult [^AWSKMS this ^com.amazonaws.services.kms.model.DisableKeyRequest disable-key-request]
    (-> this (.disableKey disable-key-request))))
...
(defn enable-key
  ...
  throws: com.amazonaws.services.kms.model.NotFoundException - The request was rejected because the specified entity or resource could not be found."
  (^com.amazonaws.services.kms.model.EnableKeyResult [^AWSKMS this ^com.amazonaws.services.kms.model.EnableKeyRequest enable-key-request]
    (-> this (.enableKey enable-key-request))))
...
(defn connect-custom-key-store
  ...
  (^com.amazonaws.services.kms.model.ConnectCustomKeyStoreResult [^AWSKMS this ^com.amazonaws.services.kms.model.ConnectCustomKeyStoreRequest connect-custom-key-store-request]
    (-> this (.connectCustomKeyStore connect-custom-key-store-request))))
...
(defn get-parameters-for-import
  ...
  throws: com.amazonaws.services.kms.model.InvalidArnException - The request was rejected because a specified ARN, or an ARN in a key policy, is not valid."
  (^com.amazonaws.services.kms.model.GetParametersForImportResult [^AWSKMS this ^com.amazonaws.services.kms.model.GetParametersForImportRequest get-parameters-for-import-request]
    (-> this (.getParametersForImport get-parameters-for-import-request))))
...
(defn update-custom-key-store
  ...
  throws: com.amazonaws.services.kms.model.CustomKeyStoreNotFoundException - The request was rejected because AWS KMS cannot find a custom key store with the specified key store name or ID."
  (^com.amazonaws.services.kms.model.UpdateCustomKeyStoreResult [^AWSKMS this ^com.amazonaws.services.kms.model.UpdateCustomKeyStoreRequest update-custom-key-store-request]
    (-> this (.updateCustomKeyStore update-custom-key-store-request))))
