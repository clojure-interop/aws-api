(ns com.amazonaws.services.securitytoken.AWSSecurityTokenService
  "Interface for accessing AWS STS.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAWSSecurityTokenService instead.
...
(defn set-region
  ...
  ([^AWSSecurityTokenService this ^com.amazonaws.regions.Region region]
...
(defn get-session-token
  ...
  (^com.amazonaws.services.securitytoken.model.GetSessionTokenResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.GetSessionTokenRequest get-session-token-request]
    (-> this (.getSessionToken get-session-token-request)))
  (^com.amazonaws.services.securitytoken.model.GetSessionTokenResult [^AWSSecurityTokenService this]
...
(defn get-access-key-info
  ...
  (^com.amazonaws.services.securitytoken.model.GetAccessKeyInfoResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.GetAccessKeyInfoRequest get-access-key-info-request]
    (-> this (.getAccessKeyInfo get-access-key-info-request))))
...
(defn get-caller-identity
  ...
  (^com.amazonaws.services.securitytoken.model.GetCallerIdentityResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.GetCallerIdentityRequest get-caller-identity-request]
    (-> this (.getCallerIdentity get-caller-identity-request))))
...
(defn assume-role-with-saml
  ...
  (^com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.AssumeRoleWithSAMLRequest assume-role-with-saml-request]
    (-> this (.assumeRoleWithSAML assume-role-with-saml-request))))
...
(defn assume-role-with-web-identity
  ...
  throws: com.amazonaws.services.securitytoken.model.MalformedPolicyDocumentException - The request was rejected because the policy document was malformed. The error message describes the specific error."
  (^com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.AssumeRoleWithWebIdentityRequest assume-role-with-web-identity-request]
    (-> this (.assumeRoleWithWebIdentity assume-role-with-web-identity-request))))
...
(defn assume-role
  ...
  throws: com.amazonaws.services.securitytoken.model.MalformedPolicyDocumentException - The request was rejected because the policy document was malformed. The error message describes the specific error."
  (^com.amazonaws.services.securitytoken.model.AssumeRoleResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.AssumeRoleRequest assume-role-request]
    (-> this (.assumeRole assume-role-request))))

(defn shutdown
  "Shuts down this client object, releasing any resources that might be held open. This is an optional method, and
   callers are not expected to call it, but can if they want to explicitly release any open resources. Once a client
   has been shutdown, it should not be used to make any more requests."
  ([^AWSSecurityTokenService this]
    (-> this (.shutdown))))
...
(defn decode-authorization-message
  ...
  (^com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.DecodeAuthorizationMessageRequest decode-authorization-message-request]
    (-> this (.decodeAuthorizationMessage decode-authorization-message-request))))
...
(defn set-endpoint
  ...
  ([^AWSSecurityTokenService this ^java.lang.String endpoint]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AWSSecurityTokenService this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn get-federation-token
  ...
  throws: com.amazonaws.services.securitytoken.model.MalformedPolicyDocumentException - The request was rejected because the policy document was malformed. The error message describes the specific error."
  (^com.amazonaws.services.securitytoken.model.GetFederationTokenResult [^AWSSecurityTokenService this ^com.amazonaws.services.securitytoken.model.GetFederationTokenRequest get-federation-token-request]
