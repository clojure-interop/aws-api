(ns com.amazonaws.services.directory.AWSDirectoryServiceAsyncClient
  ...
  (:import [com.amazonaws.services.directory AWSDirectoryServiceAsyncClient]))

(defn ->aws-directory-service-async-client
  "Constructor.
  ...
  (^AWSDirectoryServiceAsyncClient [^com.amazonaws.auth.AWSCredentials aws-credentials ^com.amazonaws.ClientConfiguration client-configuration ^java.util.concurrent.ExecutorService executor-service]
    (new AWSDirectoryServiceAsyncClient aws-credentials client-configuration executor-service))
  (^AWSDirectoryServiceAsyncClient [^com.amazonaws.auth.AWSCredentials aws-credentials ^java.util.concurrent.ExecutorService executor-service]
    (new AWSDirectoryServiceAsyncClient aws-credentials executor-service))
  (^AWSDirectoryServiceAsyncClient [^com.amazonaws.ClientConfiguration client-configuration]
    (new AWSDirectoryServiceAsyncClient client-configuration))
  (^AWSDirectoryServiceAsyncClient []
    (new AWSDirectoryServiceAsyncClient )))

(defn *async-builder
  "returns: `com.amazonaws.services.directory.AWSDirectoryServiceAsyncClientBuilder`"
  (^com.amazonaws.services.directory.AWSDirectoryServiceAsyncClientBuilder []
    (AWSDirectoryServiceAsyncClient/asyncBuilder )))
...
(defn disable-radius-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DisableRadiusRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.disableRadiusAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DisableRadiusRequest request]
...
(defn delete-trust-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteTrustRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteTrustAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteTrustRequest request]
...
(defn describe-directories-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeDirectoriesRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeDirectoriesAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeDirectoriesRequest request]
    (-> this (.describeDirectoriesAsync request)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this]
...
(defn verify-trust-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.VerifyTrustRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.verifyTrustAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.VerifyTrustRequest request]
...
(defn start-schema-extension-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.StartSchemaExtensionRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.startSchemaExtensionAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.StartSchemaExtensionRequest request]
...
(defn create-microsoft-ad-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateMicrosoftADRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createMicrosoftADAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateMicrosoftADRequest request]
...
(defn describe-domain-controllers-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeDomainControllersRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeDomainControllersAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeDomainControllersRequest request]
...
(defn get-executor-service
  ...
  (^java.util.concurrent.ExecutorService [^AWSDirectoryServiceAsyncClient this]
...
(defn connect-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ConnectDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.connectDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ConnectDirectoryRequest request]
...
(defn reject-shared-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RejectSharedDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.rejectSharedDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RejectSharedDirectoryRequest request]
...
(defn enable-radius-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.EnableRadiusRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.enableRadiusAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.EnableRadiusRequest request]
...
(defn create-alias-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateAliasRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createAliasAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateAliasRequest request]
...
(defn accept-shared-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.AcceptSharedDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.acceptSharedDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.AcceptSharedDirectoryRequest request]
...
(defn cancel-schema-extension-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CancelSchemaExtensionRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.cancelSchemaExtensionAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CancelSchemaExtensionRequest request]
...
(defn create-conditional-forwarder-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateConditionalForwarderRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createConditionalForwarderAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateConditionalForwarderRequest request]
...
(defn create-log-subscription-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateLogSubscriptionRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createLogSubscriptionAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateLogSubscriptionRequest request]
...
(defn restore-from-snapshot-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RestoreFromSnapshotRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.restoreFromSnapshotAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RestoreFromSnapshotRequest request]
...
(defn share-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ShareDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.shareDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ShareDirectoryRequest request]
...
(defn list-log-subscriptions-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListLogSubscriptionsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listLogSubscriptionsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListLogSubscriptionsRequest request]
...
(defn update-radius-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateRadiusRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateRadiusAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateRadiusRequest request]
...
(defn create-snapshot-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateSnapshotRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createSnapshotAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateSnapshotRequest request]
...
(defn describe-shared-directories-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeSharedDirectoriesRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeSharedDirectoriesAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeSharedDirectoriesRequest request]
...
(defn enable-sso-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.EnableSsoRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.enableSsoAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.EnableSsoRequest request]
...
(defn create-computer-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateComputerRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createComputerAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateComputerRequest request]
...
(defn add-ip-routes-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.AddIpRoutesRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.addIpRoutesAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.AddIpRoutesRequest request]
...
(defn update-conditional-forwarder-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateConditionalForwarderRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateConditionalForwarderAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateConditionalForwarderRequest request]
...
(defn unshare-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UnshareDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.unshareDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UnshareDirectoryRequest request]
...
(defn describe-conditional-forwarders-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeConditionalForwardersRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeConditionalForwardersAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeConditionalForwardersRequest request]
...
(defn shutdown
  "Shuts down the client, releasing all managed resources. This includes forcibly terminating all pending
   ...
   calling this method."
  ([^AWSDirectoryServiceAsyncClient this]
    (-> this (.shutdown))))
...
(defn describe-event-topics-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeEventTopicsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeEventTopicsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeEventTopicsRequest request]
...
(defn describe-trusts-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeTrustsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeTrustsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeTrustsRequest request]
...
(defn update-trust-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateTrustRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateTrustAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateTrustRequest request]
...
(defn deregister-event-topic-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeregisterEventTopicRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deregisterEventTopicAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeregisterEventTopicRequest request]
...
(defn create-trust-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateTrustRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createTrustAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateTrustRequest request]
...
(defn describe-snapshots-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeSnapshotsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeSnapshotsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DescribeSnapshotsRequest request]
...
(defn get-directory-limits-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.GetDirectoryLimitsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getDirectoryLimitsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.GetDirectoryLimitsRequest request]
...
(defn remove-tags-from-resource-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RemoveTagsFromResourceRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.removeTagsFromResourceAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RemoveTagsFromResourceRequest request]
...
(defn delete-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteDirectoryRequest request]
...
(defn list-tags-for-resource-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListTagsForResourceRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listTagsForResourceAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListTagsForResourceRequest request]
...
(defn register-event-topic-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RegisterEventTopicRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.registerEventTopicAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RegisterEventTopicRequest request]
...
(defn create-directory-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateDirectoryRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createDirectoryAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.CreateDirectoryRequest request]
...
(defn get-snapshot-limits-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.GetSnapshotLimitsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getSnapshotLimitsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.GetSnapshotLimitsRequest request]
...
(defn delete-conditional-forwarder-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteConditionalForwarderRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteConditionalForwarderAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteConditionalForwarderRequest request]
...
(defn reset-user-password-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ResetUserPasswordRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.resetUserPasswordAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ResetUserPasswordRequest request]
...
(defn delete-log-subscription-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteLogSubscriptionRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteLogSubscriptionAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteLogSubscriptionRequest request]
...
(defn list-schema-extensions-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListSchemaExtensionsRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listSchemaExtensionsAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListSchemaExtensionsRequest request]
...
(defn disable-sso-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DisableSsoRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.disableSsoAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DisableSsoRequest request]
...
(defn update-number-of-domain-controllers-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateNumberOfDomainControllersAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.UpdateNumberOfDomainControllersRequest request]
...
(defn add-tags-to-resource-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.AddTagsToResourceRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.addTagsToResourceAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.AddTagsToResourceRequest request]
...
(defn list-ip-routes-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListIpRoutesRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listIpRoutesAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.ListIpRoutesRequest request]
...
(defn delete-snapshot-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteSnapshotRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteSnapshotAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.DeleteSnapshotRequest request]
...
(defn remove-ip-routes-async
  ...
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RemoveIpRoutesRequest request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.removeIpRoutesAsync request async-handler)))
  (^java.util.concurrent.Future [^AWSDirectoryServiceAsyncClient this ^com.amazonaws.services.directory.model.RemoveIpRoutesRequest request]
