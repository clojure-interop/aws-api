(ns com.amazonaws.services.secretsmanager.AWSSecretsManagerAsync
...
(defn untag-resource-async
  ...
  untag-resource-request - `com.amazonaws.services.secretsmanager.model.UntagResourceRequest`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.UntagResourceRequest untag-resource-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.untagResourceAsync untag-resource-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.UntagResourceRequest untag-resource-request]
...
(defn rotate-secret-async
  "Configures and starts the asynchronous process of rotating this secret. If you include the configuration
   ...
   secret with the staging label AWSCURRENT so that your clients all immediately begin to use the new
  ...
  rotate-secret-request - `com.amazonaws.services.secretsmanager.model.RotateSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.RotateSecretRequest rotate-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.rotateSecretAsync rotate-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.RotateSecretRequest rotate-secret-request]
    (-> this (.rotateSecretAsync rotate-secret-request))))
...
(defn list-secrets-async
  "Lists all of the secrets that are stored by Secrets Manager in the AWS account. To list the versions currently
   stored for a specific secret, use ListSecretVersionIds. The encrypted fields SecretString and
   SecretBinary are not included in the output. To get that information, call the GetSecretValue
   operation.
   ...
   more results available. When this happens, the NextToken response parameter contains a value to pass
  ...
  list-secrets-request - `com.amazonaws.services.secretsmanager.model.ListSecretsRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.ListSecretsRequest list-secrets-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listSecretsAsync list-secrets-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.ListSecretsRequest list-secrets-request]
    (-> this (.listSecretsAsync list-secrets-request))))
...
(defn cancel-rotate-secret-async
  "Disables automatic scheduled rotation and cancels the rotation of a secret if one is currently in progress.
   ...
   If you cancel a rotation that is in progress, it can leave the VersionStage labels in an unexpected
   ...
   do by removing all staging labels from the new version's VersionStage field.
  ...
  cancel-rotate-secret-request - `com.amazonaws.services.secretsmanager.model.CancelRotateSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.CancelRotateSecretRequest cancel-rotate-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.cancelRotateSecretAsync cancel-rotate-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.CancelRotateSecretRequest cancel-rotate-secret-request]
    (-> this (.cancelRotateSecretAsync cancel-rotate-secret-request))))

(defn update-secret-async
  "Modifies many of the details of the specified secret. If you include a ClientRequestToken and
   either SecretString or SecretBinary then it also creates a new version attached
   to the secret.
   ...
   SecretBinary for a secret in the same account as the calling user and that secret doesn't specify a
   AWS KMS encryption key, Secrets Manager uses the account's default AWS managed customer master key (CMK) with the
   alias aws/secretsmanager. If this key doesn't already exist in your account then Secrets Manager
   ...
   secret when you create the secret or when you update it by including it in the KMSKeyId. If you call
   an API that must encrypt or decrypt SecretString or SecretBinary using credentials from
  ...
  update-secret-request - `com.amazonaws.services.secretsmanager.model.UpdateSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.UpdateSecretRequest update-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateSecretAsync update-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.UpdateSecretRequest update-secret-request]
    (-> this (.updateSecretAsync update-secret-request))))
...
(defn describe-secret-async
  ...
  describe-secret-request - `com.amazonaws.services.secretsmanager.model.DescribeSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.DescribeSecretRequest describe-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeSecretAsync describe-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.DescribeSecretRequest describe-secret-request]
    (-> this (.describeSecretAsync describe-secret-request))))
...
(defn update-secret-version-stage-async
  ...
  update-secret-version-stage-request - `com.amazonaws.services.secretsmanager.model.UpdateSecretVersionStageRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.UpdateSecretVersionStageRequest update-secret-version-stage-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateSecretVersionStageAsync update-secret-version-stage-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.UpdateSecretVersionStageRequest update-secret-version-stage-request]
    (-> this (.updateSecretVersionStageAsync update-secret-version-stage-request))))
...
(defn get-secret-value-async
  ...
  get-secret-value-request - `com.amazonaws.services.secretsmanager.model.GetSecretValueRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.GetSecretValueRequest get-secret-value-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getSecretValueAsync get-secret-value-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.GetSecretValueRequest get-secret-value-request]
    (-> this (.getSecretValueAsync get-secret-value-request))))
...
(defn create-secret-async
  ...
  create-secret-request - `com.amazonaws.services.secretsmanager.model.CreateSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.CreateSecretRequest create-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createSecretAsync create-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.CreateSecretRequest create-secret-request]
    (-> this (.createSecretAsync create-secret-request))))
...
(defn put-secret-value-async
  "Stores a new encrypted secret value in the specified secret. To do this, the operation creates a new version and
   ...
   The Secrets Manager console uses only the SecretString field. To add binary data to a secret with
   the SecretBinary field you must use the AWS CLI or one of the AWS SDKs.
   ...
   labels other than those that you explicitly specify in the VersionStages parameter.




   If this operation moves the staging label AWSCURRENT from another version to this version (because
   you included it in the StagingLabels parameter) then Secrets Manager also automatically moves the
  ...
  put-secret-value-request - `com.amazonaws.services.secretsmanager.model.PutSecretValueRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.PutSecretValueRequest put-secret-value-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.putSecretValueAsync put-secret-value-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.PutSecretValueRequest put-secret-value-request]
    (-> this (.putSecretValueAsync put-secret-value-request))))
...
(defn get-random-password-async
  ...
  get-random-password-request - `com.amazonaws.services.secretsmanager.model.GetRandomPasswordRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.GetRandomPasswordRequest get-random-password-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getRandomPasswordAsync get-random-password-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.GetRandomPasswordRequest get-random-password-request]
    (-> this (.getRandomPasswordAsync get-random-password-request))))
...
(defn delete-resource-policy-async
  ...
  delete-resource-policy-request - `com.amazonaws.services.secretsmanager.model.DeleteResourcePolicyRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.DeleteResourcePolicyRequest delete-resource-policy-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteResourcePolicyAsync delete-resource-policy-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.DeleteResourcePolicyRequest delete-resource-policy-request]
...
(defn list-secret-version-ids-async
  ...
  list-secret-version-ids-request - `com.amazonaws.services.secretsmanager.model.ListSecretVersionIdsRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.ListSecretVersionIdsRequest list-secret-version-ids-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listSecretVersionIdsAsync list-secret-version-ids-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.ListSecretVersionIdsRequest list-secret-version-ids-request]
    (-> this (.listSecretVersionIdsAsync list-secret-version-ids-request))))
...
(defn restore-secret-async
  ...
  restore-secret-request - `com.amazonaws.services.secretsmanager.model.RestoreSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.RestoreSecretRequest restore-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.restoreSecretAsync restore-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.RestoreSecretRequest restore-secret-request]
    (-> this (.restoreSecretAsync restore-secret-request))))
...
(defn put-resource-policy-async
  ...
  put-resource-policy-request - `com.amazonaws.services.secretsmanager.model.PutResourcePolicyRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.PutResourcePolicyRequest put-resource-policy-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.putResourcePolicyAsync put-resource-policy-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.PutResourcePolicyRequest put-resource-policy-request]
...
(defn get-resource-policy-async
  ...
  get-resource-policy-request - `com.amazonaws.services.secretsmanager.model.GetResourcePolicyRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.GetResourcePolicyRequest get-resource-policy-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getResourcePolicyAsync get-resource-policy-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.GetResourcePolicyRequest get-resource-policy-request]
...
(defn tag-resource-async
  ...
  tag-resource-request - `com.amazonaws.services.secretsmanager.model.TagResourceRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.TagResourceRequest tag-resource-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.tagResourceAsync tag-resource-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.TagResourceRequest tag-resource-request]
...
(defn delete-secret-async
  ...
  delete-secret-request - `com.amazonaws.services.secretsmanager.model.DeleteSecretRequest`
  async-handler - Asynchronous callback handler for events in the lifecycle of the request. Users can provide an implementation of the callback methods in this interface to receive notification of successful or unsuccessful completion of the operation. - `com.amazonaws.handlers.AsyncHandler`
  ...
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.DeleteSecretRequest delete-secret-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteSecretAsync delete-secret-request async-handler)))
  (^java.util.concurrent.Future [^AWSSecretsManagerAsync this ^com.amazonaws.services.secretsmanager.model.DeleteSecretRequest delete-secret-request]
    (-> this (.deleteSecretAsync delete-secret-request))))
