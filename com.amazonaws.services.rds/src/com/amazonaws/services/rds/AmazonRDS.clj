(ns com.amazonaws.services.rds.AmazonRDS
  "Interface for accessing Amazon RDS.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAmazonRDS instead.
...
(defn create-db-cluster-endpoint
  ...
  (^com.amazonaws.services.rds.model.CreateDBClusterEndpointResult [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBClusterEndpointRequest create-db-cluster-endpoint-request]
    (-> this (.createDBClusterEndpoint create-db-cluster-endpoint-request))))
...
(defn stop-db-cluster
  ...
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.StopDBClusterRequest stop-db-cluster-request]
...
(defn modify-db-cluster-snapshot-attribute
  ...
  (^com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBClusterSnapshotAttributeRequest modify-db-cluster-snapshot-attribute-request]
...
(defn create-db-instance
  ...
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBInstanceRequest create-db-instance-request]
...
(defn list-tags-for-resource
  ...
  (^com.amazonaws.services.rds.model.ListTagsForResourceResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ListTagsForResourceRequest list-tags-for-resource-request]
...
(defn modify-db-snapshot-attribute
  ...
  (^com.amazonaws.services.rds.model.DBSnapshotAttributesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBSnapshotAttributeRequest modify-db-snapshot-attribute-request]
    (-> this (.modifyDBSnapshotAttribute modify-db-snapshot-attribute-request))))
...
(defn describe-db-security-groups
  ...
  (^com.amazonaws.services.rds.model.DescribeDBSecurityGroupsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBSecurityGroupsRequest describe-db-security-groups-request]
    (-> this (.describeDBSecurityGroups describe-db-security-groups-request)))
  (^com.amazonaws.services.rds.model.DescribeDBSecurityGroupsResult [^AmazonRDS this]
...
(defn stop-db-instance
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.StopDBInstanceRequest stop-db-instance-request]
    (-> this (.stopDBInstance stop-db-instance-request))))
...
(defn modify-db-subnet-group
  ...
  (^com.amazonaws.services.rds.model.DBSubnetGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBSubnetGroupRequest modify-db-subnet-group-request]
...
(defn stop-activity-stream
  ...
  (^com.amazonaws.services.rds.model.StopActivityStreamResult [^AmazonRDS this ^com.amazonaws.services.rds.model.StopActivityStreamRequest stop-activity-stream-request]
    (-> this (.stopActivityStream stop-activity-stream-request))))
...
(defn describe-db-cluster-snapshot-attributes
  ...
  throws: com.amazonaws.services.rds.model.DBClusterSnapshotNotFoundException - DBClusterSnapshotIdentifier doesn't refer to an existing DB cluster snapshot."
  (^com.amazonaws.services.rds.model.DBClusterSnapshotAttributesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClusterSnapshotAttributesRequest describe-db-cluster-snapshot-attributes-request]
...
(defn set-region
  ...
  ([^AmazonRDS this ^com.amazonaws.regions.Region region]
...
(defn describe-db-subnet-groups
  ...
  throws: com.amazonaws.services.rds.model.DBSubnetGroupNotFoundException - DBSubnetGroupName doesn't refer to an existing DB subnet group."
  (^com.amazonaws.services.rds.model.DescribeDBSubnetGroupsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBSubnetGroupsRequest describe-db-subnet-groups-request]
    (-> this (.describeDBSubnetGroups describe-db-subnet-groups-request)))
  (^com.amazonaws.services.rds.model.DescribeDBSubnetGroupsResult [^AmazonRDS this]
...
(defn reboot-db-instance
  ...
  throws: com.amazonaws.services.rds.model.InvalidDBInstanceStateException - The DB instance isn't in a valid state."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.RebootDBInstanceRequest reboot-db-instance-request]
...
(defn copy-db-parameter-group
  ...
  (^com.amazonaws.services.rds.model.DBParameterGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CopyDBParameterGroupRequest copy-db-parameter-group-request]
...
(defn delete-db-cluster-snapshot
  ...
  (^com.amazonaws.services.rds.model.DBClusterSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBClusterSnapshotRequest delete-db-cluster-snapshot-request]
...
(defn create-db-security-group
  ...
  (^com.amazonaws.services.rds.model.DBSecurityGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBSecurityGroupRequest create-db-security-group-request]
    (-> this (.createDBSecurityGroup create-db-security-group-request))))
...
(defn create-event-subscription
  ...
  (^com.amazonaws.services.rds.model.EventSubscription [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateEventSubscriptionRequest create-event-subscription-request]
...
(defn waiters
  ...
  (^com.amazonaws.services.rds.waiters.AmazonRDSWaiters [^AmazonRDS this]
    (-> this (.waiters))))
...
(defn describe-event-subscriptions
  ...
  (^com.amazonaws.services.rds.model.DescribeEventSubscriptionsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeEventSubscriptionsRequest describe-event-subscriptions-request]
    (-> this (.describeEventSubscriptions describe-event-subscriptions-request)))
  (^com.amazonaws.services.rds.model.DescribeEventSubscriptionsResult [^AmazonRDS this]
...
(defn restore-db-instance-to-point-in-time
  ...
  throws: com.amazonaws.services.rds.model.DomainNotFoundException - Domain doesn't refer to an existing Active Directory domain."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.RestoreDBInstanceToPointInTimeRequest restore-db-instance-to-point-in-time-request]
    (-> this (.restoreDBInstanceToPointInTime restore-db-instance-to-point-in-time-request))))
...
(defn delete-db-snapshot
  ...
  (^com.amazonaws.services.rds.model.DBSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBSnapshotRequest delete-db-snapshot-request]
    (-> this (.deleteDBSnapshot delete-db-snapshot-request))))
...
(defn promote-read-replica-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.PromoteReadReplicaDBClusterRequest promote-read-replica-db-cluster-request]
...
(defn delete-db-cluster-parameter-group
  ...
  (^com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBClusterParameterGroupRequest delete-db-cluster-parameter-group-request]
...
(defn describe-engine-default-cluster-parameters
  ...
  (^com.amazonaws.services.rds.model.EngineDefaults [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeEngineDefaultClusterParametersRequest describe-engine-default-cluster-parameters-request]
...
(defn describe-option-groups
  ...
  (^com.amazonaws.services.rds.model.DescribeOptionGroupsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeOptionGroupsRequest describe-option-groups-request]
    (-> this (.describeOptionGroups describe-option-groups-request)))
  (^com.amazonaws.services.rds.model.DescribeOptionGroupsResult [^AmazonRDS this]
...
(defn describe-pending-maintenance-actions
  ...
  (^com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsRequest describe-pending-maintenance-actions-request]
    (-> this (.describePendingMaintenanceActions describe-pending-maintenance-actions-request)))
  (^com.amazonaws.services.rds.model.DescribePendingMaintenanceActionsResult [^AmazonRDS this]
...
(defn failover-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.FailoverDBClusterRequest failover-db-cluster-request]
    (-> this (.failoverDBCluster failover-db-cluster-request)))
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this]
...
(defn modify-db-instance
  ...
  throws: com.amazonaws.services.rds.model.DomainNotFoundException - Domain doesn't refer to an existing Active Directory domain."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBInstanceRequest modify-db-instance-request]
...
(defn create-db-instance-read-replica
  ...
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBInstanceReadReplicaRequest create-db-instance-read-replica-request]
    (-> this (.createDBInstanceReadReplica create-db-instance-read-replica-request))))
...
(defn create-db-snapshot
  ...
  (^com.amazonaws.services.rds.model.DBSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBSnapshotRequest create-db-snapshot-request]
    (-> this (.createDBSnapshot create-db-snapshot-request))))
...
(defn create-db-cluster
  ...
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBClusterRequest create-db-cluster-request]
...
(defn describe-source-regions
  ...
  (^com.amazonaws.services.rds.model.DescribeSourceRegionsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeSourceRegionsRequest describe-source-regions-request]
    (-> this (.describeSourceRegions describe-source-regions-request))))
...
(defn describe-db-snapshot-attributes
  ...
  throws: com.amazonaws.services.rds.model.DBSnapshotNotFoundException - DBSnapshotIdentifier doesn't refer to an existing DB snapshot."
  (^com.amazonaws.services.rds.model.DBSnapshotAttributesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBSnapshotAttributesRequest describe-db-snapshot-attributes-request]
    (-> this (.describeDBSnapshotAttributes describe-db-snapshot-attributes-request)))
  (^com.amazonaws.services.rds.model.DBSnapshotAttributesResult [^AmazonRDS this]
...
(defn restore-db-cluster-from-s-3
  ...
  throws: com.amazonaws.services.rds.model.DBClusterAlreadyExistsException - The user already has a DB cluster with the given identifier."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.RestoreDBClusterFromS3Request restore-db-cluster-from-s-3-request]
    (-> this (.restoreDBClusterFromS3 restore-db-cluster-from-s-3-request))))
...
(defn remove-role-from-db-instance
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.RemoveRoleFromDBInstanceResult [^AmazonRDS this ^com.amazonaws.services.rds.model.RemoveRoleFromDBInstanceRequest remove-role-from-db-instance-request]
    (-> this (.removeRoleFromDBInstance remove-role-from-db-instance-request))))
...
(defn start-activity-stream
  ...
  throws: com.amazonaws.services.rds.model.InvalidDBInstanceStateException - The DB instance isn't in a valid state."
  (^com.amazonaws.services.rds.model.StartActivityStreamResult [^AmazonRDS this ^com.amazonaws.services.rds.model.StartActivityStreamRequest start-activity-stream-request]
    (-> this (.startActivityStream start-activity-stream-request))))
...
(defn describe-valid-db-instance-modifications
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.ValidDBInstanceModificationsMessage [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeValidDBInstanceModificationsRequest describe-valid-db-instance-modifications-request]
...
(defn delete-db-instance
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBInstanceRequest delete-db-instance-request]
...
(defn describe-option-group-options
  ...
  (^com.amazonaws.services.rds.model.DescribeOptionGroupOptionsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeOptionGroupOptionsRequest describe-option-group-options-request]
    (-> this (.describeOptionGroupOptions describe-option-group-options-request))))
...
(defn describe-certificates
  ...
  (^com.amazonaws.services.rds.model.DescribeCertificatesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeCertificatesRequest describe-certificates-request]
    (-> this (.describeCertificates describe-certificates-request)))
  (^com.amazonaws.services.rds.model.DescribeCertificatesResult [^AmazonRDS this]
...
(defn delete-db-subnet-group
  ...
  (^com.amazonaws.services.rds.model.DeleteDBSubnetGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBSubnetGroupRequest delete-db-subnet-group-request]
...
(defn delete-option-group
  ...
  throws: com.amazonaws.services.rds.model.OptionGroupNotFoundException - The specified option group could not be found."
  (^com.amazonaws.services.rds.model.DeleteOptionGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteOptionGroupRequest delete-option-group-request]
    (-> this (.deleteOptionGroup delete-option-group-request))))
...
(defn restore-db-cluster-to-point-in-time
  ...
  throws: com.amazonaws.services.rds.model.DBClusterAlreadyExistsException - The user already has a DB cluster with the given identifier."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.RestoreDBClusterToPointInTimeRequest restore-db-cluster-to-point-in-time-request]
...
(defn delete-db-instance-automated-backup
  ...
  (^com.amazonaws.services.rds.model.DBInstanceAutomatedBackup [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBInstanceAutomatedBackupRequest delete-db-instance-automated-backup-request]
    (-> this (.deleteDBInstanceAutomatedBackup delete-db-instance-automated-backup-request))))
...
(defn delete-global-cluster
  ...
  (^com.amazonaws.services.rds.model.GlobalCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteGlobalClusterRequest delete-global-cluster-request]
    (-> this (.deleteGlobalCluster delete-global-cluster-request))))
...
(defn copy-db-snapshot
  ...
  throws: com.amazonaws.services.rds.model.DBSnapshotAlreadyExistsException - DBSnapshotIdentifier is already used by an existing snapshot."
  (^com.amazonaws.services.rds.model.DBSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.CopyDBSnapshotRequest copy-db-snapshot-request]
    (-> this (.copyDBSnapshot copy-db-snapshot-request))))
...
(defn add-role-to-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.AddRoleToDBClusterResult [^AmazonRDS this ^com.amazonaws.services.rds.model.AddRoleToDBClusterRequest add-role-to-db-cluster-request]
...
(defn delete-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBClusterRequest delete-db-cluster-request]
...
(defn modify-current-db-cluster-capacity
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.ModifyCurrentDBClusterCapacityResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyCurrentDBClusterCapacityRequest modify-current-db-cluster-capacity-request]
    (-> this (.modifyCurrentDBClusterCapacity modify-current-db-cluster-capacity-request))))
...
(defn promote-read-replica
  ...
  throws: com.amazonaws.services.rds.model.InvalidDBInstanceStateException - The DB instance isn't in a valid state."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.PromoteReadReplicaRequest promote-read-replica-request]
    (-> this (.promoteReadReplica promote-read-replica-request))))
...
(defn copy-option-group
  ...
  (^com.amazonaws.services.rds.model.OptionGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CopyOptionGroupRequest copy-option-group-request]
    (-> this (.copyOptionGroup copy-option-group-request))))
...
(defn modify-event-subscription
  ...
  throws: com.amazonaws.services.rds.model.EventSubscriptionQuotaExceededException - You have reached the maximum number of event subscriptions."
  (^com.amazonaws.services.rds.model.EventSubscription [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyEventSubscriptionRequest modify-event-subscription-request]
...
(defn create-db-parameter-group
  ...
  (^com.amazonaws.services.rds.model.DBParameterGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBParameterGroupRequest create-db-parameter-group-request]
...
(defn create-db-cluster-snapshot
  ...
  (^com.amazonaws.services.rds.model.DBClusterSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBClusterSnapshotRequest create-db-cluster-snapshot-request]
...
(defn describe-account-attributes
  ...
  (^com.amazonaws.services.rds.model.DescribeAccountAttributesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeAccountAttributesRequest describe-account-attributes-request]
    (-> this (.describeAccountAttributes describe-account-attributes-request)))
  (^com.amazonaws.services.rds.model.DescribeAccountAttributesResult [^AmazonRDS this]
...
(defn describe-events
  ...
  (^com.amazonaws.services.rds.model.DescribeEventsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeEventsRequest describe-events-request]
    (-> this (.describeEvents describe-events-request)))
  (^com.amazonaws.services.rds.model.DescribeEventsResult [^AmazonRDS this]
    (-> this (.describeEvents))))
...
(defn describe-global-clusters
  ...
  throws: com.amazonaws.services.rds.model.GlobalClusterNotFoundException"
  (^com.amazonaws.services.rds.model.DescribeGlobalClustersResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeGlobalClustersRequest describe-global-clusters-request]
    (-> this (.describeGlobalClusters describe-global-clusters-request))))
...
(defn create-global-cluster
  ...
  (^com.amazonaws.services.rds.model.GlobalCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateGlobalClusterRequest create-global-cluster-request]
    (-> this (.createGlobalCluster create-global-cluster-request))))
...
(defn authorize-db-security-group-ingress
  ...
  throws: com.amazonaws.services.rds.model.DBSecurityGroupNotFoundException - DBSecurityGroupName doesn't refer to an existing DB security group."
  (^com.amazonaws.services.rds.model.DBSecurityGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.AuthorizeDBSecurityGroupIngressRequest authorize-db-security-group-ingress-request]
    (-> this (.authorizeDBSecurityGroupIngress authorize-db-security-group-ingress-request))))
...
(defn describe-db-instance-automated-backups
  ...
  (^com.amazonaws.services.rds.model.DescribeDBInstanceAutomatedBackupsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBInstanceAutomatedBackupsRequest describe-db-instance-automated-backups-request]
    (-> this (.describeDBInstanceAutomatedBackups describe-db-instance-automated-backups-request))))
...
(defn remove-role-from-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.RemoveRoleFromDBClusterResult [^AmazonRDS this ^com.amazonaws.services.rds.model.RemoveRoleFromDBClusterRequest remove-role-from-db-cluster-request]
...
(defn set-endpoint
  ...
  ([^AmazonRDS this ^java.lang.String endpoint]
...
(defn modify-global-cluster
  ...
  throws: com.amazonaws.services.rds.model.GlobalClusterNotFoundException"
  (^com.amazonaws.services.rds.model.GlobalCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyGlobalClusterRequest modify-global-cluster-request]
    (-> this (.modifyGlobalCluster modify-global-cluster-request))))
...
(defn start-db-instance
  ...
  throws: com.amazonaws.services.rds.model.DBSubnetGroupNotFoundException - DBSubnetGroupName doesn't refer to an existing DB subnet group."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.StartDBInstanceRequest start-db-instance-request]
    (-> this (.startDBInstance start-db-instance-request))))
...
(defn delete-db-security-group
  ...
  (^com.amazonaws.services.rds.model.DeleteDBSecurityGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBSecurityGroupRequest delete-db-security-group-request]
    (-> this (.deleteDBSecurityGroup delete-db-security-group-request))))
...
(defn download-db-log-file-portion
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.DownloadDBLogFilePortionResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DownloadDBLogFilePortionRequest download-db-log-file-portion-request]
    (-> this (.downloadDBLogFilePortion download-db-log-file-portion-request))))
...
(defn describe-event-categories
  ...
  (^com.amazonaws.services.rds.model.DescribeEventCategoriesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeEventCategoriesRequest describe-event-categories-request]
    (-> this (.describeEventCategories describe-event-categories-request)))
  (^com.amazonaws.services.rds.model.DescribeEventCategoriesResult [^AmazonRDS this]
...
(defn remove-from-global-cluster
  ...
  throws: com.amazonaws.services.rds.model.GlobalClusterNotFoundException"
  (^com.amazonaws.services.rds.model.GlobalCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.RemoveFromGlobalClusterRequest remove-from-global-cluster-request]
    (-> this (.removeFromGlobalCluster remove-from-global-cluster-request))))
...
(defn describe-db-engine-versions
  ...
  (^com.amazonaws.services.rds.model.DescribeDBEngineVersionsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBEngineVersionsRequest describe-db-engine-versions-request]
    (-> this (.describeDBEngineVersions describe-db-engine-versions-request)))
  (^com.amazonaws.services.rds.model.DescribeDBEngineVersionsResult [^AmazonRDS this]
...
(defn describe-db-parameters
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.DescribeDBParametersResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBParametersRequest describe-db-parameters-request]
...
(defn delete-db-cluster-endpoint
  ...
  (^com.amazonaws.services.rds.model.DeleteDBClusterEndpointResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBClusterEndpointRequest delete-db-cluster-endpoint-request]
    (-> this (.deleteDBClusterEndpoint delete-db-cluster-endpoint-request))))
...
(defn delete-event-subscription
  ...
  throws: com.amazonaws.services.rds.model.SubscriptionNotFoundException - The subscription name does not exist."
  (^com.amazonaws.services.rds.model.EventSubscription [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteEventSubscriptionRequest delete-event-subscription-request]
...
(defn purchase-reserved-db-instances-offering
  ...
  (^com.amazonaws.services.rds.model.ReservedDBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.PurchaseReservedDBInstancesOfferingRequest purchase-reserved-db-instances-offering-request]
    (-> this (.purchaseReservedDBInstancesOffering purchase-reserved-db-instances-offering-request))))
...
(defn create-db-cluster-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupQuotaExceededException - The request would result in the user exceeding the allowed number of DB parameter groups."
  (^com.amazonaws.services.rds.model.DBClusterParameterGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBClusterParameterGroupRequest create-db-cluster-parameter-group-request]
...
(defn modify-option-group
  ...
  (^com.amazonaws.services.rds.model.OptionGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyOptionGroupRequest modify-option-group-request]
    (-> this (.modifyOptionGroup modify-option-group-request))))
...
(defn describe-reserved-db-instances
  ...
  (^com.amazonaws.services.rds.model.DescribeReservedDBInstancesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeReservedDBInstancesRequest describe-reserved-db-instances-request]
    (-> this (.describeReservedDBInstances describe-reserved-db-instances-request)))
  (^com.amazonaws.services.rds.model.DescribeReservedDBInstancesResult [^AmazonRDS this]
...
(defn describe-db-parameter-groups
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.DescribeDBParameterGroupsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBParameterGroupsRequest describe-db-parameter-groups-request]
    (-> this (.describeDBParameterGroups describe-db-parameter-groups-request)))
  (^com.amazonaws.services.rds.model.DescribeDBParameterGroupsResult [^AmazonRDS this]
...
(defn describe-db-cluster-parameter-groups
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsRequest describe-db-cluster-parameter-groups-request]
    (-> this (.describeDBClusterParameterGroups describe-db-cluster-parameter-groups-request)))
  (^com.amazonaws.services.rds.model.DescribeDBClusterParameterGroupsResult [^AmazonRDS this]
...
(defn describe-reserved-db-instances-offerings
  ...
  throws: com.amazonaws.services.rds.model.ReservedDBInstancesOfferingNotFoundException - Specified offering does not exist."
  (^com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsRequest describe-reserved-db-instances-offerings-request]
    (-> this (.describeReservedDBInstancesOfferings describe-reserved-db-instances-offerings-request)))
  (^com.amazonaws.services.rds.model.DescribeReservedDBInstancesOfferingsResult [^AmazonRDS this]
...
(defn restore-db-instance-from-s-3
  ...
  throws: com.amazonaws.services.rds.model.DBSubnetGroupNotFoundException - DBSubnetGroupName doesn't refer to an existing DB subnet group."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.RestoreDBInstanceFromS3Request restore-db-instance-from-s-3-request]
    (-> this (.restoreDBInstanceFromS3 restore-db-instance-from-s-3-request))))
...
(defn describe-db-instances
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.DescribeDBInstancesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBInstancesRequest describe-db-instances-request]
    (-> this (.describeDBInstances describe-db-instances-request)))
  (^com.amazonaws.services.rds.model.DescribeDBInstancesResult [^AmazonRDS this]
...
(defn describe-engine-default-parameters
  ...
  (^com.amazonaws.services.rds.model.EngineDefaults [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeEngineDefaultParametersRequest describe-engine-default-parameters-request]
...
(defn remove-tags-from-resource
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.RemoveTagsFromResourceResult [^AmazonRDS this ^com.amazonaws.services.rds.model.RemoveTagsFromResourceRequest remove-tags-from-resource-request]
...
(defn remove-source-identifier-from-subscription
  ...
  throws: com.amazonaws.services.rds.model.SubscriptionNotFoundException - The subscription name does not exist."
  (^com.amazonaws.services.rds.model.EventSubscription [^AmazonRDS this ^com.amazonaws.services.rds.model.RemoveSourceIdentifierFromSubscriptionRequest remove-source-identifier-from-subscription-request]
...
(defn describe-db-log-files
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.DescribeDBLogFilesResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBLogFilesRequest describe-db-log-files-request]
    (-> this (.describeDBLogFiles describe-db-log-files-request))))
...
(defn restore-db-instance-from-db-snapshot
  ...
  throws: com.amazonaws.services.rds.model.DomainNotFoundException - Domain doesn't refer to an existing Active Directory domain."
  (^com.amazonaws.services.rds.model.DBInstance [^AmazonRDS this ^com.amazonaws.services.rds.model.RestoreDBInstanceFromDBSnapshotRequest restore-db-instance-from-db-snapshot-request]
    (-> this (.restoreDBInstanceFromDBSnapshot restore-db-instance-from-db-snapshot-request))))
...
(defn reset-db-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.InvalidDBParameterGroupStateException - The DB parameter group is in use or is in an invalid state. If you are attempting to delete the parameter group, you can't delete it when the parameter group is in this state."
  (^com.amazonaws.services.rds.model.ResetDBParameterGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ResetDBParameterGroupRequest reset-db-parameter-group-request]
...
(defn describe-db-cluster-snapshots
  ...
  throws: com.amazonaws.services.rds.model.DBClusterSnapshotNotFoundException - DBClusterSnapshotIdentifier doesn't refer to an existing DB cluster snapshot."
  (^com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsRequest describe-db-cluster-snapshots-request]
    (-> this (.describeDBClusterSnapshots describe-db-cluster-snapshots-request)))
  (^com.amazonaws.services.rds.model.DescribeDBClusterSnapshotsResult [^AmazonRDS this]
...
(defn revoke-db-security-group-ingress
  ...
  throws: com.amazonaws.services.rds.model.DBSecurityGroupNotFoundException - DBSecurityGroupName doesn't refer to an existing DB security group."
  (^com.amazonaws.services.rds.model.DBSecurityGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.RevokeDBSecurityGroupIngressRequest revoke-db-security-group-ingress-request]
    (-> this (.revokeDBSecurityGroupIngress revoke-db-security-group-ingress-request))))
...
(defn modify-db-snapshot
  ...
  throws: com.amazonaws.services.rds.model.DBSnapshotNotFoundException - DBSnapshotIdentifier doesn't refer to an existing DB snapshot."
  (^com.amazonaws.services.rds.model.DBSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBSnapshotRequest modify-db-snapshot-request]
    (-> this (.modifyDBSnapshot modify-db-snapshot-request))))
...
(defn delete-db-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.InvalidDBParameterGroupStateException - The DB parameter group is in use or is in an invalid state. If you are attempting to delete the parameter group, you can't delete it when the parameter group is in this state."
  (^com.amazonaws.services.rds.model.DeleteDBParameterGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DeleteDBParameterGroupRequest delete-db-parameter-group-request]
...
(defn describe-db-cluster-backtracks
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DescribeDBClusterBacktracksResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClusterBacktracksRequest describe-db-cluster-backtracks-request]
    (-> this (.describeDBClusterBacktracks describe-db-cluster-backtracks-request))))
...
(defn describe-orderable-db-instance-options
  ...
  (^com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeOrderableDBInstanceOptionsRequest describe-orderable-db-instance-options-request]
...
(defn describe-db-cluster-parameters
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.DescribeDBClusterParametersResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClusterParametersRequest describe-db-cluster-parameters-request]
...
(defn describe-db-cluster-endpoints
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DescribeDBClusterEndpointsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClusterEndpointsRequest describe-db-cluster-endpoints-request]
    (-> this (.describeDBClusterEndpoints describe-db-cluster-endpoints-request))))
...
(defn restore-db-cluster-from-snapshot
  ...
  throws: com.amazonaws.services.rds.model.DBClusterAlreadyExistsException - The user already has a DB cluster with the given identifier."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.RestoreDBClusterFromSnapshotRequest restore-db-cluster-from-snapshot-request]
...
(defn describe-db-snapshots
  ...
  throws: com.amazonaws.services.rds.model.DBSnapshotNotFoundException - DBSnapshotIdentifier doesn't refer to an existing DB snapshot."
  (^com.amazonaws.services.rds.model.DescribeDBSnapshotsResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBSnapshotsRequest describe-db-snapshots-request]
    (-> this (.describeDBSnapshots describe-db-snapshots-request)))
  (^com.amazonaws.services.rds.model.DescribeDBSnapshotsResult [^AmazonRDS this]
...
(defn describe-db-clusters
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DescribeDBClustersResult [^AmazonRDS this ^com.amazonaws.services.rds.model.DescribeDBClustersRequest describe-db-clusters-request]
    (-> this (.describeDBClusters describe-db-clusters-request)))
  (^com.amazonaws.services.rds.model.DescribeDBClustersResult [^AmazonRDS this]
...
(defn add-tags-to-resource
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.AddTagsToResourceResult [^AmazonRDS this ^com.amazonaws.services.rds.model.AddTagsToResourceRequest add-tags-to-resource-request]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonRDS this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn add-source-identifier-to-subscription
  ...
  throws: com.amazonaws.services.rds.model.SubscriptionNotFoundException - The subscription name does not exist."
  (^com.amazonaws.services.rds.model.EventSubscription [^AmazonRDS this ^com.amazonaws.services.rds.model.AddSourceIdentifierToSubscriptionRequest add-source-identifier-to-subscription-request]
...
(defn create-option-group
  ...
  throws: com.amazonaws.services.rds.model.OptionGroupAlreadyExistsException - The option group you are trying to create already exists."
  (^com.amazonaws.services.rds.model.OptionGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateOptionGroupRequest create-option-group-request]
    (-> this (.createOptionGroup create-option-group-request))))
...
(defn modify-db-cluster-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBClusterParameterGroupRequest modify-db-cluster-parameter-group-request]
...
(defn add-role-to-db-instance
  ...
  throws: com.amazonaws.services.rds.model.DBInstanceNotFoundException - DBInstanceIdentifier doesn't refer to an existing DB instance."
  (^com.amazonaws.services.rds.model.AddRoleToDBInstanceResult [^AmazonRDS this ^com.amazonaws.services.rds.model.AddRoleToDBInstanceRequest add-role-to-db-instance-request]
    (-> this (.addRoleToDBInstance add-role-to-db-instance-request))))
...
(defn modify-db-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.ModifyDBParameterGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBParameterGroupRequest modify-db-parameter-group-request]
...
(defn reset-db-cluster-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.InvalidDBParameterGroupStateException - The DB parameter group is in use or is in an invalid state. If you are attempting to delete the parameter group, you can't delete it when the parameter group is in this state."
  (^com.amazonaws.services.rds.model.ResetDBClusterParameterGroupResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ResetDBClusterParameterGroupRequest reset-db-cluster-parameter-group-request]
...
(defn modify-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterAlreadyExistsException - The user already has a DB cluster with the given identifier."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBClusterRequest modify-db-cluster-request]
...
(defn backtrack-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.BacktrackDBClusterResult [^AmazonRDS this ^com.amazonaws.services.rds.model.BacktrackDBClusterRequest backtrack-db-cluster-request]
    (-> this (.backtrackDBCluster backtrack-db-cluster-request))))
...
(defn copy-db-cluster-parameter-group
  ...
  throws: com.amazonaws.services.rds.model.DBParameterGroupNotFoundException - DBParameterGroupName doesn't refer to an existing DB parameter group."
  (^com.amazonaws.services.rds.model.DBClusterParameterGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CopyDBClusterParameterGroupRequest copy-db-cluster-parameter-group-request]
...
(defn copy-db-cluster-snapshot
  ...
  throws: com.amazonaws.services.rds.model.DBClusterSnapshotAlreadyExistsException - The user already has a DB cluster snapshot with the given identifier."
  (^com.amazonaws.services.rds.model.DBClusterSnapshot [^AmazonRDS this ^com.amazonaws.services.rds.model.CopyDBClusterSnapshotRequest copy-db-cluster-snapshot-request]
...
(defn apply-pending-maintenance-action
  ...
  throws: com.amazonaws.services.rds.model.ResourceNotFoundException - The specified resource ID was not found."
  (^com.amazonaws.services.rds.model.ResourcePendingMaintenanceActions [^AmazonRDS this ^com.amazonaws.services.rds.model.ApplyPendingMaintenanceActionRequest apply-pending-maintenance-action-request]
...
(defn modify-db-cluster-endpoint
  ...
  (^com.amazonaws.services.rds.model.ModifyDBClusterEndpointResult [^AmazonRDS this ^com.amazonaws.services.rds.model.ModifyDBClusterEndpointRequest modify-db-cluster-endpoint-request]
    (-> this (.modifyDBClusterEndpoint modify-db-cluster-endpoint-request))))
...
(defn start-db-cluster
  ...
  throws: com.amazonaws.services.rds.model.DBClusterNotFoundException - DBClusterIdentifier doesn't refer to an existing DB cluster."
  (^com.amazonaws.services.rds.model.DBCluster [^AmazonRDS this ^com.amazonaws.services.rds.model.StartDBClusterRequest start-db-cluster-request]
...
(defn create-db-subnet-group
  ...
  (^com.amazonaws.services.rds.model.DBSubnetGroup [^AmazonRDS this ^com.amazonaws.services.rds.model.CreateDBSubnetGroupRequest create-db-subnet-group-request]
