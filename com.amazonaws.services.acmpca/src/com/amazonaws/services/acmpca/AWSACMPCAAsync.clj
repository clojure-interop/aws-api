(ns com.amazonaws.services.acmpca.AWSACMPCAAsync
  ...
  AbstractAWSACMPCAAsync instead.
...
(defn issue-certificate-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.IssueCertificateRequest issue-certificate-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.issueCertificateAsync issue-certificate-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.IssueCertificateRequest issue-certificate-request]
    (-> this (.issueCertificateAsync issue-certificate-request))))
...
(defn update-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.UpdateCertificateAuthorityRequest update-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.updateCertificateAuthorityAsync update-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.UpdateCertificateAuthorityRequest update-certificate-authority-request]
    (-> this (.updateCertificateAuthorityAsync update-certificate-authority-request))))
...
(defn list-tags-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ListTagsRequest list-tags-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listTagsAsync list-tags-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ListTagsRequest list-tags-request]
...
(defn describe-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityRequest describe-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeCertificateAuthorityAsync describe-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityRequest describe-certificate-authority-request]
    (-> this (.describeCertificateAuthorityAsync describe-certificate-authority-request))))
...
(defn delete-permission-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DeletePermissionRequest delete-permission-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deletePermissionAsync delete-permission-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DeletePermissionRequest delete-permission-request]
    (-> this (.deletePermissionAsync delete-permission-request))))
...
(defn untag-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.UntagCertificateAuthorityRequest untag-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.untagCertificateAuthorityAsync untag-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.UntagCertificateAuthorityRequest untag-certificate-authority-request]
    (-> this (.untagCertificateAuthorityAsync untag-certificate-authority-request))))
...
(defn get-certificate-authority-certificate-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCertificateRequest get-certificate-authority-certificate-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getCertificateAuthorityCertificateAsync get-certificate-authority-certificate-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCertificateRequest get-certificate-authority-certificate-request]
    (-> this (.getCertificateAuthorityCertificateAsync get-certificate-authority-certificate-request))))
...
(defn revoke-certificate-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.RevokeCertificateRequest revoke-certificate-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.revokeCertificateAsync revoke-certificate-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.RevokeCertificateRequest revoke-certificate-request]
    (-> this (.revokeCertificateAsync revoke-certificate-request))))
...
(defn create-certificate-authority-audit-report-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityAuditReportRequest create-certificate-authority-audit-report-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createCertificateAuthorityAuditReportAsync create-certificate-authority-audit-report-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityAuditReportRequest create-certificate-authority-audit-report-request]
    (-> this (.createCertificateAuthorityAuditReportAsync create-certificate-authority-audit-report-request))))
...
(defn get-certificate-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.GetCertificateRequest get-certificate-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getCertificateAsync get-certificate-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.GetCertificateRequest get-certificate-request]
...
(defn restore-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.RestoreCertificateAuthorityRequest restore-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.restoreCertificateAuthorityAsync restore-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.RestoreCertificateAuthorityRequest restore-certificate-authority-request]
    (-> this (.restoreCertificateAuthorityAsync restore-certificate-authority-request))))
...
(defn describe-certificate-authority-audit-report-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityAuditReportRequest describe-certificate-authority-audit-report-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.describeCertificateAuthorityAuditReportAsync describe-certificate-authority-audit-report-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityAuditReportRequest describe-certificate-authority-audit-report-request]
    (-> this (.describeCertificateAuthorityAuditReportAsync describe-certificate-authority-audit-report-request))))
...
(defn delete-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DeleteCertificateAuthorityRequest delete-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.deleteCertificateAuthorityAsync delete-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.DeleteCertificateAuthorityRequest delete-certificate-authority-request]
    (-> this (.deleteCertificateAuthorityAsync delete-certificate-authority-request))))
...
(defn get-certificate-authority-csr-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCsrRequest get-certificate-authority-csr-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.getCertificateAuthorityCsrAsync get-certificate-authority-csr-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCsrRequest get-certificate-authority-csr-request]
    (-> this (.getCertificateAuthorityCsrAsync get-certificate-authority-csr-request))))
...
(defn list-certificate-authorities-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ListCertificateAuthoritiesRequest list-certificate-authorities-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listCertificateAuthoritiesAsync list-certificate-authorities-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ListCertificateAuthoritiesRequest list-certificate-authorities-request]
    (-> this (.listCertificateAuthoritiesAsync list-certificate-authorities-request))))
...
(defn create-permission-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.CreatePermissionRequest create-permission-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createPermissionAsync create-permission-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.CreatePermissionRequest create-permission-request]
    (-> this (.createPermissionAsync create-permission-request))))
...
(defn list-permissions-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ListPermissionsRequest list-permissions-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.listPermissionsAsync list-permissions-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ListPermissionsRequest list-permissions-request]
    (-> this (.listPermissionsAsync list-permissions-request))))
...
(defn tag-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.TagCertificateAuthorityRequest tag-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.tagCertificateAuthorityAsync tag-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.TagCertificateAuthorityRequest tag-certificate-authority-request]
    (-> this (.tagCertificateAuthorityAsync tag-certificate-authority-request))))
...
(defn import-certificate-authority-certificate-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ImportCertificateAuthorityCertificateRequest import-certificate-authority-certificate-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.importCertificateAuthorityCertificateAsync import-certificate-authority-certificate-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.ImportCertificateAuthorityCertificateRequest import-certificate-authority-certificate-request]
    (-> this (.importCertificateAuthorityCertificateAsync import-certificate-authority-certificate-request))))
...
(defn create-certificate-authority-async
  ...
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityRequest create-certificate-authority-request ^com.amazonaws.handlers.AsyncHandler async-handler]
    (-> this (.createCertificateAuthorityAsync create-certificate-authority-request async-handler)))
  (^java.util.concurrent.Future [^AWSACMPCAAsync this ^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityRequest create-certificate-authority-request]
    (-> this (.createCertificateAuthorityAsync create-certificate-authority-request))))
