(ns com.amazonaws.services.acmpca.AWSACMPCAClient
...
(defn *builder
  "returns: `com.amazonaws.services.acmpca.AWSACMPCAClientBuilder`"
  (^com.amazonaws.services.acmpca.AWSACMPCAClientBuilder []
    (AWSACMPCAClient/builder )))
...
(defn restore-certificate-authority
  ...
  (^com.amazonaws.services.acmpca.model.RestoreCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.RestoreCertificateAuthorityRequest request]
    (-> this (.restoreCertificateAuthority request))))

(defn waiters
  "returns: `com.amazonaws.services.acmpca.waiters.AWSACMPCAWaiters`"
  (^com.amazonaws.services.acmpca.waiters.AWSACMPCAWaiters [^AWSACMPCAClient this]
    (-> this (.waiters))))
...
(defn untag-certificate-authority
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.UntagCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.UntagCertificateAuthorityRequest request]
...
(defn create-certificate-authority-audit-report
  ...
  (^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityAuditReportResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityAuditReportRequest request]
...
(defn list-tags
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.ListTagsResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.ListTagsRequest request]
...
(defn import-certificate-authority-certificate
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.ImportCertificateAuthorityCertificateResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.ImportCertificateAuthorityCertificateRequest request]
...
(defn describe-certificate-authority
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityRequest request]
...
(defn list-permissions
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.ListPermissionsResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.ListPermissionsRequest request]
...
(defn delete-permission
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.DeletePermissionResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.DeletePermissionRequest request]
    (-> this (.deletePermission request))))

(defn shutdown
  "Description copied from class: AmazonWebServiceClient"
  ([^AWSACMPCAClient this]
    (-> this (.shutdown))))
...
(defn describe-certificate-authority-audit-report
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityAuditReportResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.DescribeCertificateAuthorityAuditReportRequest request]
...
(defn list-certificate-authorities
  ...
  (^com.amazonaws.services.acmpca.model.ListCertificateAuthoritiesResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.ListCertificateAuthoritiesRequest request]
...
(defn tag-certificate-authority
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.TagCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.TagCertificateAuthorityRequest request]
...
(defn issue-certificate
  ...
  (^com.amazonaws.services.acmpca.model.IssueCertificateResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.IssueCertificateRequest request]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AWSACMPCAClient this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn get-certificate
  ...
  throws: com.amazonaws.services.acmpca.model.RequestInProgressException - Your request is already in progress."
  (^com.amazonaws.services.acmpca.model.GetCertificateResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.GetCertificateRequest request]
...
(defn revoke-certificate
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.RevokeCertificateResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.RevokeCertificateRequest request]
...
(defn create-certificate-authority
  ...
  (^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.CreateCertificateAuthorityRequest request]
...
(defn delete-certificate-authority
  ...
  (^com.amazonaws.services.acmpca.model.DeleteCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.DeleteCertificateAuthorityRequest request]
...
(defn create-permission
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.CreatePermissionResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.CreatePermissionRequest request]
...
(defn update-certificate-authority
  ...
  throws: com.amazonaws.services.acmpca.model.ConcurrentModificationException - A previous update to your private CA is still ongoing."
  (^com.amazonaws.services.acmpca.model.UpdateCertificateAuthorityResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.UpdateCertificateAuthorityRequest request]
...
(defn get-certificate-authority-certificate
  ...
  throws: com.amazonaws.services.acmpca.model.ResourceNotFoundException - A resource such as a private CA, S3 bucket, certificate, or audit report cannot be found."
  (^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCertificateResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCertificateRequest request]
...
(defn get-certificate-authority-csr
  ...
  throws: com.amazonaws.services.acmpca.model.RequestInProgressException - Your request is already in progress."
  (^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCsrResult [^AWSACMPCAClient this ^com.amazonaws.services.acmpca.model.GetCertificateAuthorityCsrRequest request]
