(ns com.amazonaws.services.ecs.AmazonECS
  "Interface for accessing Amazon ECS.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAmazonECS instead.
...
(defn describe-services
  ...
  (^com.amazonaws.services.ecs.model.DescribeServicesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DescribeServicesRequest describe-services-request]
...
(defn submit-container-state-change
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.SubmitContainerStateChangeResult [^AmazonECS this ^com.amazonaws.services.ecs.model.SubmitContainerStateChangeRequest submit-container-state-change-request]
    (-> this (.submitContainerStateChange submit-container-state-change-request)))
  (^com.amazonaws.services.ecs.model.SubmitContainerStateChangeResult [^AmazonECS this]
...
(defn list-tags-for-resource
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListTagsForResourceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListTagsForResourceRequest list-tags-for-resource-request]
...
(defn set-region
  ...
  ([^AmazonECS this ^com.amazonaws.regions.Region region]
...
(defn create-service
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.CreateServiceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.CreateServiceRequest create-service-request]
...
(defn list-services
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListServicesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListServicesRequest list-services-request]
    (-> this (.listServices list-services-request)))
  (^com.amazonaws.services.ecs.model.ListServicesResult [^AmazonECS this]
    (-> this (.listServices))))

(defn waiters
  "returns: `com.amazonaws.services.ecs.waiters.AmazonECSWaiters`"
  (^com.amazonaws.services.ecs.waiters.AmazonECSWaiters [^AmazonECS this]
    (-> this (.waiters))))
...
(defn delete-service
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DeleteServiceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeleteServiceRequest delete-service-request]
...
(defn update-container-agent
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.UpdateContainerAgentResult [^AmazonECS this ^com.amazonaws.services.ecs.model.UpdateContainerAgentRequest update-container-agent-request]
    (-> this (.updateContainerAgent update-container-agent-request))))
...
(defn put-account-setting-default
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.PutAccountSettingDefaultResult [^AmazonECS this ^com.amazonaws.services.ecs.model.PutAccountSettingDefaultRequest put-account-setting-default-request]
    (-> this (.putAccountSettingDefault put-account-setting-default-request))))
...
(defn list-task-definition-families
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesRequest list-task-definition-families-request]
    (-> this (.listTaskDefinitionFamilies list-task-definition-families-request)))
  (^com.amazonaws.services.ecs.model.ListTaskDefinitionFamiliesResult [^AmazonECS this]
...
(defn describe-tasks
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DescribeTasksResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DescribeTasksRequest describe-tasks-request]
    (-> this (.describeTasks describe-tasks-request))))
...
(defn untag-resource
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.UntagResourceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.UntagResourceRequest untag-resource-request]
...
(defn deregister-container-instance
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DeregisterContainerInstanceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeregisterContainerInstanceRequest deregister-container-instance-request]
    (-> this (.deregisterContainerInstance deregister-container-instance-request))))
...
(defn list-account-settings
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListAccountSettingsResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListAccountSettingsRequest list-account-settings-request]
    (-> this (.listAccountSettings list-account-settings-request))))
...
(defn describe-container-instances
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DescribeContainerInstancesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DescribeContainerInstancesRequest describe-container-instances-request]
    (-> this (.describeContainerInstances describe-container-instances-request))))
...
(defn describe-task-definition
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DescribeTaskDefinitionResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DescribeTaskDefinitionRequest describe-task-definition-request]
    (-> this (.describeTaskDefinition describe-task-definition-request))))
...
(defn submit-attachment-state-changes
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.SubmitAttachmentStateChangesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.SubmitAttachmentStateChangesRequest submit-attachment-state-changes-request]
    (-> this (.submitAttachmentStateChanges submit-attachment-state-changes-request))))
...
(defn put-account-setting
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.PutAccountSettingResult [^AmazonECS this ^com.amazonaws.services.ecs.model.PutAccountSettingRequest put-account-setting-request]
    (-> this (.putAccountSetting put-account-setting-request))))
...
(defn run-task
  ...
  (^com.amazonaws.services.ecs.model.RunTaskResult [^AmazonECS this ^com.amazonaws.services.ecs.model.RunTaskRequest run-task-request]
    (-> this (.runTask run-task-request))))
...
(defn describe-task-sets
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DescribeTaskSetsResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DescribeTaskSetsRequest describe-task-sets-request]
    (-> this (.describeTaskSets describe-task-sets-request))))
...
(defn put-attributes
  ...
  (^com.amazonaws.services.ecs.model.PutAttributesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.PutAttributesRequest put-attributes-request]
...
(defn stop-task
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.StopTaskResult [^AmazonECS this ^com.amazonaws.services.ecs.model.StopTaskRequest stop-task-request]
    (-> this (.stopTask stop-task-request))))
...
(defn create-task-set
  ...
  throws: com.amazonaws.services.ecs.model.UnsupportedFeatureException - The specified task is not supported in this Region."
  (^com.amazonaws.services.ecs.model.CreateTaskSetResult [^AmazonECS this ^com.amazonaws.services.ecs.model.CreateTaskSetRequest create-task-set-request]
    (-> this (.createTaskSet create-task-set-request))))
...
(defn list-task-definitions
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListTaskDefinitionsResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListTaskDefinitionsRequest list-task-definitions-request]
    (-> this (.listTaskDefinitions list-task-definitions-request)))
  (^com.amazonaws.services.ecs.model.ListTaskDefinitionsResult [^AmazonECS this]
...
(defn set-endpoint
  ...
  ([^AmazonECS this ^java.lang.String endpoint]
...
(defn discover-poll-endpoint
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DiscoverPollEndpointResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DiscoverPollEndpointRequest discover-poll-endpoint-request]
    (-> this (.discoverPollEndpoint discover-poll-endpoint-request)))
  (^com.amazonaws.services.ecs.model.DiscoverPollEndpointResult [^AmazonECS this]
...
(defn register-task-definition
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.RegisterTaskDefinitionResult [^AmazonECS this ^com.amazonaws.services.ecs.model.RegisterTaskDefinitionRequest register-task-definition-request]
    (-> this (.registerTaskDefinition register-task-definition-request))))
...
(defn list-container-instances
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListContainerInstancesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListContainerInstancesRequest list-container-instances-request]
    (-> this (.listContainerInstances list-container-instances-request)))
  (^com.amazonaws.services.ecs.model.ListContainerInstancesResult [^AmazonECS this]
...
(defn create-cluster
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.CreateClusterResult [^AmazonECS this ^com.amazonaws.services.ecs.model.CreateClusterRequest create-cluster-request]
    (-> this (.createCluster create-cluster-request)))
  (^com.amazonaws.services.ecs.model.CreateClusterResult [^AmazonECS this]
    (-> this (.createCluster))))
...
(defn update-task-set
  ...
  throws: com.amazonaws.services.ecs.model.UnsupportedFeatureException - The specified task is not supported in this Region."
  (^com.amazonaws.services.ecs.model.UpdateTaskSetResult [^AmazonECS this ^com.amazonaws.services.ecs.model.UpdateTaskSetRequest update-task-set-request]
    (-> this (.updateTaskSet update-task-set-request))))
...
(defn update-service
  ...
  (^com.amazonaws.services.ecs.model.UpdateServiceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.UpdateServiceRequest update-service-request]
...
(defn delete-account-setting
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DeleteAccountSettingResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeleteAccountSettingRequest delete-account-setting-request]
    (-> this (.deleteAccountSetting delete-account-setting-request))))
...
(defn delete-task-set
  ...
  throws: com.amazonaws.services.ecs.model.UnsupportedFeatureException - The specified task is not supported in this Region."
  (^com.amazonaws.services.ecs.model.DeleteTaskSetResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeleteTaskSetRequest delete-task-set-request]
    (-> this (.deleteTaskSet delete-task-set-request))))
...
(defn delete-cluster
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DeleteClusterResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeleteClusterRequest delete-cluster-request]
...
(defn start-task
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.StartTaskResult [^AmazonECS this ^com.amazonaws.services.ecs.model.StartTaskRequest start-task-request]
    (-> this (.startTask start-task-request))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonECS this ^com.amazonaws.AmazonWebServiceRequest request]
...
(defn list-tasks
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListTasksResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListTasksRequest list-tasks-request]
    (-> this (.listTasks list-tasks-request)))
  (^com.amazonaws.services.ecs.model.ListTasksResult [^AmazonECS this]
    (-> this (.listTasks))))
...
(defn deregister-task-definition
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DeregisterTaskDefinitionResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeregisterTaskDefinitionRequest deregister-task-definition-request]
    (-> this (.deregisterTaskDefinition deregister-task-definition-request))))
...
(defn update-service-primary-task-set
  ...
  throws: com.amazonaws.services.ecs.model.UnsupportedFeatureException - The specified task is not supported in this Region."
  (^com.amazonaws.services.ecs.model.UpdateServicePrimaryTaskSetResult [^AmazonECS this ^com.amazonaws.services.ecs.model.UpdateServicePrimaryTaskSetRequest update-service-primary-task-set-request]
    (-> this (.updateServicePrimaryTaskSet update-service-primary-task-set-request))))
...
(defn register-container-instance
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.RegisterContainerInstanceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.RegisterContainerInstanceRequest register-container-instance-request]
    (-> this (.registerContainerInstance register-container-instance-request))))
...
(defn tag-resource
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.TagResourceResult [^AmazonECS this ^com.amazonaws.services.ecs.model.TagResourceRequest tag-resource-request]
...
(defn delete-attributes
  ...
  throws: com.amazonaws.services.ecs.model.ClusterNotFoundException - The specified cluster could not be found. You can view your available clusters with ListClusters. Amazon ECS clusters are Region-specific."
  (^com.amazonaws.services.ecs.model.DeleteAttributesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DeleteAttributesRequest delete-attributes-request]
...
(defn update-container-instances-state
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.UpdateContainerInstancesStateResult [^AmazonECS this ^com.amazonaws.services.ecs.model.UpdateContainerInstancesStateRequest update-container-instances-state-request]
    (-> this (.updateContainerInstancesState update-container-instances-state-request))))
...
(defn list-attributes
  ...
  throws: com.amazonaws.services.ecs.model.ClusterNotFoundException - The specified cluster could not be found. You can view your available clusters with ListClusters. Amazon ECS clusters are Region-specific."
  (^com.amazonaws.services.ecs.model.ListAttributesResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListAttributesRequest list-attributes-request]
    (-> this (.listAttributes list-attributes-request))))
...
(defn describe-clusters
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.DescribeClustersResult [^AmazonECS this ^com.amazonaws.services.ecs.model.DescribeClustersRequest describe-clusters-request]
    (-> this (.describeClusters describe-clusters-request)))
  (^com.amazonaws.services.ecs.model.DescribeClustersResult [^AmazonECS this]
...
(defn submit-task-state-change
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.SubmitTaskStateChangeResult [^AmazonECS this ^com.amazonaws.services.ecs.model.SubmitTaskStateChangeRequest submit-task-state-change-request]
    (-> this (.submitTaskStateChange submit-task-state-change-request))))
...
(defn list-clusters
  ...
  throws: com.amazonaws.services.ecs.model.ServerException - These errors are usually caused by a server issue."
  (^com.amazonaws.services.ecs.model.ListClustersResult [^AmazonECS this ^com.amazonaws.services.ecs.model.ListClustersRequest list-clusters-request]
    (-> this (.listClusters list-clusters-request)))
  (^com.amazonaws.services.ecs.model.ListClustersResult [^AmazonECS this]
    (-> this (.listClusters))))
