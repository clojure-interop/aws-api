(ns com.amazonaws.services.kinesisfirehose.AmazonKinesisFirehoseClient
...
(defn ->amazon-kinesis-firehose-client
  "Constructor.
  ...
  client-configuration - The client configuration options controlling how this client connects to Firehose (ex: proxy settings, retry counts, etc.). - `com.amazonaws.ClientConfiguration`
  request-metric-collector - optional request metric collector - `com.amazonaws.metrics.RequestMetricCollector`"
  (^AmazonKinesisFirehoseClient [^com.amazonaws.auth.AWSCredentialsProvider aws-credentials-provider ^com.amazonaws.ClientConfiguration client-configuration ^com.amazonaws.metrics.RequestMetricCollector request-metric-collector]
    (new AmazonKinesisFirehoseClient aws-credentials-provider client-configuration request-metric-collector))
  (^AmazonKinesisFirehoseClient [^com.amazonaws.auth.AWSCredentials aws-credentials ^com.amazonaws.ClientConfiguration client-configuration]
    (new AmazonKinesisFirehoseClient aws-credentials client-configuration))
  (^AmazonKinesisFirehoseClient [^com.amazonaws.ClientConfiguration client-configuration]
    (new AmazonKinesisFirehoseClient client-configuration))
  (^AmazonKinesisFirehoseClient []
    (new AmazonKinesisFirehoseClient )))

(defn *builder
  "returns: `com.amazonaws.services.kinesisfirehose.AmazonKinesisFirehoseClientBuilder`"
...
(defn stop-delivery-stream-encryption
  ...
  (^com.amazonaws.services.kinesisfirehose.model.StopDeliveryStreamEncryptionResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.StopDeliveryStreamEncryptionRequest request]
...
(defn describe-delivery-stream
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamRequest request]
...
(defn put-record-batch
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.PutRecordBatchResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.PutRecordBatchRequest request]
...
(defn tag-delivery-stream
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.TagDeliveryStreamResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.TagDeliveryStreamRequest request]
...
(defn list-tags-for-delivery-stream
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.ListTagsForDeliveryStreamResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.ListTagsForDeliveryStreamRequest request]
...
(defn untag-delivery-stream
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.UntagDeliveryStreamResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.UntagDeliveryStreamRequest request]
...
(defn list-delivery-streams
  ...
  (^com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsRequest request]
...
(defn delete-delivery-stream
  ...
  (^com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamRequest request]
...
(defn update-destination
  ...
  (^com.amazonaws.services.kinesisfirehose.model.UpdateDestinationResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.UpdateDestinationRequest request]
...
(defn put-record
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.PutRecordResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.PutRecordRequest request]
...
(defn create-delivery-stream
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.InvalidArgumentException - The specified input parameter has a value that is not valid."
  (^com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamRequest request]
...
(defn start-delivery-stream-encryption
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.StartDeliveryStreamEncryptionResult [^AmazonKinesisFirehoseClient this ^com.amazonaws.services.kinesisfirehose.model.StartDeliveryStreamEncryptionRequest request]
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonKinesisFirehoseClient this ^com.amazonaws.AmazonWebServiceRequest request]
