(ns com.amazonaws.services.kinesisfirehose.AmazonKinesisFirehose
  "Interface for accessing Firehose.

  Note: Do not directly implement this interface, new methods are added to it regularly. Extend from
  AbstractAmazonKinesisFirehose instead.
...
(defn set-region
  ...
  ([^AmazonKinesisFirehose this ^com.amazonaws.regions.Region region]
...
(defn stop-delivery-stream-encryption
  ...
  stop-delivery-stream-encryption-request - `com.amazonaws.services.kinesisfirehose.model.StopDeliveryStreamEncryptionRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.StopDeliveryStreamEncryptionResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.StopDeliveryStreamEncryptionRequest stop-delivery-stream-encryption-request]
    (-> this (.stopDeliveryStreamEncryption stop-delivery-stream-encryption-request))))
...
(defn describe-delivery-stream
  "Describes the specified delivery stream and gets the status. For example, after your delivery stream is created,
   call DescribeDeliveryStream to see whether the delivery stream is ACTIVE and therefore
   ready for data to be sent to it.

  describe-delivery-stream-request - `com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.DescribeDeliveryStreamRequest describe-delivery-stream-request]
    (-> this (.describeDeliveryStream describe-delivery-stream-request))))
...
(defn put-record-batch
  "Writes multiple data records into a delivery stream in a single call, which can achieve higher throughput per
   ...
   two operations for each delivery stream. For more information about limits, see Amazon Kinesis Data Firehose Limits.
   ...
   RequestResponses includes both successfully and unsuccessfully processed records. Kinesis Data
  ...
  put-record-batch-request - `com.amazonaws.services.kinesisfirehose.model.PutRecordBatchRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.PutRecordBatchResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.PutRecordBatchRequest put-record-batch-request]
    (-> this (.putRecordBatch put-record-batch-request))))
...
(defn tag-delivery-stream
  "Adds or updates tags for the specified delivery stream. A tag is a key-value pair that you can define and assign
   ...
   types of information that can help you distinguish the delivery stream. For more information about tags, see Using Cost Allocation
  ...
  tag-delivery-stream-request - `com.amazonaws.services.kinesisfirehose.model.TagDeliveryStreamRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.TagDeliveryStreamResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.TagDeliveryStreamRequest tag-delivery-stream-request]
    (-> this (.tagDeliveryStream tag-delivery-stream-request))))

(defn shutdown
  "Shuts down this client object, releasing any resources that might be held open. This is an optional method, and
   callers are not expected to call it, but can if they want to explicitly release any open resources. Once a client
   has been shutdown, it should not be used to make any more requests."
  ([^AmazonKinesisFirehose this]
    (-> this (.shutdown))))
...
(defn list-tags-for-delivery-stream
  ...
  list-tags-for-delivery-stream-request - `com.amazonaws.services.kinesisfirehose.model.ListTagsForDeliveryStreamRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.ListTagsForDeliveryStreamResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.ListTagsForDeliveryStreamRequest list-tags-for-delivery-stream-request]
    (-> this (.listTagsForDeliveryStream list-tags-for-delivery-stream-request))))
...
(defn untag-delivery-stream
  ...
  untag-delivery-stream-request - `com.amazonaws.services.kinesisfirehose.model.UntagDeliveryStreamRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.UntagDeliveryStreamResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.UntagDeliveryStreamRequest untag-delivery-stream-request]
    (-> this (.untagDeliveryStream untag-delivery-stream-request))))
...
(defn list-delivery-streams
  ...
  list-delivery-streams-request - `com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsRequest`
  ...
  (^com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.ListDeliveryStreamsRequest list-delivery-streams-request]
    (-> this (.listDeliveryStreams list-delivery-streams-request))))
...
(defn set-endpoint
  ...
  ([^AmazonKinesisFirehose this ^java.lang.String endpoint]
...
(defn delete-delivery-stream
  "Deletes a delivery stream and its data.
   ...
   While the delivery stream is DELETING state, the service might continue to accept the records, but
  ...
  delete-delivery-stream-request - `com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceInUseException - The resource is already in use and not available for this operation."
  (^com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.DeleteDeliveryStreamRequest delete-delivery-stream-request]
    (-> this (.deleteDeliveryStream delete-delivery-stream-request))))
...
(defn update-destination
  "Updates the specified destination of the specified delivery stream.
   ...
   Kinesis Data Firehose uses CurrentDeliveryStreamVersionId to avoid race conditions and conflicting
  ...
  update-destination-request - `com.amazonaws.services.kinesisfirehose.model.UpdateDestinationRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.InvalidArgumentException - The specified input parameter has a value that is not valid."
  (^com.amazonaws.services.kinesisfirehose.model.UpdateDestinationResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.UpdateDestinationRequest update-destination-request]
    (-> this (.updateDestination update-destination-request))))

(defn put-record
  "Writes a single data record into an Amazon Kinesis Data Firehose delivery stream. To write multiple data records
   into a delivery stream, use PutRecordBatch. Applications using these operations are referred to as
   producers.


   By default, each delivery stream can take in up to 2,000 transactions per second, 5,000 records per second, or 5
   MB per second. If you use PutRecord and PutRecordBatch, the limits are an aggregate across these
   two operations for each delivery stream. For more information about limits and how to request an increase, see Amazon Kinesis Data Firehose Limits.
  ...
  put-record-request - `com.amazonaws.services.kinesisfirehose.model.PutRecordRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.PutRecordResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.PutRecordRequest put-record-request]
...
(defn create-delivery-stream
  "Creates a Kinesis Data Firehose delivery stream.
   ...
   data. Attempts to send data to a delivery stream that is not in the ACTIVE state cause an exception.
   To check the state of a delivery stream, use DescribeDeliveryStream.
   ...
   source. To specify a Kinesis data stream as input, set the DeliveryStreamType parameter to
   ...
   BufferingHints value is provided, Kinesis Data Firehose buffers data up to 5 MB or for 5 minutes,
   ...
   delivers data to Amazon S3 and then uses COPY syntax to load data into an Amazon Redshift table.
   This is specified in the RedshiftDestinationConfiguration.S3Configuration parameter.
   ...
   Firehose Access to an Amazon S3 Destination in the Amazon Kinesis Data Firehose Developer Guide.

  create-delivery-stream-request - `com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.InvalidArgumentException - The specified input parameter has a value that is not valid."
  (^com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.CreateDeliveryStreamRequest create-delivery-stream-request]
    (-> this (.createDeliveryStream create-delivery-stream-request))))
...
(defn start-delivery-stream-encryption
  "Enables server-side encryption (SSE) for the delivery stream.
   ...
   This operation is asynchronous. It returns immediately. When you invoke it, Kinesis Data Firehose first sets the
   status of the stream to ENABLING, and then to ENABLED. You can continue to read and
   write data to your stream while its status is ENABLING, but the data is not encrypted. It can take
   up to 5 seconds after the encryption status changes to ENABLED before all records written to the
  ...
  start-delivery-stream-encryption-request - `com.amazonaws.services.kinesisfirehose.model.StartDeliveryStreamEncryptionRequest`
  ...
  throws: com.amazonaws.services.kinesisfirehose.model.ResourceNotFoundException - The specified resource could not be found."
  (^com.amazonaws.services.kinesisfirehose.model.StartDeliveryStreamEncryptionResult [^AmazonKinesisFirehose this ^com.amazonaws.services.kinesisfirehose.model.StartDeliveryStreamEncryptionRequest start-delivery-stream-encryption-request]
    (-> this (.startDeliveryStreamEncryption start-delivery-stream-encryption-request))))
...
(defn get-cached-response-metadata
  ...
  (^com.amazonaws.ResponseMetadata [^AmazonKinesisFirehose this ^com.amazonaws.AmazonWebServiceRequest request]
